...
{
/**
 * @class AlignSectionsFeature
 * @brief This filter will ....
 */
class RECONSTRUCTION_EXPORT AlignSectionsFeature : public IFilter
{
public:
  AlignSectionsFeature() = default;
  ~AlignSectionsFeature() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, AlignSectionsFeature, "2bcaf030-2689-4da9-8456-35c1d9efad9d");
