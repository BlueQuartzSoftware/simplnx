 ...
 */
class RECONSTRUCTION_EXPORT AlignSectionsMisorientation : public IFilter
{
public:
  AlignSectionsMisorientation() = default;
  ~AlignSectionsMisorientation() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, AlignSectionsMisorientation, "4fb2b9de-3124-534b-b914-dbbbdbc14604");
