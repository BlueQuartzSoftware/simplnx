 ...
 */
class RECONSTRUCTION_EXPORT ScalarSegmentFeatures : public IFilter
{
public:
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_ScalarTolerance_Key = "ScalarTolerance";
  static inline constexpr StringLiteral k_UseGoodVoxels_Key = "UseGoodVoxels";
  static inline constexpr StringLiteral k_ScalarArrayPath_Key = "ScalarArrayPath";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ScalarSegmentFeatures, "948d0035-dc19-58b9-a931-30b69a09bb1a");
