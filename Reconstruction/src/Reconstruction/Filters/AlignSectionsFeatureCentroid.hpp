 ...
 */
class COMPLEX_EXPORT AlignSectionsFeatureCentroid : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::AlignSectionsFeatureCentroid, "4bd95009-ddb9-5543-aea7-9884af87f921");
