 ...
 */
class RECONSTRUCTION_EXPORT ComputeFeatureRect : public IFilter
{
public:
  ComputeFeatureRect() = default;
  ~ComputeFeatureRect() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ComputeFeatureRect, "bf947c45-8610-44c9-917a-405e88f73fe7");
