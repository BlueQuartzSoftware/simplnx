 ...
 */
class SAMPLING_EXPORT ResampleImageGeom : public IFilter
{
public:
  ResampleImageGeom() = default;
  ~ResampleImageGeom() noexcept override = default;
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_CurrentGeomtryInfo_Key = "CurrentGeomtryInfo";
  static inline constexpr StringLiteral k_Spacing_Key = "Spacing";
  static inline constexpr StringLiteral k_NewGeomtryInfo_Key = "NewGeomtryInfo";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ResampleImageGeom, "4bc6846c-00ab-50b5-862b-aa6712260d41");
