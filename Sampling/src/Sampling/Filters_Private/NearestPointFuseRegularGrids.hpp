 ...
 */
class SAMPLING_EXPORT NearestPointFuseRegularGrids : public IFilter
{
public:
  NearestPointFuseRegularGrids() = default;
  ~NearestPointFuseRegularGrids() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, NearestPointFuseRegularGrids, "c8746bf8-fa5f-48b0-8a47-11023402e543");
