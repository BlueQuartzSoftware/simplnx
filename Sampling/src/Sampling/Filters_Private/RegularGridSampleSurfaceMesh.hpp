 ...
 */
class SAMPLING_EXPORT RegularGridSampleSurfaceMesh : public IFilter
{
public:
  RegularGridSampleSurfaceMesh() = default;
  ~RegularGridSampleSurfaceMesh() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, RegularGridSampleSurfaceMesh, "7d061fe1-7c88-45ef-a7ee-f8ab027c8e85");
