...
{
/**
 * @class ExtractFlaggedFeatures
 * @brief This filter will ....
 */
class SAMPLING_EXPORT ExtractFlaggedFeatures : public IFilter
{
public:
  ExtractFlaggedFeatures() = default;
  ~ExtractFlaggedFeatures() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExtractFlaggedFeatures, "5b9d0ab9-eee8-467a-b904-3f2894cf2764");
