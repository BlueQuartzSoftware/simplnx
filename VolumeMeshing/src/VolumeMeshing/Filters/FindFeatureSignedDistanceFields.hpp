...
{
/**
 * @class FindFeatureSignedDistanceFields
 * @brief This filter will ....
 */
class VOLUMEMESHING_EXPORT FindFeatureSignedDistanceFields : public IFilter
{
public:
  FindFeatureSignedDistanceFields() = default;
  ~FindFeatureSignedDistanceFields() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindFeatureSignedDistanceFields, "df5a0b3f-5fa4-59de-8913-a6cd63ec2bb5");
