...
class ExportGBCDGMTFileFilter(complex.IFilter):
    def __init__(self) -> None: ...
    @classmethod
    def execute(cls, data_structure: complex.DataStructure, crystal_structures_array_path: complex.DataPath = ..., gbcd_array_path: complex.DataPath = ..., misorientation_rotation: List[float] = ..., output_file: os.PathLike = ..., phase_of_interest: int = ...) -> complex.IFilter.ExecuteResult: ...
