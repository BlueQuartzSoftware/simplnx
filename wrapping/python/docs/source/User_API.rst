...
.. py:class:: ComputeColorTableParameter (Updated v1.2.6)
   
   This parameter is used specifically for the  :ref:`simplnx.ComputeColorTableFilter() <ComputeColorTableFilter>` filter. This parameter 
