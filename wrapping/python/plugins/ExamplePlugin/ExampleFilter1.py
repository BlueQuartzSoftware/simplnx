...
class ExampleFilter1:
  ...
  def parameters(self) -> nx.Parameters:
    ...
    # See https://www.dream3d.io/python_docs/User_API.html#nx.ComputeColorTableParameter for the full list of preset names
    params.insert(nx.ComputeColorTableParameter(ExampleFilter1.PARAM16_KEY, "Select Preset...", "Select a preset color scheme to apply to the created array", "Rainbow Desaturated"))
