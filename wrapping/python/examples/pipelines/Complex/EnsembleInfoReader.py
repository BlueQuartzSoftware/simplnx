...
result = filter.execute(
    ...
    endian=0,
    input_file=cxtest.GetDataDirectory() + "Data/OrientationAnalysis/quats.raw",
...
result = filter.execute(
    ...
    input_file=cxtest.GetDataDirectory() + "Data/OrientationAnalysis/Ensemble.ini",
...
output_file_path = cxtest.GetDataDirectory() + "Data/Output/Examples/EnsembleInfoReaderExample.dream3d"
# Execute Filter with Parameters
result = filter.execute(
    data_structure=data_structure,
