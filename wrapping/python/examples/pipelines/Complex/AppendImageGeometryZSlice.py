...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=cxtest.GetDataDirectory() + "Data/ASCIIData/FeatureIds.csv",
    n_comp=1,
    n_skip_lines=0,
    n_tuples=[[480000.0]],
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=cxtest.GetDataDirectory() + "Data/ASCIIData/IPFColor.csv",
    n_comp=3,
    n_skip_lines=0,
    n_tuples=[[480000.0]],
...
output_file_path = cxtest.GetDataDirectory() + "Data/Output/Examples/AppendImageGeometryZSlice.dream3d"
# Execute Filter with Parameters
result = filter.execute(
    data_structure=data_structure,
