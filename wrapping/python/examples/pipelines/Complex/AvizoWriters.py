...
import_data.file_path = cxtest.GetDataDirectory() + "Data/Output/Reconstruction/SmallIN100_Final.dream3d"
...
result = filter.execute(data_structure=data_structure,
    ...
    output_file=cxtest.GetDataDirectory() + "Data/Output/Examples/SmallIN100_AvizoUniform.am",
    units="meters",
...
result = filter.execute(data_structure=data_structure,
    feature_ids_array_path=cx.DataPath("DataContainer/CellData/FeatureIds"),
    geometry_path=cx.DataPath("DataContainer"),
    output_file=cxtest.GetDataDirectory() + "Data/Output/Examples/SmallIN100_AvizoRectilinear.am",
    units="meters",
    write_binary_file=False
)
if len(result.warnings) != 0:
