...
file_path = str(nxtest.get_data_directory() / "Output/SurfaceMesh/SmallIN100_Mesh.dream3d")
...
result = nx_filter.execute(
    ...
    surface_mesh_node_type_array_path=nx.DataPath("TriangleDataContainer/Vertex Data/NodeType"),
