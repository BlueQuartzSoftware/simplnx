...
result = nx_filter.execute(
    ...
    crystal_structures_array_path=nx.DataPath("fw-ar-IF1-avtr12-corr/Cell Ensemble Data/CrystalStructures"),
...
result = nx_filter.execute(
    ...
    input_data_array_paths=[nx.DataPath("fw-ar-IF1-avtr12-corr/Histograms/\"EquivalentDiameters\" Histogram/Bin Counts")]
)
nxtest.check_filter_result(nx_filter, result)
