...
result = nx_filter.execute(
    ...
    created_triangle_geometry_path=nx.DataPath("Blade"),
...
result = nx_filter.execute(
    ...
    scale_output=False,
    stl_file_path=nxtest.get_data_directory() / "STL_Models/ASTMD638_specimen.stl",
    created_triangle_geometry_path=nx.DataPath("Blade [Rotation]"),
    vertex_attribute_matrix_name="Vertex Data"
)
nxtest.check_filter_result(nx_filter, result)
...
result = nx_filter.execute(
    ...
    #scale: List[float] = ...,
    selected_image_geometry_path=nx.DataPath("Blade [Rotation]"),
...
result = nx_filter.execute(
    ...
    scale_output=False,
    stl_file_path=nxtest.get_data_directory() / "STL_Models/ASTMD638_specimen.stl",
    created_triangle_geometry_path=nx.DataPath("Blade [Translation]"),
    vertex_attribute_matrix_name="Vertex Data"
)
nxtest.check_filter_result(nx_filter, result)
...
result = nx_filter.execute(
    data_structure=data_structure,
    interpolation_type=2,
    selected_image_geometry_path=nx.DataPath("Blade [Translation]"),
...
result = nx_filter.execute(
    ...
    scale_output=False,
    stl_file_path=nxtest.get_data_directory() / "STL_Models/ASTMD638_specimen.stl",
    created_triangle_geometry_path=nx.DataPath("Blade [Scale]"),
    vertex_attribute_matrix_name="Vertex Data"
)
nxtest.check_filter_result(nx_filter, result)
...
result = nx_filter.execute(
    ...
    interpolation_type=2,
    scale=[0.5, 0.5, 1.0],
    selected_image_geometry_path=nx.DataPath("Blade [Scale]"),
