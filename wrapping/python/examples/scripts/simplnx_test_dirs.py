...
def get_build_directory() -> Path:
  return Path('/Users/mjackson/Workspace1/DREAM3D-Build/NX-arm64-Release/Bin')

def get_test_directory() -> Path:
  return Path('/Users/mjackson/Workspace1/DREAM3D-Build/NX-arm64-Release/simplnx/Testing')

def get_test_temp_directory() -> Path:
  return Path('/Users/mjackson/Workspace1/DREAM3D-Build/NX-arm64-Release/simplnx/Testing/Temporary')

def get_data_directory() -> Path:
  return Path('/Users/mjackson/Workspace1/DREAM3D-Build/NX-arm64-Release/Bin/./Data')

def get_simplnx_python_source_dir() -> Path:
  return Path('/Users/mjackson/Workspace1/simplnx/wrapping/python')

def get_simplnx_source_dir() -> Path:
  return Path('/Users/mjackson/Workspace1/simplnx')
