...
pipeline = nx.Pipeline().from_file(nxtest.get_simplnx_source_dir() / 'src/Plugins/OrientationAnalysis/pipelines/Small_IN100_Processing/(01) Small IN100 Archive.d3dpipeline')
