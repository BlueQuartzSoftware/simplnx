...
result = filter.execute(
    ...
    feature_data_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Output/fw-ar-IF1-aptr12-corr/FeatureData.csv",
...
result = filter.execute(
    data_structure=data_structure,
    delimiter=2,
    output_path="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Output/fw-ar-IF1-aptr12-corr/EqDiamHistogram.csv",
    output_style=1,
...
result = filter.execute(
    data_structure=data_structure,
    export_file_path="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Output/fw-ar-IF1-aptr12-corr/fw-ar-IF1-aptr12-corr.dream3d",
