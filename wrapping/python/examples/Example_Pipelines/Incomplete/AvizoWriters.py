...
result = filter.execute(data_structure=data_structure,
    ...
    output_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Output/Examples/SmallIN100_AvizoUniform.am",
    units="meters",
...
result = filter.execute(data_structure=data_structure,
    feature_ids_array_path=cx.DataPath("DataContainer/CellData/FeatureIds"),
    geometry_path=cx.DataPath("DataContainer"),
    output_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Output/Examples/SmallIN100_AvizoRectilinear.am",
    units="meters",
    write_binary_file=False
)
if len(result.warnings) != 0:
