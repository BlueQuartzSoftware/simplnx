...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/ASCIIData/SEM Signal.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/ASCIIData/Fit.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/ASCIIData/EulerAngles.csv",
    n_comp=3,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file="C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/ASCIIData/Phases.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
# Execute Filter with Parameters
output_file_path = "C:/Users/alejo/Downloads/DREAM3DNX-7.0.0-RC-7-windows-AMD64/Data/Examples/ResampleRectGridToImageGeom.dream3d"
