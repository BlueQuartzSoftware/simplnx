...
read_csv_data.input_file_path = nxtest.GetDataDirectory() + "Data/ASCIIData/EulersRotated.csv"
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/Import_ASCII_IPF.png",
