...
result = filter.execute(
    ...
    input_file=nxtest.GetDataDirectory() + "Data/Small_IN100/Slice_1.ang"
)
...
output_file_path = nxtest.GetDataDirectory() + "Data/Output/Transformation/ApplyTransformation_Image.dream3d"
# Execute Filter with Parameters
result = filter.execute(
    data_structure=data_structure,
