...
read_csv_data.input_file_path = nxtest.GetDataDirectory() + "Data/ASCIIData/RectilinearGrid.csv"
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=nxtest.GetDataDirectory() + "Data/ASCIIData/SEM Signal.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=nxtest.GetDataDirectory() + "Data/ASCIIData/Fit.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=nxtest.GetDataDirectory() + "Data/ASCIIData/EulerAngles.csv",
    n_comp=3,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
result = filter.execute(
    ...
    data_format="",
    delimiter_choice=0,
    input_file=nxtest.GetDataDirectory() + "Data/ASCIIData/Phases.csv",
    n_comp=1,
    n_skip_lines=0,
    # n_tuples: List[List[float]] = ...,
...
# Execute Filter with Parameters
output_file_path = nxtest.GetDataDirectory() + "Data/Examples/ResampleRectGridToImageGeom.dream3d"
