...
result = filter.execute(
    ...
    scale_output=False,
    stl_file_path=nxtest.GetDataDirectory() + "Data/STL_Models/ASTMD638_specimen.stl",
...
output_file_path = nxtest.GetDataDirectory() + "Data/Output/ApplyTransformation_Node.dream3d"
# Execute Filter with Parameters
result = filter.execute(
    data_structure=data_structure,
