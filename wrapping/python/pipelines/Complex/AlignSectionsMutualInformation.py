...
h5ebsdParameter.input_file_path=nxtest.GetDataDirectory() + "Data/Output/Reconstruction/Small_IN100.h5ebsd"
...
result = filter.execute(
    data_structure=data_structure,
    alignment_shift_file_name=nxtest.GetDataDirectory() + "Data/Output/OrientationAnalysis/Alignment_By_Mutual_Information_Shifts.txt",
