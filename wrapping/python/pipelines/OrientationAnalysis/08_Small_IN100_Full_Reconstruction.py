...
filter_parameter.input_file_path=nxtest.GetDataDirectory() + "Data/Output/Reconstruction/Small_IN100.h5ebsd"
...
output_file_path = nxtest.GetDataDirectory() + "Data/Output/Reconstruction/SmallIN100_Final.dream3d"
# Execute Filter with Parameters
result = filter.execute(
    data_structure=data_structure,
