...
result = filter.execute(
    ...
    input_file=nxtest.GetDataDirectory() + "Data/T12-MAI-2010/fw-ar-IF1-avtr12-corr.ctf"
)
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/fw-ar-IF1-avtr12-corr_001.png",
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/fw-ar-IF1-avtr12-corr_010.png",
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/fw-ar-IF1-avtr12-corr_100.png",
...
result = filter.execute(
    ...
    feature_data_file=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/FeatureData.csv",
...
result = filter.execute(
    data_structure=data_structure,
    delimiter=2,
    output_path=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/EqDiamHistogram.csv",
    output_style=1,
...
result = filter.execute(
    data_structure=data_structure,
    export_file_path=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-avtr12-corr/fw-ar-IF1-avtr12-corr.dream3d",
