...
result = filter.execute(
    ...
    input_file=nxtest.GetDataDirectory() + "Data/Textured_Copper/Cugrid_after 2nd_15kv_2kx_2.ctf"
)
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/TexturedCopper/IPF_Unexposed.png",
...
result = filter.execute(
    ...
    num_colors=32,
    output_path=nxtest.GetDataDirectory() + "Data/Output/TexturedCopper",
