...
result = filter.execute(
    ...
    input_file=nxtest.GetDataDirectory() + "Data/T12-MAI-2010/fw-ar-IF1-aptr12-corr.ctf"
)
...
result = filter.execute(
    data_structure=data_structure,
    created_image_geometry=cx.DataPath("fw-ar-IF1-aptr12-corr"),
...
result = filter.execute(
    data_structure=data_structure,
    comparison_data_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/Error"),
    loop=False,
    min_confidence=0.0,
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/fw-ar-IF1-aptr12-corr_001.png",
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/fw-ar-IF1-aptr12-corr_010.png",
...
result = filter.execute(
    data_structure=data_structure,
    file_name=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/fw-ar-IF1-aptr12-corr_100.png",
...
result = filter.execute(
    ...
    grid_geometry_path=cx.DataPath("fw-ar-IF1-aptr12-corr"),
    mask_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/ThresholdArray"),
...
result = filter.execute(
    ...
    cell_feature_attribute_matrix=cx.DataPath("fw-ar-IF1-aptr12-corr/CellFeatureData"),
    cell_feature_ids_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/FeatureIds"),
    cell_phases_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/Phases"),
    cell_quats_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/Quats"),
    crystal_structures_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/CellEnsembleData/CrystalStructures")
)
if len(result.warnings) !=0:
    print(f'{filter.name()} Warnings: {result.warnings}')
...
result = filter.execute(
    ...
    kernel_size=[1, 1, 1],
    quats_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/Quats"),
    selected_image_geometry_path=cx.DataPath("fw-ar-IF1-aptr12-corr")
)
if len(result.warnings) !=0:
    print(f'{filter.name()} Warnings: {result.warnings}')
if len(result.errors) != 0:
...
result = filter.execute(
    data_structure=data_structure,
    avg_quats_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/CellFeatureData/AvgQuats"),
    cell_phases_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/Cell Data/Phases"),
    crystal_structures_array_path=cx.DataPath("fw-ar-IF1-aptr12-corr/CellEnsembleData/CrystalStructures"),
...
result = filter.execute(
    data_structure=data_structure,
    cell_feature_attribute_matrix_path=cx.DataPath("fw-ar-IF1-aptr12-corr/CellFeatureData"),
    delimiter_choice_int=2,
    feature_data_file=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/FeatureData.csv",
...
result = filter.execute(
    ...
    new_data_group=True,
    new_data_group_name=cx.DataPath("fw-ar-IF1-aptr12-corr/Histograms"),
    number_of_bins=256,
...
result = filter.execute(
    data_structure=data_structure,
    delimiter=2,
    output_path=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/EqDiamHistogram.csv",
    output_style=1,
...
result = filter.execute(
    data_structure=data_structure,
    export_file_path=nxtest.GetDataDirectory() + "Data/Output/fw-ar-IF1-aptr12-corr/fw-ar-IF1-aptr12-corr.dream3d",
