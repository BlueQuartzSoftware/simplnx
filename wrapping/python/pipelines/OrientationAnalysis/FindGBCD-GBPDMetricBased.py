...
result = filter.execute(
    ...
    dist_output_file=nxtest.GetDataDirectory() + "Data/Output/Examples/gbcd_distribution.dat",
    err_output_file=nxtest.GetDataDirectory() + "Data/Output/Examples/gbcd_distribution_errors.dat",
...
result = filter.execute(
    data_structure=data_structure,
    crystal_structures_array_path=cx.DataPath("DataContainer/CellEnsembleData/CrystalStructures"),
    dist_output_file=nxtest.GetDataDirectory() + "Data/Output/Examples/gbpd_distribution.dat",
    err_output_file=nxtest.GetDataDirectory() + "Data/Output/Examples/gbpd_distribution_errors.dat",
