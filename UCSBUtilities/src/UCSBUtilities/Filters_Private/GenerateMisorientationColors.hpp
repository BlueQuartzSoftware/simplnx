...
public:
  ...
  static inline constexpr StringLiteral k_ReferenceAngle_Key = "reference_angle";
  ...
  static inline constexpr StringLiteral k_MisorientationColorArrayName_Key = "misorientation_color_array_name";
