 ...
 */
class COMPLEX_EXPORT InputCrystalCompliances : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, InputCrystalCompliances, "2a79c9da-da6e-5371-af59-4f256845a7d6");
