...
{
/**
 * @class GenerateMisorientationColors
 * @brief This filter will ....
 */
class UCSBUTILITIES_EXPORT GenerateMisorientationColors : public IFilter
{
public:
  GenerateMisorientationColors() = default;
  ~GenerateMisorientationColors() noexcept override = default;
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_ReferenceAxis_Key = "ReferenceAxis";
  static inline constexpr StringLiteral k_ReferenceAngle_Key = "ReferenceAngle";
  ...
  static inline constexpr StringLiteral k_MisorientationColorArrayName_Key = "MisorientationColorArrayName";
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateMisorientationColors, "9f92ca90-48ea-47d7-9615-3dd0a90129e3");
