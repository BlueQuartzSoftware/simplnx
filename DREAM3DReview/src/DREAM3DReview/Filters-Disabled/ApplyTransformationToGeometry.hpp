 ...
 */
class COMPLEX_EXPORT ApplyTransformationToGeometry : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ApplyTransformationToGeometry, "2a09affe-1f88-5cbc-9251-64c85ee82203");
