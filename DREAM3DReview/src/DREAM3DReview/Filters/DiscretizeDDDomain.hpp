...
{
/**
 * @class DiscretizeDDDomain
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT DiscretizeDDDomain : public IFilter
{
public:
  DiscretizeDDDomain() = default;
  ~DiscretizeDDDomain() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, DiscretizeDDDomain, "de7f7882-410f-40f9-9a46-a97dfdbc21b0");
