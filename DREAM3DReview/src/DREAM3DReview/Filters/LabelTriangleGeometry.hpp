...
{
/**
 * @class LabelTriangleGeometry
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT LabelTriangleGeometry : public IFilter
{
public:
  LabelTriangleGeometry() = default;
  ~LabelTriangleGeometry() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, LabelTriangleGeometry, "7a7a2c6f-3b03-444d-8b8c-5976b0e5c82e");
