 ...
 */
class DREAM3DREVIEW_EXPORT ParaDisReader : public IFilter
{
public:
  ParaDisReader() = default;
  ~ParaDisReader() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ParaDisReader, "7824d032-a370-4a6f-9e2d-b6bfe5a32467");
