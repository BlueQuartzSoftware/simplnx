 ...
 */
class COMPLEX_EXPORT InsertTransformationPhases : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, InsertTransformationPhases, "f6e4b3ef-581c-55cb-8908-f44fe043bbc5");
