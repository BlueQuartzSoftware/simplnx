...
{
/**
 * @class SteinerCompact
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT SteinerCompact : public IFilter
{
public:
  SteinerCompact() = default;
  ~SteinerCompact() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, SteinerCompact, "addb4284-2048-40bd-ac2e-b1d4c4589913");
