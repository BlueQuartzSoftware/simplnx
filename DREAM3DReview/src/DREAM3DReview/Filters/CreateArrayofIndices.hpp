...
{
/**
 * @class CreateArrayofIndices
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT CreateArrayofIndices : public IFilter
{
public:
  CreateArrayofIndices() = default;
  ~CreateArrayofIndices() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CreateArrayofIndices, "3dd5d1cb-d39d-5bb6-aab5-4f64c0892e24");
