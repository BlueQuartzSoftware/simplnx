 ...
 */
class DREAM3DREVIEW_EXPORT ReadMicData : public IFilter
{
public:
  ReadMicData() = default;
  ~ReadMicData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReadMicData, "09887e07-c1e5-4631-91fb-1e28be5b7054");
