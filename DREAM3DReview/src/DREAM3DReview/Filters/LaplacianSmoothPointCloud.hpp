 ...
 */
class COMPLEX_EXPORT LaplacianSmoothPointCloud : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, LaplacianSmoothPointCloud, "f4f7719b-d079-5fcc-b081-ca332b0bd57d");
