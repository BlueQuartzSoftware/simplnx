 ...
 */
class DREAM3DREVIEW_EXPORT RobustAutomaticThreshold : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_GradientMagnitudeArrayPath_Key = "GradientMagnitudeArrayPath";
...
COMPLEX_DEF_FILTER_TRAITS(complex, RobustAutomaticThreshold, "6fae2634-52bf-5fc4-b309-1f0d5cf355c8");
