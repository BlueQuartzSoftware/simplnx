 ...
 */
class COMPLEX_EXPORT MapPointCloudToRegularGrid : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::MapPointCloudToRegularGrid, "2db3204e-a4ce-5f37-a928-65744ba06173");
