...
{
/**
 * @class FindElementCentroids
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT FindElementCentroids : public IFilter
{
public:
  FindElementCentroids() = default;
  ~FindElementCentroids() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindElementCentroids, "bb480357-b33d-45b0-9bd7-c6c252d56081");
