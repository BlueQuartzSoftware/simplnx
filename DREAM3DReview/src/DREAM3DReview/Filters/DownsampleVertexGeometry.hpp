 ...
 */
class COMPLEX_EXPORT DownsampleVertexGeometry : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, DownsampleVertexGeometry, "26455785-2a9e-5c6d-8a59-a55f203beb28");
