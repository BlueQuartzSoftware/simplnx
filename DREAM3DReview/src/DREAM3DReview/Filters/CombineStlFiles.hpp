 ...
 */
class DREAM3DREVIEW_EXPORT CombineStlFiles : public IFilter
{
public:
  CombineStlFiles() = default;
  ~CombineStlFiles() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CombineStlFiles, "76b56f80-fcbe-4d48-a34d-a73d0fc6e5ae");
