 ...
 */
class DREAM3DREVIEW_EXPORT KMeans : public IFilter
{
public:
  KMeans() = default;
  ~KMeans() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_MeansArrayName_Key = "MeansArrayName";
...
COMPLEX_DEF_FILTER_TRAITS(complex, KMeans, "061f74ad-9173-523a-a774-c84e07d380a0");
