...
{
/**
 * @class FindMinkowskiBouligandDimension
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT FindMinkowskiBouligandDimension : public IFilter
{
public:
  FindMinkowskiBouligandDimension() = default;
  ~FindMinkowskiBouligandDimension() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindMinkowskiBouligandDimension, "1eaa74db-9218-5528-989e-ded856c7ec7e");
