 ...
 */
class COMPLEX_EXPORT AverageVertexArrayToEdgeFaceCellArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, AverageVertexArrayToEdgeFaceCellArray, "d5d7625a-2344-551d-8834-b838e5531866");
