 ...
 */
class DREAM3DREVIEW_EXPORT ExtractInternalSurfacesFromTriangleGeometry : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_InternalTrianglesName_Key = "InternalTrianglesName";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExtractInternalSurfacesFromTriangleGeometry, "1531f0cc-82c4-5efb-8b0f-44be9cfe2836");
