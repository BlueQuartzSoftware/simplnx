 ...
 */
class DREAM3DREVIEW_EXPORT ComputeFeatureEigenstrains : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ComputeFeatureEigenstrains, "94c5365c-41d8-42cf-a2a1-923a37818b6f");
