...
{
/**
 * @class TesselateFarFieldGrains
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT TesselateFarFieldGrains : public IFilter
{
public:
  TesselateFarFieldGrains() = default;
  ~TesselateFarFieldGrains() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, TesselateFarFieldGrains, "e30e9cee-fb85-4414-af46-41ae2df329f4");
