 ...
 */
class COMPLEX_EXPORT WaveFrontObjectFileWriter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, WaveFrontObjectFileWriter, "29c6512f-5928-5eb4-8ec0-729b34ce97a4");
