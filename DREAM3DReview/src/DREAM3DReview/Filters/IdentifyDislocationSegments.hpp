...
{
/**
 * @class IdentifyDislocationSegments
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT IdentifyDislocationSegments : public IFilter
{
public:
  IdentifyDislocationSegments() = default;
  ~IdentifyDislocationSegments() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, IdentifyDislocationSegments, "6bf380da-8016-52af-bd54-f6a729ccd201");
