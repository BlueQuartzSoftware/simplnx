 ...
 */
class DREAM3DREVIEW_EXPORT PottsModel : public IFilter
{
public:
  PottsModel() = default;
  ~PottsModel() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_Temperature_Key = "Temperature";
...
COMPLEX_DEF_FILTER_TRAITS(complex, PottsModel, "236a6372-cce2-4ddf-80de-c98269588469");
