 ...
 */
class DREAM3DREVIEW_EXPORT FindNorm : public IFilter
{
public:
  FindNorm() = default;
  ~FindNorm() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindNorm, "fd3223fa-e065-4b41-9b6f-06ba3f972c6d");
