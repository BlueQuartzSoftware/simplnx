 ...
 */
class DREAM3DREVIEW_EXPORT ExportCLIFile : public IFilter
{
public:
  ExportCLIFile() = default;
  ~ExportCLIFile() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExportCLIFile, "207630e3-7372-46e4-93be-096f249dc7b5");
