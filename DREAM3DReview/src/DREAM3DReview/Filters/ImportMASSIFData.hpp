...
{
/**
 * @class ImportMASSIFData
 * @brief This filter will ....
 */
class DREAM3DREVIEW_EXPORT ImportMASSIFData : public IFilter
{
public:
  ImportMASSIFData() = default;
  ~ImportMASSIFData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportMASSIFData, "0544f31f-87f0-4f68-9e27-3c7af77fe349");
