 ...
 */
class SYNTHETICBUILDING_EXPORT JumbleOrientations : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, JumbleOrientations, "85b7e460-f80f-4b14-9fa4-8ce28bf412f3");
