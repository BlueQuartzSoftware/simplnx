...
{
/**
 * @class GeneratePrecipitateStatsData
 * @brief This filter will ....
 */
class SYNTHETICBUILDING_EXPORT GeneratePrecipitateStatsData : public IFilter
{
public:
  GeneratePrecipitateStatsData() = default;
  ~GeneratePrecipitateStatsData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GeneratePrecipitateStatsData, "8e1a4183-73b5-44b0-a355-0f06176881aa");
