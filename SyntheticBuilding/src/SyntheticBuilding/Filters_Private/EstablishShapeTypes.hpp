...
{
/**
 * @class EstablishShapeTypes
 * @brief This filter will ....
 */
class SYNTHETICBUILDING_EXPORT EstablishShapeTypes : public IFilter
{
public:
  EstablishShapeTypes() = default;
  ~EstablishShapeTypes() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, EstablishShapeTypes, "e19a554d-227c-4091-bc46-f3a6aa541f7a");
