 ...
 */
class SYNTHETICBUILDING_EXPORT StatsGeneratorFilter : public IFilter
{
public:
  StatsGeneratorFilter() = default;
  ~StatsGeneratorFilter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, StatsGeneratorFilter, "fd7861f9-9972-4f86-afb7-d9c589e3a636");
