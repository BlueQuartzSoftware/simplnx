 ...
 */
class IMPORTEXPORT_EXPORT AvizoRectilinearCoordinateWriter : public IFilter
{
public:
  AvizoRectilinearCoordinateWriter() = default;
  ~AvizoRectilinearCoordinateWriter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, AvizoRectilinearCoordinateWriter, "58661ea8-0322-44af-a48e-1dc80e999376");
