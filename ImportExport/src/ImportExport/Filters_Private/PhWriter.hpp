 ...
 */
class IMPORTEXPORT_EXPORT PhWriter : public IFilter
{
public:
  PhWriter() = default;
  ~PhWriter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, PhWriter, "b824e9bb-0676-4581-b919-c70eb51f0551");
