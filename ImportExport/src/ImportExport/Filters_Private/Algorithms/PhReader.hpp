...
* This is example code to put in the Execute Method of the filter.
  PhReaderInputValues inputValues;
  ...
  return PhReader(dataStructure, messageHandler, shouldCancel, &inputValues)();
*/

namespace complex
{

struct IMPORTEXPORT_EXPORT PhReaderInputValues
{
...
class IMPORTEXPORT_EXPORT PhReader
{
public:
  PhReader(DataStructure& dataStructure, const IFilter::MessageHandler& mesgHandler, const std::atomic_bool& shouldCancel, PhReaderInputValues* inputValues);
  ~PhReader() noexcept;
...
private:
  ...
  const PhReaderInputValues* m_InputValues = nullptr;
