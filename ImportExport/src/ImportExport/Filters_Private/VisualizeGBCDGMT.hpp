...
{
/**
 * @class VisualizeGBCDGMT
 * @brief This filter will ....
 */
class IMPORTEXPORT_EXPORT VisualizeGBCDGMT : public IFilter
{
public:
  VisualizeGBCDGMT() = default;
  ~VisualizeGBCDGMT() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, VisualizeGBCDGMT, "31710abf-b8a6-423f-a03f-4b8885bd3633");
