...
{
/**
 * @class SPParksSitesWriter
 * @brief This filter will ....
 */
class IMPORTEXPORT_EXPORT SPParksSitesWriter : public IFilter
{
public:
  SPParksSitesWriter() = default;
  ~SPParksSitesWriter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, SPParksSitesWriter, "dec4ded3-13d7-4da9-a7af-fb2579cb9c9f");
