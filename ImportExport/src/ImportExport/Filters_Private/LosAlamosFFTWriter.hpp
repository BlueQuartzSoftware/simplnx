...
{
/**
 * @class LosAlamosFFTWriter
 * @brief This filter will ....
 */
class IMPORTEXPORT_EXPORT LosAlamosFFTWriter : public IFilter
{
public:
  LosAlamosFFTWriter() = default;
  ~LosAlamosFFTWriter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, LosAlamosFFTWriter, "9d5ffeba-4339-49d2-a519-5743fbd5e7a9");
