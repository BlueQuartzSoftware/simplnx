...
{
/**
 * @class GBCDTriangleDumper
 * @brief This filter will ....
 */
class IMPORTEXPORT_EXPORT GBCDTriangleDumper : public IFilter
{
public:
  GBCDTriangleDumper() = default;
  ~GBCDTriangleDumper() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GBCDTriangleDumper, "6e0da3a1-dc42-4b01-80aa-3af9e8209ee3");
