 ...
 */
class IMPORTEXPORT_EXPORT WriteStlFile : public IFilter
{
public:
  WriteStlFile() = default;
  ~WriteStlFile() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, WriteStlFile, "54a293f4-1366-46ca-b284-fe5965545dd2");
