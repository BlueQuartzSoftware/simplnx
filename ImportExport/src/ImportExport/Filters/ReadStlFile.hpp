 ...
 */
class IMPORTEXPORT_EXPORT ReadStlFile : public IFilter
{
public:
  ReadStlFile() = default;
  ~ReadStlFile() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_SurfaceMeshDataContainerName_Key = "SurfaceMeshDataContainerName";
