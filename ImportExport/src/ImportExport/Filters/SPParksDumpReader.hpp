...
{
/**
 * @class SPParksDumpReader
 * @brief This filter will ....
 */
class IMPORTEXPORT_EXPORT SPParksDumpReader : public IFilter
{
public:
  SPParksDumpReader() = default;
  ~SPParksDumpReader() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_OneBasedArrays_Key = "OneBasedArrays";
...
COMPLEX_DEF_FILTER_TRAITS(complex, SPParksDumpReader, "fcb2f2a4-75ee-4a44-8bc6-2a8b419b657b");
