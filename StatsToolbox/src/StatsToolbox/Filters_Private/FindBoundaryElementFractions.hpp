...
{
/**
 * @class FindBoundaryElementFractions
 * @brief This filter will ....
 */
class STATSTOOLBOX_EXPORT FindBoundaryElementFractions : public IFilter
{
public:
  FindBoundaryElementFractions() = default;
  ~FindBoundaryElementFractions() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindBoundaryElementFractions, "f268dab6-9a31-498e-8502-338cd7a549b4");
