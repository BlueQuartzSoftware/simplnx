...
{
/**
 * @class FindAvgScalarValueForFeatures
 * @brief This filter will ....
 */
class STATSTOOLBOX_EXPORT FindAvgScalarValueForFeatures : public IFilter
{
public:
  FindAvgScalarValueForFeatures() = default;
  ~FindAvgScalarValueForFeatures() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindAvgScalarValueForFeatures, "fc0c716d-7fb9-4b25-ada4-12663115996a");
