...
{
/**
 * @class FindLargestCrossSections
 * @brief This filter will ....
 */
class STATSTOOLBOX_EXPORT FindLargestCrossSections : public IFilter
{
public:
  FindLargestCrossSections() = default;
  ~FindLargestCrossSections() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindLargestCrossSections, "18ba2f7a-4e3a-4547-bd8c-b0955d542a9f");
