...
{
/**
 * @class FindNumFeatures
 * @brief This filter will ....
 */
class STATSTOOLBOX_EXPORT FindNumFeatures : public IFilter
{
public:
  FindNumFeatures() = default;
  ~FindNumFeatures() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindNumFeatures, "ec3388de-d7a7-4cf6-94f4-81061b0863c8");
