 ...
 */
class COMPLEX_EXPORT GenerateEnsembleStatistics : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::GenerateEnsembleStatistics, "f11f8b23-b09d-5d78-abb0-8e9d8ab35bfb");
