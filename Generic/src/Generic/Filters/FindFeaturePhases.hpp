...
{
/**
 * @class FindFeaturePhases
 * @brief This filter will ....
 */
class GENERIC_EXPORT FindFeaturePhases : public IFilter
{
public:
  FindFeaturePhases() = default;
  ~FindFeaturePhases() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindFeaturePhases, "9df86f97-5d1c-56f6-9cbd-da5daea97f4f");
