...
{
/**
 * @class FindFeaturePhasesBinary
 * @brief This filter will ....
 */
class GENERIC_EXPORT FindFeaturePhasesBinary : public IFilter
{
public:
  FindFeaturePhasesBinary() = default;
  ~FindFeaturePhasesBinary() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindFeaturePhasesBinary, "16010080-a913-443a-b5b3-bd43391fe3c0");
