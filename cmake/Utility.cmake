...
function(enable_vcpkg_manifest_feature)
  ...
  if(${ARGS_TEST_VAR})
    if(NOT ${ARGS_FEATURE} IN_LIST VCPKG_MANIFEST_FEATURES)
      set(VCPKG_MANIFEST_FEATURES ${VCPKG_MANIFEST_FEATURES} ${ARGS_FEATURE} CACHE STRING "" FORCE)
      message(WARNING "VCPKG_MANIFEST_FEATURES was changed. ${ARGS_FEATURE} was added. Rerun CMake again to have VCPKG pick up the changes.")
    endif()
  endif()
endfunction()
