 ...
 */
class SIMPL_EXPORT LinkFeatureMapToElementArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, LinkFeatureMapToElementArray, "e76a23c9-89d4-4afa-bc4c-115aabd140a9");
