...
{
/**
 * @class CreateGridMontage
 * @brief This filter will ....
 */
class SIMPL_EXPORT CreateGridMontage : public IFilter
{
public:
  CreateGridMontage() = default;
  ~CreateGridMontage() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CreateGridMontage, "82ff5ee4-334c-447f-b5cb-b279b202d31f");
