 ...
 */
class SIMPL_EXPORT ExtractComponentAsArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExtractComponentAsArray, "fcc1c1cc-c37a-40fc-97fa-ce40201d34e3");
