 ...
 */
class SIMPL_EXPORT PostSlackMessage : public IFilter
{
public:
  PostSlackMessage() = default;
  ~PostSlackMessage() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, PostSlackMessage, "0625f382-02b4-4ef4-b9d2-dbab66d5a78a");
