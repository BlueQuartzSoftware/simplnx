...
{
/**
 * @class GenerateVertexCoordinates
 * @brief This filter will ....
 */
class SIMPL_EXPORT GenerateVertexCoordinates : public IFilter
{
public:
  GenerateVertexCoordinates() = default;
  ~GenerateVertexCoordinates() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateVertexCoordinates, "b6c685f1-28e5-4975-8b00-996876678159");
