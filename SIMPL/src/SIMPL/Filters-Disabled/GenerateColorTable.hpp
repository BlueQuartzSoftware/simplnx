 ...
 */
class SIMPL_EXPORT GenerateColorTable : public IFilter
{
public:
  GenerateColorTable() = default;
  ~GenerateColorTable() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateColorTable, "d1731177-4d70-41c0-9334-566a0b482796");
