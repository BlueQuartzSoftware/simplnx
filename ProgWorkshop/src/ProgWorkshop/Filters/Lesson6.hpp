 ...
 */
class PROGWORKSHOP_EXPORT Lesson6 : public IFilter
{
public:
  Lesson6() = default;
  ~Lesson6() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, Lesson6, "d160f282-25bf-4709-b34a-c308c662fe94");
