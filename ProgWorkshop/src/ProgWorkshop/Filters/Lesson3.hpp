 ...
 */
class PROGWORKSHOP_EXPORT Lesson3 : public IFilter
{
public:
  Lesson3() = default;
  ~Lesson3() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, Lesson3, "795caa2f-b02d-41c8-aaca-297ea263c56b");
