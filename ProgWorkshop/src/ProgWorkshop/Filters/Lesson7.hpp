 ...
 */
class PROGWORKSHOP_EXPORT Lesson7 : public IFilter
{
public:
  Lesson7() = default;
  ~Lesson7() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, Lesson7, "6bce0de9-e108-44d0-a1f4-ee6759ca3406");
