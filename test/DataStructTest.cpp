...
TEST_CASE("DataStructureDuplicateNames")
{
  ...
  DataGroup* group1 = DataGroup::Create(dataGraph, name);
  REQUIRE(group1 != nullptr);

  DataGroup* group2 = DataGroup::Create(dataGraph, name);
  REQUIRE(group2 == nullptr);

  // Nested test

  DataGroup* childGroup1 = DataGroup::Create(dataGraph, name, group1->getId());
  REQUIRE(group1 != nullptr);

  DataGroup* childGroup2 = DataGroup::Create(dataGraph, name, group1->getId());
  REQUIRE(group2 == nullptr);
}
