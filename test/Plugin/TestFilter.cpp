...
complex::Result<OutputActions> TestFilter::preflightImpl(const DataStructure& data, const Arguments& args) const
{
  return {};
}

complex::Result<> TestFilter::executeImpl(DataStructure& data, const Arguments& args) const
{
  return {};
}
