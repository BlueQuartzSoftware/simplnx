...
Result<OutputActions> Test2Filter::preflightImpl(const DataStructure& data, const Arguments& args) const
{
  return {};
}

Result<> Test2Filter::executeImpl(DataStructure& data, const Arguments& args) const
{
  return {};
}
