...
const FilterHandle k_MultiThresholdObjectsFilterHandle(k_MultiThresholdObjectsId, k_ComplexCorePluginId, "MultiThresholdObjects", "MultiThresholdObjects");
...
const FilterHandle k_IdentifySampleFilterHandle(k_IdentifySampleFilterId, k_ComplexCorePluginId, "IdentifySampleFilter", "IdentifySampleFilter");
