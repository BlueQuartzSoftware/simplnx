...
{
  INFO(fmt::format("Error creating Filter '{}'  ", Constants::k_ConvertOrientationsFilterHandle.getFilterName()));
  auto filter = filterList.createFilter(Constants::k_ConvertOrientationsFilterHandle);
  REQUIRE(nullptr != filter);
...
{
  INFO(fmt::format("Error creating Filter '{}'  ", Constants::k_EbsdSegmentFeaturesFilterHandle.getFilterName()));
  auto filter = filterList.createFilter(Constants::k_EbsdSegmentFeaturesFilterHandle);
  REQUIRE(nullptr != filter);
...
{
  INFO(fmt::format("Error creating Filter '{}'  ", Constants::k_AlignSectionMisorientationFilterHandle.getFilterName()));
  auto filter = filterList.createFilter(Constants::k_AlignSectionMisorientationFilterHandle);
  REQUIRE(nullptr != filter);
...
inline void ExecuteBadDataNeighborOrientationCheck(DataStructure& dataStructure, const FilterList& filterList)
{
  ...
  INFO(fmt::format("Error creating Filter '{}'  ", Constants::k_BadDataNeighborOrientationCheckFilterHandle.getFilterName()));
  auto filter = filterList.createFilter(Constants::k_BadDataNeighborOrientationCheckFilterHandle);
  REQUIRE(nullptr != filter);
  // Parameter Keys
  constexpr StringLiteral k_MisorientationTolerance_Key = "misorientation_tolerance";
...
{
  INFO(fmt::format("Error creating Filter '{}'  ", Constants::k_NeighborOrientationCorrelationFilterHandle.getFilterName()));
  auto filter = filterList.createFilter(Constants::k_NeighborOrientationCorrelationFilterHandle);
  REQUIRE(nullptr != filter);
