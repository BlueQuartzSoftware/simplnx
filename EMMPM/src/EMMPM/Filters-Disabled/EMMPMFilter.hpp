 ...
 */
class EMMPM_EXPORT EMMPMFilter : public IFilter
{
public:
  EMMPMFilter() = default;
  ~EMMPMFilter() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, EMMPMFilter, "3b8b661a-bb72-4edd-b941-7fb30f9705b0");
