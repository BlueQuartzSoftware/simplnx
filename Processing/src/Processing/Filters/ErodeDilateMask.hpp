 ...
 */
class PROCESSING_EXPORT ErodeDilateMask : public IFilter
{
public:
  ErodeDilateMask() = default;
  ~ErodeDilateMask() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ErodeDilateMask, "880fd85d-2610-5e58-97c5-333ab52ff260");
