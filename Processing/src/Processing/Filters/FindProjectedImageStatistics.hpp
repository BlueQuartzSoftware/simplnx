 ...
 */
class COMPLEX_EXPORT FindProjectedImageStatistics : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindProjectedImageStatistics, "d76b27b4-287e-5033-ae7a-740320f595eb");
