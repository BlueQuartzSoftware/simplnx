 ...
 */
class PROCESSING_EXPORT MinSize : public IFilter
{
public:
  MinSize() = default;
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_MinAllowedFeatureSize_Key = "MinAllowedFeatureSize";
...
COMPLEX_DEF_FILTER_TRAITS(complex, MinSize, "f41f6124-38be-55ff-b4c0-22b08c25c862");
