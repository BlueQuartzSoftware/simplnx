/**
 * This file is auto generated from the original Core/SetOriginResolutionImageGeom
 ...
 *
 * When you start working on this unit test remove "[SetOriginResolutionImageGeom][.][UNIMPLEMENTED]"
...
#include "Core/Filters/SetOriginResolutionImageGeom.hpp"

using namespace complex;

TEST_CASE("Core::SetOriginResolutionImageGeom: Basic Instantiation and Parameter Check", "[SetOriginResolutionImageGeom][.][UNIMPLEMENTED][!mayfail]")
{
...
// TEST_CASE("Core::SetOriginResolutionImageGeom: Valid filter execution")
//{
//
//}

// TEST_CASE("Core::SetOriginResolutionImageGeom: InValid filter execution")
//{
//
//}
