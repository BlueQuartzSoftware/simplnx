...
Parameters CreateGeometry::parameters() const
{
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_XBoundsArrayPath_Key, "X Bounds", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_YBoundsArrayPath_Key, "Y Bounds", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_ZBoundsArrayPath_Key, "Z Bounds", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath0_Key, "Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArrayCreationParameter>(k_VertexAttributeMatrixName0_Key, "Vertex Attribute Matrix", "", DataPath{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath1_Key, "Shared Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedEdgeListArrayPath_Key, "Edge List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath2_Key, "Shared Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedTriListArrayPath_Key, "Triangle List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath3_Key, "Shared Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedQuadListArrayPath_Key, "Quadrilateral List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath4_Key, "Shared Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedTetListArrayPath_Key, "Tetrahedral List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedVertexListArrayPath5_Key, "Shared Vertex List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
  params.insert(std::make_unique<ArraySelectionParameter>(k_SharedHexListArrayPath_Key, "Hexahedral List", "", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
...
//------------------------------------------------------------------------------
IFilter::PreflightResult CreateGeometry::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler,
...
//------------------------------------------------------------------------------
Result<> CreateGeometry::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler,
                                     const std::atomic_bool& shouldCancel) const
{
  /****************************************************************************
