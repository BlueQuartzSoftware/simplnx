 ...
 */
class CORE_EXPORT RemoveComponentFromArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, RemoveComponentFromArray, "1b4b9941-62e4-52f2-9918-15d48147ab88");
