 ...
 */
class COMPLEX_EXPORT CombineAttributeArrays : public IFilter
{
public:
  CombineAttributeArrays() = default;
  ~CombineAttributeArrays() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CombineAttributeArrays, "e608eb6c-5f68-5c31-8be9-6389251266fe");
