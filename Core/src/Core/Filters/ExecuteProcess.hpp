 ...
 */
class COMPLEX_EXPORT ExecuteProcess : public IFilter
{
public:
  ExecuteProcess() = default;
  ~ExecuteProcess() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExecuteProcess, "42bdbed3-e78e-55f9-a1a1-3a246fe4f039");
