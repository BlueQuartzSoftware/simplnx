 ...
 */
class COMPLEX_EXPORT ExtractComponentAsArray : public IFilter
{
public:
  ExtractComponentAsArray() = default;
  ~ExtractComponentAsArray() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex::ExtractComponentAsArray, "b852f1a2-186f-58dd-8966-5e3d8b183c98");
