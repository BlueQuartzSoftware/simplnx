 ...
 */
class COMPLEX_EXPORT ConvertData : public IFilter
{
public:
  ConvertData() = default;
  ~ConvertData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex::ConvertData, "93820064-84e9-5ddb-bd95-faab4e0404ec");
