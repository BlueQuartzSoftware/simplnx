 ...
 */
class COMPLEX_EXPORT ExtractAttributeArraysFromGeometry : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ExtractAttributeArraysFromGeometry, "d8680574-fae2-5561-9b08-3d31e2da4fd7");
