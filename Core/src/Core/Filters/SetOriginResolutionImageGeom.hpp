 ...
 */
class COMPLEX_EXPORT SetOriginResolutionImageGeom : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, SetOriginResolutionImageGeom, "f279660d-9348-557e-927a-e163bf536f14");
