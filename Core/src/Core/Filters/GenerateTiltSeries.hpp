 ...
 */
class COMPLEX_EXPORT GenerateTiltSeries : public IFilter
{
public:
  GenerateTiltSeries() = default;
  ~GenerateTiltSeries() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateTiltSeries, "fbf48b23-e819-5e5f-a739-6878788a6102");
