...
{
/**
 * @class SplitAttributeArray
 * @brief This filter will ....
 */
class COMPLEX_EXPORT SplitAttributeArray : public IFilter
{
public:
  SplitAttributeArray() = default;
  ~SplitAttributeArray() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, SplitAttributeArray, "1e4a7ac7-fc0a-5627-8e84-f07dc42a1862");
