 ...
 */
class COMPLEX_EXPORT CreateFeatureArrayFromElementArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::CreateFeatureArrayFromElementArray, "a76fe4f4-2d85-5d59-8539-806ee7f6ebdf");
