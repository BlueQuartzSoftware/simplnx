 ...
 */
class COMPLEX_EXPORT CreateDataContainer : public IFilter
{
public:
  CreateDataContainer() = default;
  ~CreateDataContainer() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex::CreateDataContainer, "3c9bdcf0-8781-5acf-8d56-14d5118cbbd5");
