...
{
/**
 * @class WriteTriangleGeometry
 * @brief This filter will ....
 */
class COMPLEX_EXPORT WriteTriangleGeometry : public IFilter
{
public:
  WriteTriangleGeometry() = default;
  ~WriteTriangleGeometry() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, WriteTriangleGeometry, "bb06c259-ebeb-5d63-b86b-ef5197f6bef5");
