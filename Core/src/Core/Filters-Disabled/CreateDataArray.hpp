 ...
 */
class CORE_EXPORT CreateDataArray : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_InitializationType_Key = "InitializationType";
  static inline constexpr StringLiteral k_InitializationValue_Key = "InitializationValue";
  static inline constexpr StringLiteral k_InitializationRange_Key = "InitializationRange";
...
COMPLEX_DEF_FILTER_TRAITS(complex, CreateDataArray, "77f392fb-c1eb-57da-a1b1-e7acf9239fb8");
