 ...
 */
class COMPLEX_EXPORT PipelineAnnotation : public IFilter
{
public:
  PipelineAnnotation() = default;
  ~PipelineAnnotation() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, PipelineAnnotation, "a3985897-1e81-59f3-bccb-90f4b1b39423");
