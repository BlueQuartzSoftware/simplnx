 ...
 */
class COMPLEX_EXPORT RemoveArrays : public IFilter
{
public:
  RemoveArrays() = default;
  ~RemoveArrays() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex::RemoveArrays, "3904f93a-b609-5f2a-ab4e-f566841866b2");
