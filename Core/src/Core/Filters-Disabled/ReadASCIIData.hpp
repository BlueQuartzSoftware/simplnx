 ...
 */
class COMPLEX_EXPORT ReadASCIIData : public IFilter
{
public:
  ReadASCIIData() = default;
  ~ReadASCIIData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReadASCIIData, "d4883870-531f-5065-8de5-aa521b503500");
