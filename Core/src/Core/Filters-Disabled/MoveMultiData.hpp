 ...
 */
class COMPLEX_EXPORT MoveMultiData : public IFilter
{
public:
  MoveMultiData() = default;
  ~MoveMultiData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, MoveMultiData, "0b2737bb-344a-56f9-99c7-bbb7f7f09ea9");
