 ...
 */
class COMPLEX_EXPORT RotateSampleRefFrame : public IFilter
{
public:
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_RotationRepresentationChoice_Key = "RotationRepresentationChoice";
  ...
  static inline constexpr StringLiteral k_RotationTable_Key = "RotationTable";
...
COMPLEX_DEF_FILTER_TRAITS(complex, RotateSampleRefFrame, "60064e6a-b578-5398-9d8a-019825cfc5ea");
