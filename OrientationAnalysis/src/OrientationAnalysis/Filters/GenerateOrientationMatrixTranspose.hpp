 ...
 */
class COMPLEX_EXPORT GenerateOrientationMatrixTranspose : public IFilter
{
public:
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_OrientationMatrixDataArrayPath_Key = "OrientationMatrixDataArrayPath";
...
COMPLEX_DEF_FILTER_TRAITS(complex::GenerateOrientationMatrixTranspose, "ec58f4fe-8e51-527e-9536-8b6f185684be");
