 ...
 */
class COMPLEX_EXPORT FindGBCDMetricBased : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_ChosenLimitDists_Key = "ChosenLimitDists";
...
COMPLEX_DEF_FILTER_TRAITS(complex::FindGBCDMetricBased, "1cf0de20-4cdf-53a3-893d-4f9d3a70b62e");
