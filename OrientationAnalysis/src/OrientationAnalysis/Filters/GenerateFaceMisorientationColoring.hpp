 ...
 */
class COMPLEX_EXPORT GenerateFaceMisorientationColoring : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::GenerateFaceMisorientationColoring, "b4fccecd-d827-5d8e-aa45-5f5f50de11f8");
