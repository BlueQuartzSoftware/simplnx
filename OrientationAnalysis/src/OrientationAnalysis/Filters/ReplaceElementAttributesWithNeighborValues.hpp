 ...
 */
class COMPLEX_EXPORT ReplaceElementAttributesWithNeighborValues : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ReplaceElementAttributesWithNeighborValues, "24e515cd-f586-59db-86bd-6bc135aa27ef");
