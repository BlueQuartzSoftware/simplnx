 ...
 */
class COMPLEX_EXPORT GenerateFaceIPFColoring : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_SurfaceMeshFaceIPFColorsArrayName_Key = "SurfaceMeshFaceIPFColorsArrayName";
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateFaceIPFColoring, "f5a92f32-b387-50f3-9d02-f54203b5b60c");
