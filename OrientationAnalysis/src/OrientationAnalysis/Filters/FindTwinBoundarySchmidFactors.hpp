 ...
 */
class COMPLEX_EXPORT FindTwinBoundarySchmidFactors : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::FindTwinBoundarySchmidFactors, "98d6940d-f000-5547-a955-94771aa770a8");
