 ...
 */
class COMPLEX_EXPORT BadDataNeighborOrientationCheck : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::BadDataNeighborOrientationCheck, "5c7e5d98-8cfa-5d06-bbe5-f53b3e6817c7");
