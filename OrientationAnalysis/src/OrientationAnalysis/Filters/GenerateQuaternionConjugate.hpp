 ...
 */
class COMPLEX_EXPORT GenerateQuaternionConjugate : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::GenerateQuaternionConjugate, "630d7486-75ea-5e04-874c-894460cd7c4d");
