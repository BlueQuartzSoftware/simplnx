 ...
 */
class COMPLEX_EXPORT NeighborOrientationCorrelation : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, NeighborOrientationCorrelation, "b5eec343-6b30-5e06-a544-8bd8619c2593");
