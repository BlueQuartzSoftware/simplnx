 ...
 */
class ORIENTATIONANALYSIS_EXPORT ReadAngData : public IFilter
{
public:
  ReadAngData() = default;
  ~ReadAngData() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReadAngData, "b8e128a8-c2a3-5e6c-a7ad-e4fb864e5d40");
