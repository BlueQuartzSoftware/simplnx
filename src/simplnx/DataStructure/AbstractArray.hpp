...
namespace nx::core
{
class SIMPLNX_EXPORT AbstractArray : public AbstractDataObject
{
public:
  static constexpr StringLiteral k_TypeName = "IArray";
  ...
  AbstractArray& operator=(AbstractArray&&) noexcept = delete;
...
protected:
  AbstractArray(DataStructure& dataStructure, std::string name)
  : AbstractDataObject(dataStructure, std::move(name))
  {
  }

  AbstractArray(DataStructure& dataStructure, std::string name, IdType importId)
