 ...
 */
class SIMPLNX_EXPORT AbstractNeighborList : public AbstractArray
{
public:
  static constexpr StringLiteral k_TypeName = "INeighborList";

  ~AbstractNeighborList() noexcept override;
...
protected:
  /**
   * @brief Constructs a new AbstractNeighborList
   * @param dataStructure
   * @param name
   * @param numTuples
   */
  AbstractNeighborList(DataStructure& dataStructure, const std::string& name);
   ...
   * @param importId
   */
  AbstractNeighborList(DataStructure& dataStructure, const std::string& name, IdType importId);
