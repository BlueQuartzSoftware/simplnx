...
class SIMPLNX_EXPORT AbstractNodeGeometry2D : public AbstractNodeGeometry1D, public INodeGeometry2D
{
public:
  static constexpr StringLiteral k_TypeName = "INodeGeometry2D";

  AbstractNodeGeometry2D() = delete;
  AbstractNodeGeometry2D(const AbstractNodeGeometry2D&) = default;
  AbstractNodeGeometry2D(AbstractNodeGeometry2D&&) = default;

  AbstractNodeGeometry2D& operator=(const AbstractNodeGeometry2D&) = delete;
  AbstractNodeGeometry2D& operator=(AbstractNodeGeometry2D&&) noexcept = delete;

  ~AbstractNodeGeometry2D() noexcept override = default;
   ...
   * @return
   */
  usize getNumberOfVerticesPerFace() const override = 0;
   ...
   * @return Result<>
   */
  Result<> findEdges(bool recalculate) override = 0;
   ...
   * @return Result<>
   */
  Result<> findUnsharedEdges(bool recalculate) override = 0;
...
protected:
  AbstractNodeGeometry2D(DataStructure& dataStructure, std::string name);

  AbstractNodeGeometry2D(DataStructure& dataStructure, std::string name, IdType importId);
