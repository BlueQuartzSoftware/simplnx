...
namespace nx::core
{
class SIMPLNX_EXPORT AbstractNodeGeometry0D : public AbstractGeometry, public INodeGeometry0D
{
public:
  static constexpr StringLiteral k_TypeName = "INodeGeometry0D";

  AbstractNodeGeometry0D() = delete;
  AbstractNodeGeometry0D(const AbstractNodeGeometry0D&) = default;
  AbstractNodeGeometry0D(AbstractNodeGeometry0D&&) = default;

  AbstractNodeGeometry0D& operator=(const AbstractNodeGeometry0D&) = delete;
  AbstractNodeGeometry0D& operator=(AbstractNodeGeometry0D&&) noexcept = delete;

  ~AbstractNodeGeometry0D() noexcept override = default;
...
protected:
  AbstractNodeGeometry0D(DataStructure& dataStructure, std::string name);

  AbstractNodeGeometry0D(DataStructure& dataStructure, std::string name, IdType importId);
