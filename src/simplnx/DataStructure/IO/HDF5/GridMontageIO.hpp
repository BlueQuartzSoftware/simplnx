...
public:
   ...
   * @return Result<>
   */
  Result<> readData(DataStructureReader& dataStructureReader, const group_reader_type& parentGroup, const std::string& montageName, AbstractDataObject::IdType importId,
   ...
   * Returns an error if the AbstractDataObject cannot be cast to a GridMontage.
