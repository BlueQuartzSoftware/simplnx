...
AbstractDataObject::Type HexahedralGeomIO::getDataType() const
{
...
Result<> HexahedralGeomIO::readData(DataStructureReader& structureReader, const group_reader_type& parentGroup, const std::string& objectName, AbstractDataObject::IdType importId,
                                    const std::optional<AbstractDataObject::IdType>& parentId, bool useEmptyDataStore) const
{
  ...
  return AbstractNodeGeom3dIO::ReadNodeGeom3dData(structureReader, *geom, parentGroup, objectName, importId, parentId, useEmptyDataStore);
}
...
Result<> HexahedralGeomIO::writeData(DataStructureWriter& structureReader, const HexahedralGeom& geom, group_writer_type& parentGroup, bool importable) const
{
  ...
  return AbstractNodeGeom3dIO::WriteNodeGeom3dData(structureReader, geom, parentGroup, importable);
}

Result<> HexahedralGeomIO::writeDataObject(DataStructureWriter& dataStructureWriter, const AbstractDataObject* dataObject, group_writer_type& parentWriter) const
{
