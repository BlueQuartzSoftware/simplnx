...
public:
  ...
  /**
   * @brief Finishes importing TetrahedralGeom data after the geometry has been created.
   * @param dataStructure The DataStructure containing the imported geometry
   * @param dataPath The path to the imported TetrahedralGeom
  ...
  /**
   * @brief Attempts to write a TetrahedralGeom to HDF5.
