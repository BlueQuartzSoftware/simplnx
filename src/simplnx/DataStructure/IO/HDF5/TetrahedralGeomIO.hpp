...
#include "simplnx/DataStructure/IO/HDF5/AbstractNodeGeom3dIO.hpp"
...
namespace HDF5
{
class SIMPLNX_EXPORT TetrahedralGeomIO : public AbstractNodeGeom3dIO
{
public:
   ...
   * Returns an error if the AbstractDataObject cannot be cast to a TetrahedralGeom.
