...
/**
 * @brief The AbstractDataIOManager class serves as a base point for reading and writing DataStructures to specific file formats.
 * To support a new file format, create a derived class and provide subclasses of IDataFactory for all concrete AbstractDataObject types.
 */
class SIMPLNX_EXPORT AbstractDataIOManager
{
public:
  ...
  virtual ~AbstractDataIOManager() noexcept;
  ...
  /**
   * @brief Returns a pointer to the factory used for creating a specific AbstractDataObject subclass.
   * @param typeName
