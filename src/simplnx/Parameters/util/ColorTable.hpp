...
namespace 
{
constexpr nx::core::StringLiteral k_ColorTableJsonStr = R"~([
   {
   ...
   },
   {
      ...
      "NanColor" : [ 0.8, 0.2980392156862745, 0.007843137254901961 ]
   },
   {
      "IndexedColors" : [
         1,
   ...
   {
      "IndexedColors" : [ 0.908659, 0.604013, 0.581857, 1, 0.862745, 0, 0, 0.695201, 0 ],
