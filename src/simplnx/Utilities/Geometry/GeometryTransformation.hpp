 ...
 */
struct SIMPLNX_EXPORT ApplyTransformationToGeometryInputValues
{
  ...
  bool SaveTransformMatrix = false;
};
 ...
 */
class SIMPLNX_EXPORT ApplyTransformationToGeometry
{
public:
  /**
  ...
  /**
   * @brief Destroys the geometry transformation algorithm.
   */
...
/**
 * @brief Plans geometry transformation actions without a plugin dependency.
 * @param dataStructure Contains the selected geometry and related data.
 * @param inputValues Contains transformation settings and data paths.
 * @return Output actions, warnings, display values, or a validation error.
 */
SIMPLNX_EXPORT IFilter::PreflightResult PreflightGeometryTransformation(const DataStructure& dataStructure, const ApplyTransformationToGeometryInputValues& inputValues);

/**
 * @brief Applies a geometry transformation without a plugin dependency.
 * @param dataStructure Contains the selected geometry and output objects.
 * @param inputValues Contains transformation settings and data paths.
 * @param messageHandler Receives algorithm messages.
 * @param shouldCancel Stops transformation when the value is true.
 * @return An error if the selected operation cannot complete.
 */
SIMPLNX_EXPORT Result<> ApplyGeometryTransformation(DataStructure& dataStructure, const ApplyTransformationToGeometryInputValues& inputValues, const IFilter::MessageHandler& messageHandler,
