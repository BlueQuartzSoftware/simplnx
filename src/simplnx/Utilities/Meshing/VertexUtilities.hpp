...
{
  AxialAlignment axis;
  std::vector<AbstractGeometry::MeshIndexType> ordering;
};
 ...
 */
SIMPLNX_EXPORT SortedVerticesList OrderSharedVertices(const AbstractNodeGeometry0D& geom, const std::atomic_bool& shouldCancel);
 ...
 * @param geom The input mesh
 * @returns std::vector<AbstractGeometry::MeshIndexType> which is the sorted indices along the given axis
 */
SIMPLNX_EXPORT std::vector<AbstractGeometry::MeshIndexType> OrderSharedVerticesAlongAxis(nx::core::MeshingUtilities::AxialAlignment axis,
                                                                                         const AbstractNodeGeometry0D::SharedVertexList::store_type& vertexList, const std::atomic_bool& shouldCancel);
 ...
 */
SIMPLNX_EXPORT bool HasDuplicateVertices(const AbstractGeometry::SharedVertexList::store_type& verts, const SortedVerticesList& sortedVertices);
} // namespace nx::core::MeshingUtilities
