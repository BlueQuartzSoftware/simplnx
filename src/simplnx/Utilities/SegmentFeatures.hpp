...
public:
  ...
  /**
   * @brief Original DFS-based segmentation (kept for backward compatibility).
   * @param gridGeom
   * @return
   */
   ...
   * Subclasses must override isValidVoxel(), areNeighborsSimilar(), and
   * getFeatureIdsStore() to use this code path.
   * @param gridGeom
