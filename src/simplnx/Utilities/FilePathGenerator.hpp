 ...
 * @param order How should the file list be generated by starting at the start value and increasing or starting at the endIndex and decreasing
 ...
 * @return The list of files generated from the input parameters and whether or not any of the generated files are missing.
 */
 ...
 * @param fileExtension The file extension (including the '.' char)
 * @param paddingDigits the number of padding digits to use when generating the integer index value
 * @return The list of files generated from the input parameters
 */
...
/**
 * @brief GenerateExampleFile This method will generate an example file name based on the given input parameters
 * @param start Z Slice Start
 * @param end Z Slice End
 * @param increment How much to increment each item
 * @param order How should the file list be generated by starting at the start value and increasing or starting at the endIndex and decreasing
 * @param inputPath Example File Name
 * @param filePrefix The start of the file name
 ...
 * @param fileExtension The file extension (including the '.' char)
 * @param paddingDigits the number of padding digits to use when generating the integer index value
 * @return The example generated filename
 */
SIMPLNX_EXPORT std::string GenerateExampleFile(int32 start, int32 end, int32 increment, Ordering order, std::string_view inputPath, std::string_view filePrefix, std::string_view fileSuffix,
                                               std::string_view fileExtension, uint32 paddingDigits);
} // namespace FilePathGenerator
} // namespace nx::core
