...
namespace nx::core
{
AbstractFilter::~AbstractFilter() noexcept = default;

IFilter::PreflightResult AbstractFilter::preflight(const DataStructure& data, const Arguments& args, const MessageHandler& messageHandler, const std::atomic_bool& shouldCancel,
...
IFilter::ExecuteResult AbstractFilter::execute(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineFilter, const MessageHandler& messageHandler,
...
nlohmann::json AbstractFilter::toJson(const Arguments& args) const
{
  nlohmann::json json;
...
Result<Arguments> AbstractFilter::fromJson(const nlohmann::json& json) const
{
  Parameters params = parameters();
  Arguments args;
  std::vector<Error> errors;
...
std::vector<std::string> AbstractFilter::defaultTags() const
{
  return {};
}

Arguments AbstractFilter::getDefaultArguments() const
{
  Arguments args;
