...
public:
  ...
  /**
   * @brief Constructs a CreateStringArrayAction.
   * @param tDims The tuple dimensions
   * @param path The path where the StringArray will be created
   * @param initializeValue The initial value for all strings
   */
