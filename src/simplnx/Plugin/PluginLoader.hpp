...
namespace nx::core
{
class SIMPLNX_EXPORT IPluginLoader
{
public:
...
class SIMPLNX_EXPORT InMemoryPluginLoader : public IPluginLoader
{
public:
 ...
 */
class SIMPLNX_EXPORT PluginLoader : public IPluginLoader
{
public:
  /**
