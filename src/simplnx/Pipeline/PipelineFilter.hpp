...
public:
  ...
  using ErrorsChangedSignal = nod::signal<void(std::vector<nx::core::Error>)>;
   ...
   */
  static std::string CreateErrorComments(const nx::core::ErrorCollection& errors, const std::string& prefix);
