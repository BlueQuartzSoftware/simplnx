 ...
 */
class COMPLEXCORE_EXPORT FindFeatureClusteringFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindFeatureClusteringFilter, "d6e01678-3a03-433f-89ad-4e9adf1f9a45");
