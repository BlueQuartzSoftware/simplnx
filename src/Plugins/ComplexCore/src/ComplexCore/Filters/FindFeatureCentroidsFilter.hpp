 ...
 */
class COMPLEXCORE_EXPORT FindFeatureCentroidsFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindFeatureCentroidsFilter, "c6875ac7-8bdd-4f69-b6ce-82ac09bd3421");
