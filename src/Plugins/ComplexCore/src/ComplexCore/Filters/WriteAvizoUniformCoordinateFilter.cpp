...
Result<Arguments> AvizoUniformCoordinateWriterFilter::FromSIMPLJson(const nlohmann::json& json)
{
  Arguments args = AvizoUniformCoordinateWriterFilter().getDefaultArguments();
