...
Parameters CropVertexGeometry::parameters() const
{
  ...
  params.insert(std::make_unique<MultiArraySelectionParameter>(k_TargetArrayPaths_Key, "Vertex Data Arrays to crop", "", std::vector<DataPath>(), complex::k_AllDataTypes));
