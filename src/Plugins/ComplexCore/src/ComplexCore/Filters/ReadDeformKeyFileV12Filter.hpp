 ...
 */
class COMPLEXCORE_EXPORT ReadDeformKeyFileV12Filter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReadDeformKeyFileV12Filter, "22c421c3-573c-4125-883c-4d95bd6e3bcb");
