 ...
 * at the help file.
 */
class COMPLEXCORE_EXPORT FeatureFaceCurvatureFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FeatureFaceCurvatureFilter, "56165fa5-dd80-4f9e-9e13-1c516f65060f");
