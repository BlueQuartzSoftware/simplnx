                                                                ...
                                                                const std::atomic_bool& shouldCancel) const
{
  ...
  auto numTupleCheckResult = dataStructure.validateNumberOfTuples({pEquivalentDiametersArrayPathValue, pFeaturePhasesArrayPathValue, pCentroidsArrayPathValue});
