 ...
 */
class COMPLEXCORE_EXPORT ReadBinaryCTNorthstarFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReadBinaryCTNorthstarFilter, "5469af5c-368a-465b-87b7-7c0dfdf73666");
