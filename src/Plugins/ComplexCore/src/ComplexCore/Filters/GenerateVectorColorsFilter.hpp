 ...
 */
class COMPLEXCORE_EXPORT GenerateVectorColorsFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateVectorColorsFilter, "1a35650d-a9f5-4ea2-af70-5b9ce894e45f");
