 ...
 */
class COMPLEXCORE_EXPORT ConvertColorToGrayScaleFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ConvertColorToGrayScaleFilter, "d938a2aa-fee2-4db9-aa2f-2c34a9736580");
