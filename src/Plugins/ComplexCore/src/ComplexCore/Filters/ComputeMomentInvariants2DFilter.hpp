 ...
 */
class COMPLEXCORE_EXPORT ComputeMomentInvariants2DFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ComputeMomentInvariants2DFilter, "650aa454-130c-406e-a9df-80b99f89e03c");
