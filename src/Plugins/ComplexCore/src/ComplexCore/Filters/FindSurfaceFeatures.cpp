                                                            ...
                                                            const std::atomic_bool& shouldCancel) const
{
  ...
  {
    auto createSurfaceFeaturesAction = std::make_unique<CreateArrayAction>(NumericType::int8, std::vector<usize>{1}, std::vector<usize>{1}, pSurfaceFeaturesArrayPathValue);
