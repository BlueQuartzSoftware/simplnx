 ...
 */
class COMPLEXCORE_EXPORT AlignSectionsListFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, AlignSectionsListFilter, "6c0e9fcf-bea2-4939-999e-e26379ed7aad");
