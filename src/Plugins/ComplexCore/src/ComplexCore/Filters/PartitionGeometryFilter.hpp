 ...
 */
class COMPLEXCORE_EXPORT PartitionGeometryFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, PartitionGeometryFilter, "aad29ebc-bf1c-5dd3-ad25-0f7f8907a02d");
