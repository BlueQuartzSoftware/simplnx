...
Parameters KMeansFilter::parameters() const
{
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_MaskArrayPath_Key, "Mask", "Boolean array where true means that Means will be determined for", DataPath{},
