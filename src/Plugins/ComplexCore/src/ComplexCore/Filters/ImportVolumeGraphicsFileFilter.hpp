...
{
/**
 * @class ImportVolumeGraphicsFileFilter
 ...
 */
class COMPLEXCORE_EXPORT ImportVolumeGraphicsFileFilter : public IFilter
{
public:
  ImportVolumeGraphicsFileFilter();
  ~ImportVolumeGraphicsFileFilter() noexcept override;

  ImportVolumeGraphicsFileFilter(const ImportVolumeGraphicsFileFilter&) = delete;
  ImportVolumeGraphicsFileFilter(ImportVolumeGraphicsFileFilter&&) noexcept = delete;

  ImportVolumeGraphicsFileFilter& operator=(const ImportVolumeGraphicsFileFilter&) = delete;
  ImportVolumeGraphicsFileFilter& operator=(ImportVolumeGraphicsFileFilter&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportVolumeGraphicsFileFilter, "dfd93665-b455-499a-abed-36ae7dbcdf57");
