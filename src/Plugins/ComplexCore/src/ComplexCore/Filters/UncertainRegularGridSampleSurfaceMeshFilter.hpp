 ...
 */
class COMPLEXCORE_EXPORT UncertainRegularGridSampleSurfaceMeshFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, UncertainRegularGridSampleSurfaceMeshFilter, "c594cc3b-3f45-43b1-9030-1aa56c755fc8");
