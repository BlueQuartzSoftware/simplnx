...
public:
  ...
  ImportBinaryCTNorthstarFilter& operator=(const ImportBinaryCTNorthstarFilter&) = delete;
  ImportBinaryCTNorthstarFilter& operator=(ImportBinaryCTNorthstarFilter&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportBinaryCTNorthstarFilter, "5469af5c-368a-465b-87b7-7c0dfdf73666");
