...
std::vector<float> LaplacianSmoothing::generateLambdaArray()
{
  ...
  for(size_t i = 0; i < numNodes; ++i)
  {
    ...
    case complex::NodeType::Unused:
      break;
    case complex::NodeType::Default:
      lambdas[i] = m_InputValues->pLambda;
      break;
    case complex::NodeType::TriplePoint:
      lambdas[i] = m_InputValues->pTripleLineLambda;
      break;
    case complex::NodeType::QuadPoint:
      lambdas[i] = m_InputValues->pQuadPointLambda;
      break;
    case complex::NodeType::SurfaceDefault:
      lambdas[i] = m_InputValues->pSurfacePointLambda;
      break;
    case complex::NodeType::SurfaceTriplePoint:
      lambdas[i] = m_InputValues->pSurfaceTripleLineLambda;
      break;
    case complex::NodeType::SurfaceQuadPoint:
