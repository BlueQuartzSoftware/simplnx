 ...
 */
class COMPLEXCORE_EXPORT WriteFeatureDataCSVFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, WriteFeatureDataCSVFilter, "d734293f-3017-4699-b458-c05aca078b96");
