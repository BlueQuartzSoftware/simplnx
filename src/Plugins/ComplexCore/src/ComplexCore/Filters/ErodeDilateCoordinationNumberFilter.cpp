...
Parameters ErodeDilateCoordinationNumberFilter::parameters() const
{
  ...
  params.insert(std::make_unique<Int32Parameter>(k_CoordinationNumber_Key, "Coordination Number to Consider", " Number of neighboring **Cells** that can be of opposite classification before a **Cell** will be removed", 6));
