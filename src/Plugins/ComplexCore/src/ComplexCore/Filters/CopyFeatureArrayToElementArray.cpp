...
Parameters CopyFeatureArrayToElementArray::parameters() const
{
  ...
  params.insert(std::make_unique<MultiArraySelectionParameter>(k_SelectedFeatureArrayPath_Key, "Feature Data to Copy to Element Data", "The DataPath to the feature data that should be copied to the cell level", MultiArraySelectionParameter::ValueType{},
