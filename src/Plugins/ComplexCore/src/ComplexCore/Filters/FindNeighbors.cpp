...
Parameters FindNeighbors::parameters() const
{
  ...
  params.insert(std::make_unique<MultiArraySelectionParameter>(k_CellFeatures_Key, "Cell Feature AttributeMatrix", "", std::vector<DataPath>{}, complex::GetAllDataTypes()));
