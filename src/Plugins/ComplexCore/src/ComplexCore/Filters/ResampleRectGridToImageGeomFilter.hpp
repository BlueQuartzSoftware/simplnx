 ...
 */
class COMPLEXCORE_EXPORT ResampleRectGridToImageGeomFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ResampleRectGridToImageGeomFilter, "28ed3258-41b2-45a0-8f37-6574264650f9");
