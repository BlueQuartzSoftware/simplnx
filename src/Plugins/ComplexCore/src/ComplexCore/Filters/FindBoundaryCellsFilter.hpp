 ...
 */
class COMPLEXCORE_EXPORT FindBoundaryCellsFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindBoundaryCellsFilter, "a1dd1c29-9152-4648-836c-3b6967e32600");
