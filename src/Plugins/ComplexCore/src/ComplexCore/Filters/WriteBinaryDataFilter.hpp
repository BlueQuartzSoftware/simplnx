 ...
 */
class COMPLEXCORE_EXPORT WriteBinaryDataFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, WriteBinaryDataFilter, "06912cbc-9745-4098-8d44-c674974d2ca8");
