 ...
 */
class COMPLEXCORE_EXPORT CombineAttributeArraysFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, CombineAttributeArraysFilter, "2436b614-e96d-47f0-9f6f-41d6fe97acd4");
