...
TEST_CASE("ComplexCore::ComputeMomentInvariants2DFilter: Valid Filter Execution", "[ComplexCore][ComputeMomentInvariants2DFilter]")
{
  TestBinomial();
  TestBigX();
...
TEST_CASE("ComplexCore::ComputeMomentInvariants2DFilter: InValid Filter Execution", "[ComplexCore][ComputeMomentInvariants2DFilter]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ComputeMomentInvariants2DFilter filter;
