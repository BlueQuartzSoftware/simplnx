...
private:
  ...
  void setMemb()
  {
    ...
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "int8"));
      setFillValue(-65, -63, -61);
    }
    else if(std::is_same<T, int16>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "int16"));
      setFillValue(-650, -648, -646);
    }
    else if(std::is_same<T, int32>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "int32"));
      setFillValue(-6500, -6498, -6496);
    }
    else if(std::is_same<T, int64>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "int64"));
      setFillValue(-65000, -64998, -64996);
    }
    else if(std::is_same<T, uint8>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "uint8"));
      setFillValue(65, 67, 69);
    }
    else if(std::is_same<T, uint16>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "uint16"));
      setFillValue(650, 652, 654);
    }
    else if(std::is_same<T, uint32>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "uint32"));
      setFillValue(6500, 6502, 6504);
    }
    else if(std::is_same<T, uint64>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "uint64"));
      setFillValue(65000, 65002, 65004);
    }
    else if(std::is_same<T, float32>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "float32"));
      setFillValue(65.001, 67.001, 69.001);
    }
    else if(std::is_same<T, float64>::value)
    {
      m_ExemplarsPath = fs::path(fmt::format("{}/TestFiles/write_ascii_data_exemplars/{}", unit_test::k_DREAM3DDataDir.view(), "float64"));
