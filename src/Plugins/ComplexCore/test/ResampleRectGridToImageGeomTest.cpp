...
{
  const std::string kDataInputArchive = "6_6_resample_rect_grid_to_image_geom.tar.gz";
  const std::string kExpectedOutputTopLevel = "6_6_resample_rect_grid_to_image_geom.dream3d";
