...
TEST_CASE("ComplexCore::WriteVtkRectilinearGridFilter: Valid Filter Execution", "[ComplexCore][WriteVtkRectilinearGridFilter]")
{
...
TEST_CASE("ComplexCore::WriteVtkRectilinearGridFilter: InValid Filter Execution", "[ComplexCore][WriteVtkRectilinearGridFilter]")
{
  const complex::UnitTest::TestFileSentinel testDataSentinel(complex::unit_test::k_CMakeExecutable, complex::unit_test::k_TestFilesDir, "Small_IN100_dream3d.tar.gz", "Small_IN100.dream3d");
