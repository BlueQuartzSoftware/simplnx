...
{
  const std::string kDataInputArchive = "6_6_find_feature_boundary_element_fractions.tar.gz";
  const std::string kExpectedOutputTopLevel = "6_6_find_feature_boundary_element_fractions";
