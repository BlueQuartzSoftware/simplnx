...
TEST_CASE("ComplexCore::FindLargestCrossSectionsFilter: Valid Filter Execution", "[ComplexCore][FindLargestCrossSectionsFilter]")
{
...
TEST_CASE("ComplexCore::FindLargestCrossSectionsFilter: InValid Filter Execution")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  FindLargestCrossSectionsFilter filter;
  Arguments args;
