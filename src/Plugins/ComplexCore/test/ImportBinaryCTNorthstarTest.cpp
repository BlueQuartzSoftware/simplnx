...
namespace
{
const fs::path k_TestDirPath = fs::path(complex::unit_test::k_BinaryTestOutputDir.str());
...
TEST_CASE("ComplexCore::ReadBinaryCTNorthStarFilter: Valid filter execution")
{
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
...
TEST_CASE("ComplexCore::ReadBinaryCTNorthStarFilter: Valid filter execution with subvolume")
{
  ...
  // Create default Parameters for the filter.
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{1, 2, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 3, 6}));
  ...
  REQUIRE_NOTHROW(dataStructure.getDataRefAs<Float32Array>(densityArrayPath));
  const Float32Array& densityResult = dataStructure.getDataRefAs<Float32Array>(densityArrayPath);
  auto startVoxelCoord = args.value<VectorInt32Parameter::ValueType>(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key);
  auto endVoxelCoord = args.value<VectorInt32Parameter::ValueType>(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key);
...
TEST_CASE("ComplexCore::ReadBinaryCTNorthStarFilter: Invalid filter execution - Incorrect Start/End Coords")
{
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 2, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 3, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 3, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 2, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 2, 6}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 3, 4}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, -1, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 3, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 2, -1}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 3, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_InputHeaderFile_Key, std::make_any<FileSystemPathParameter::ValueType>(k_NsiHeaderPath));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 2, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{9, 3, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 2, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 9, 6}));
  ...
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_ImportSubvolume_Key, std::make_any<bool>(true));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_StartVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{3, 2, 4}));
  args.insertOrAssign(ImportBinaryCTNorthstarFilter::k_EndVoxelCoord_Key, std::make_any<VectorInt32Parameter::ValueType>(std::vector<int32>{4, 3, 9}));
