...
TEST_CASE("MapPointCloudToRegularGridFilter: Instantiate Filter", "[MapPointCloudToRegularGridFilter]")
{
  ...
  args.insertOrAssign(MapPointCloudToRegularGridFilter::k_ImageGeometry_Key, std::make_any<DataPath>(imageGeomPath));
...
TEST_CASE("MapPointCloudToRegularGridFilter: Test Algorithm", "[MapPointCloudToRegularGridFilter]")
{
  MapPointCloudToRegularGridFilter filter;
