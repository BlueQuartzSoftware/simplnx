...
void CreateVerticesArray(DataStructure& dataGraph, const std::string& name, DataObject::IdType parentId)
{
  Float32Array* verticesArray = UnitTest::CreateTestDataArray<float32>(dataGraph, name, {144}, {3}, parentId);
...
void CreateEdgesArray(DataStructure& dataGraph, const std::string& name, DataObject::IdType parentId)
{
  IGeometry::MeshIndexArrayType* edgesListArray = UnitTest::CreateTestDataArray<IGeometry::MeshIndexType>(dataGraph, name, {264}, {2}, parentId);
  (*edgesListArray)[0] = 12;
  (*edgesListArray)[1] = 0;
  (*edgesListArray)[2] = 0;
  (*edgesListArray)[3] = 1;
...
void CreateTrianglesArray(DataStructure& dataGraph, const std::string& name, DataObject::IdType parentId)
{
  IGeometry::MeshIndexArrayType* trianglesListArray = UnitTest::CreateTestDataArray<IGeometry::MeshIndexType>(dataGraph, name, {242}, {3}, parentId);
...
void CreateQuadsArray(DataStructure& dataGraph, const std::string& name, DataObject::IdType parentId)
{
  IGeometry::MeshIndexArrayType* quadsListArray = UnitTest::CreateTestDataArray<IGeometry::MeshIndexType>(dataGraph, name, {121}, {4}, parentId);
  (*quadsListArray)[0] = 0;
  (*quadsListArray)[1] = 1;
  (*quadsListArray)[2] = 13;
  (*quadsListArray)[3] = 12;
...
void CreateTetAndVerticesArrays(DataStructure& dataGraph, const std::string& verticesName, const std::string& tetsName, DataObject::IdType parentId)
{
  Float32Array* vertListArray = UnitTest::CreateTestDataArray<float32>(dataGraph, verticesName, {5}, {3}, parentId);
  (*vertListArray)[0] = -1;
  (*vertListArray)[1] = 0.5;
  (*vertListArray)[2] = 0;
  (*vertListArray)[3] = 0;
  ...
  (*vertListArray)[14] = 0;
  IGeometry::MeshIndexArrayType* polyListArray = UnitTest::CreateTestDataArray<IGeometry::MeshIndexType>(dataGraph, tetsName, {2}, {4}, parentId);
  (*polyListArray)[0] = 0;
  (*polyListArray)[1] = 1;
  (*polyListArray)[2] = 2;
  (*polyListArray)[3] = 3;
...
void CreateHexAndVerticesArrays(DataStructure& dataGraph, const std::string& verticesName, const std::string& hexsName, DataObject::IdType parentId)
{
  Float32Array* vertListArray = UnitTest::CreateTestDataArray<float32>(dataGraph, verticesName, {12}, {3}, parentId);
  (*vertListArray)[0] = -1;
  (*vertListArray)[1] = 1;
  (*vertListArray)[2] = 1;
  (*vertListArray)[3] = -1;
  ...
  (*vertListArray)[34] = -1;
  (*vertListArray)[35] = 1;
  IGeometry::MeshIndexArrayType* polyListArray = UnitTest::CreateTestDataArray<IGeometry::MeshIndexType>(dataGraph, hexsName, {2}, {8}, parentId);
  (*polyListArray)[0] = 6;
  (*polyListArray)[1] = 7;
  (*polyListArray)[2] = 4;
  (*polyListArray)[3] = 5;
...
void CreateIncompatibleVerticesArray(DataStructure& dataGraph, const std::string& name, DataObject::IdType parentId)
{
  Float32Array* verticesArray = UnitTest::CreateTestDataArray<float32>(dataGraph, name, {2}, {3}, parentId);
  (*verticesArray)[0] = -0.707107;
  (*verticesArray)[1] = -0.707107;
  (*verticesArray)[2] = 0;
  (*verticesArray)[3] = -0.599278;
...
TEST_CASE("ComplexCore::CreateGeometry: Instantiation and Parameter Check", "[ComplexCore][CreateGeometry]")
{
  ...
  CreateVerticesArray(dataGraph, vertexListName, 0);
  CreateEdgesArray(dataGraph, edgeListName, 0);
  CreateTrianglesArray(dataGraph, triangleListName, 0);
  CreateQuadsArray(dataGraph, quadListName, 0);
  CreateTetAndVerticesArrays(dataGraph, tetVertexListName, tetListName, 0);
  CreateHexAndVerticesArrays(dataGraph, hexVertexListName, hexListName, 0);
  CreateIncompatibleVerticesArray(dataGraph, incompatibleVertexListName, 0);
  ...
  SECTION("Image Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<ImageGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    const auto cellAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(cellAmName));
  ...
  {
    Float32Array* xBoundsArray = UnitTest::CreateTestDataArray<float32>(dataGraph, xBoundsName, {14}, {1}, 0);
    (*xBoundsArray)[0] = 0;
    (*xBoundsArray)[1] = 1;
    (*xBoundsArray)[2] = 2;
    (*xBoundsArray)[3] = 3;
    ...
    (*xBoundsArray)[12] = 12;
    (*xBoundsArray)[13] = 14;
    Float32Array* yBoundsArray = UnitTest::CreateTestDataArray<float32>(dataGraph, yBoundsName, {14}, {1}, 0);
    (*yBoundsArray)[0] = 0;
    (*yBoundsArray)[1] = 2;
    (*yBoundsArray)[2] = 4;
    (*yBoundsArray)[3] = 6;
    ...
    (*yBoundsArray)[12] = 24;
    (*yBoundsArray)[13] = 26;
    Float32Array* zBoundsArray = UnitTest::CreateTestDataArray<float32>(dataGraph, zBoundsName, {14}, {1}, 0);
    (*zBoundsArray)[0] = 0;
    (*zBoundsArray)[1] = 5;
    (*zBoundsArray)[2] = 10;
    (*zBoundsArray)[3] = 15;
    ...
    const auto createdGeom = dataGraph.getDataAs<RectGridGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    ...
    REQUIRE(cellAm != nullptr);
    REQUIRE(createdGeom->getCellData() != nullptr);
    const auto destXBounds = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(xBoundsName));
    REQUIRE(destXBounds != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, xBoundsPath, geometryPath.createChildPath(xBoundsName));
    const auto destYBounds = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(yBoundsName));
    REQUIRE(destYBounds != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, yBoundsPath, geometryPath.createChildPath(yBoundsName));
    const auto destZBounds = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(zBoundsName));
    REQUIRE(destZBounds != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, zBoundsPath, geometryPath.createChildPath(zBoundsName));
  }
  ...
  SECTION("Vertex Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<VertexGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    const auto vertexAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(vertexAmName));
    REQUIRE(vertexAm != nullptr);
    REQUIRE(createdGeom->getVertexAttributeMatrix() != nullptr);
    const auto destVertices = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(vertexListName));
    REQUIRE(destVertices != nullptr);
    REQUIRE(createdGeom->getVertices() != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, srcVerticesPath, geometryPath.createChildPath(vertexListName));
  }
  ...
  SECTION("Edge Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<EdgeGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    ...
    const auto edgeAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(edgeAmName));
    REQUIRE(edgeAm != nullptr);
    REQUIRE(createdGeom->getEdgeAttributeMatrix() != nullptr);
    const auto destEdges = dataGraph.getDataAs<IGeometry::MeshIndexArrayType>(geometryPath.createChildPath(edgeListName));
    REQUIRE(destEdges != nullptr);
    REQUIRE(createdGeom->getEdges() != nullptr);
    UnitTest::CompareArrays<IGeometry::MeshIndexType>(dataGraph, srcEdgesPath, geometryPath.createChildPath(edgeListName));
  }
  ...
  SECTION("Triangle Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<TriangleGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    ...
    const auto faceAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(faceAmName));
    REQUIRE(faceAm != nullptr);
    REQUIRE(createdGeom->getFaceAttributeMatrix() != nullptr);
    const auto destFaces = dataGraph.getDataAs<IGeometry::MeshIndexArrayType>(geometryPath.createChildPath(triangleListName));
    REQUIRE(destFaces != nullptr);
    REQUIRE(createdGeom->getFaces() != nullptr);
    UnitTest::CompareArrays<IGeometry::MeshIndexType>(dataGraph, srcTrianglesPath, geometryPath.createChildPath(triangleListName));
  }
  ...
  SECTION("Quad Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<QuadGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);
    ...
    const auto quadAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(faceAmName));
    REQUIRE(quadAm != nullptr);
    REQUIRE(createdGeom->getFaceAttributeMatrix() != nullptr);
    const auto destFaces = dataGraph.getDataAs<IGeometry::MeshIndexArrayType>(geometryPath.createChildPath(quadListName));
    REQUIRE(destFaces != nullptr);
    REQUIRE(createdGeom->getFaces() != nullptr);
    UnitTest::CompareArrays<IGeometry::MeshIndexType>(dataGraph, srcQuadsPath, geometryPath.createChildPath(quadListName));
  }
  ...
  SECTION("Tetrahedral Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<TetrahedralGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);

    const auto vertexAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(vertexAmName));
    REQUIRE(vertexAm != nullptr);
    REQUIRE(createdGeom->getVertexAttributeMatrix() != nullptr);
    const auto destVertices = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(tetVertexListName));
    REQUIRE(destVertices != nullptr);
    REQUIRE(createdGeom->getVertices() != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, srcTetVerticesPath, geometryPath.createChildPath(tetVertexListName));

    const auto tetAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(cellAmName));
    REQUIRE(tetAm != nullptr);
    REQUIRE(createdGeom->getPolyhedraAttributeMatrix() != nullptr);
    const auto destCells = dataGraph.getDataAs<IGeometry::MeshIndexArrayType>(geometryPath.createChildPath(tetListName));
    REQUIRE(destCells != nullptr);
    REQUIRE(createdGeom->getPolyhedra() != nullptr);
    UnitTest::CompareArrays<IGeometry::MeshIndexType>(dataGraph, srcTetsPath, geometryPath.createChildPath(tetListName));
  }
  ...
  SECTION("Hexahedral Geometry Copy")
  {
    ...
    const auto createdGeom = dataGraph.getDataAs<HexahedralGeom>(geometryPath);
    REQUIRE(createdGeom != nullptr);

    const auto vertexAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(vertexAmName));
    REQUIRE(vertexAm != nullptr);
    REQUIRE(createdGeom->getVertexAttributeMatrix() != nullptr);
    const auto destVertices = dataGraph.getDataAs<Float32Array>(geometryPath.createChildPath(hexVertexListName));
    REQUIRE(destVertices != nullptr);
    REQUIRE(createdGeom->getVertices() != nullptr);
    UnitTest::CompareArrays<float32>(dataGraph, srcHexVerticesPath, geometryPath.createChildPath(hexVertexListName));

    const auto hexAm = dataGraph.getDataAs<AttributeMatrix>(geometryPath.createChildPath(cellAmName));
    REQUIRE(hexAm != nullptr);
    REQUIRE(createdGeom->getPolyhedraAttributeMatrix() != nullptr);
    const auto destCells = dataGraph.getDataAs<IGeometry::MeshIndexArrayType>(geometryPath.createChildPath(hexListName));
    REQUIRE(destCells != nullptr);
    REQUIRE(createdGeom->getPolyhedra() != nullptr);
    UnitTest::CompareArrays<IGeometry::MeshIndexType>(dataGraph, srcHexsPath, geometryPath.createChildPath(hexListName));
  }
  ...
  SECTION("Triangle Geometry Move")
  {
    ...
    REQUIRE(dataGraph.getData(srcVerticesPath) == nullptr);
    REQUIRE(dataGraph.getData(srcTrianglesPath) == nullptr);
  }
