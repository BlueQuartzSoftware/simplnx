                                                   ...
                                                   const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKValuedRegionalMinimaImage::ArrayOptionsT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor, messageHandler);
}
} // namespace complex
