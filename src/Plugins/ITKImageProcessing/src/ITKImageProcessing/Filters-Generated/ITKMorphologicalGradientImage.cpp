                                                    ...
                                                    const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKMorphologicalGradientImage::ArrayOptionsT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor, messageHandler);
}
} // namespace complex
