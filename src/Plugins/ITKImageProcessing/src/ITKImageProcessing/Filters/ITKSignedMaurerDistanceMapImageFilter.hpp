...
{
/**
 * @class ITKSignedMaurerDistanceMapImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKSignedMaurerDistanceMapImageFilter : public AbstractFilter
{
public:
  ITKSignedMaurerDistanceMapImageFilter() = default;
  ~ITKSignedMaurerDistanceMapImageFilter() noexcept override = default;

  ITKSignedMaurerDistanceMapImageFilter(const ITKSignedMaurerDistanceMapImageFilter&) = delete;
  ITKSignedMaurerDistanceMapImageFilter(ITKSignedMaurerDistanceMapImageFilter&&) noexcept = delete;

  ITKSignedMaurerDistanceMapImageFilter& operator=(const ITKSignedMaurerDistanceMapImageFilter&) = delete;
