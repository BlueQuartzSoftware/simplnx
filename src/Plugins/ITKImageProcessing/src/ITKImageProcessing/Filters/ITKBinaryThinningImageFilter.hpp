...
{
/**
 * @class ITKBinaryThinningImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKBinaryThinningImageFilter : public AbstractFilter
{
public:
  ITKBinaryThinningImageFilter() = default;
  ~ITKBinaryThinningImageFilter() noexcept override = default;

  ITKBinaryThinningImageFilter(const ITKBinaryThinningImageFilter&) = delete;
  ITKBinaryThinningImageFilter(ITKBinaryThinningImageFilter&&) noexcept = delete;

  ITKBinaryThinningImageFilter& operator=(const ITKBinaryThinningImageFilter&) = delete;
  ITKBinaryThinningImageFilter& operator=(ITKBinaryThinningImageFilter&&) noexcept = delete;
