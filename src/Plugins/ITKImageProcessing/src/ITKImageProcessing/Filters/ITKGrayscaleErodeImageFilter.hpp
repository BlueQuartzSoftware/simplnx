...
{
/**
 * @class ITKGrayscaleErodeImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKGrayscaleErodeImageFilter : public AbstractFilter
{
public:
  ITKGrayscaleErodeImageFilter() = default;
  ~ITKGrayscaleErodeImageFilter() noexcept override = default;

  ITKGrayscaleErodeImageFilter(const ITKGrayscaleErodeImageFilter&) = delete;
  ITKGrayscaleErodeImageFilter(ITKGrayscaleErodeImageFilter&&) noexcept = delete;

  ITKGrayscaleErodeImageFilter& operator=(const ITKGrayscaleErodeImageFilter&) = delete;
  ITKGrayscaleErodeImageFilter& operator=(ITKGrayscaleErodeImageFilter&&) noexcept = delete;
