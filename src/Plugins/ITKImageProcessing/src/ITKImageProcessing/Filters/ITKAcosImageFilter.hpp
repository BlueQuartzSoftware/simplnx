 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKAcosImageFilter : public AbstractFilter
{
public:
  ITKAcosImageFilter() = default;
  ~ITKAcosImageFilter() noexcept override = default;

  ITKAcosImageFilter(const ITKAcosImageFilter&) = delete;
  ITKAcosImageFilter(ITKAcosImageFilter&&) noexcept = delete;

  ITKAcosImageFilter& operator=(const ITKAcosImageFilter&) = delete;
  ITKAcosImageFilter& operator=(ITKAcosImageFilter&&) noexcept = delete;
