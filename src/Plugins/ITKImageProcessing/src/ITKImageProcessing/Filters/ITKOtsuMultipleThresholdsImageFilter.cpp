                                                                             ...
                                                                             const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions =
      ITK::DataCheck<cxITKOtsuMultipleThresholdsImageFilter::ArrayOptionsType, cxITKOtsuMultipleThresholdsImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);
                                                           ...
                                                           const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKOtsuMultipleThresholdsImageFilter::ArrayOptionsType, cxITKOtsuMultipleThresholdsImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath,
