...
{
/**
 * @class ITKBinaryOpeningByReconstructionImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKBinaryOpeningByReconstructionImageFilter : public AbstractFilter
{
public:
  ITKBinaryOpeningByReconstructionImageFilter() = default;
  ~ITKBinaryOpeningByReconstructionImageFilter() noexcept override = default;

  ITKBinaryOpeningByReconstructionImageFilter(const ITKBinaryOpeningByReconstructionImageFilter&) = delete;
  ITKBinaryOpeningByReconstructionImageFilter(ITKBinaryOpeningByReconstructionImageFilter&&) noexcept = delete;

  ITKBinaryOpeningByReconstructionImageFilter& operator=(const ITKBinaryOpeningByReconstructionImageFilter&) = delete;
  ITKBinaryOpeningByReconstructionImageFilter& operator=(ITKBinaryOpeningByReconstructionImageFilter&&) noexcept = delete;
