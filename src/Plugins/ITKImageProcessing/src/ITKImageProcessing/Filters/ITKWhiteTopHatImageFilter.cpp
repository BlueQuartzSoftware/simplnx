...
namespace cxITKWhiteTopHatImageFilter
{
...
{
//------------------------------------------------------------------------------
std::string ITKWhiteTopHatImageFilter::name() const
{
  return FilterTraits<ITKWhiteTopHatImageFilter>::name;
}

//------------------------------------------------------------------------------
std::string ITKWhiteTopHatImageFilter::className() const
{
  return FilterTraits<ITKWhiteTopHatImageFilter>::className;
}

//------------------------------------------------------------------------------
Uuid ITKWhiteTopHatImageFilter::uuid() const
{
  return FilterTraits<ITKWhiteTopHatImageFilter>::uuid;
}

//------------------------------------------------------------------------------
std::string ITKWhiteTopHatImageFilter::humanName() const
{
  return "ITK White Top Hat Image Filter";
}

//------------------------------------------------------------------------------
std::vector<std::string> ITKWhiteTopHatImageFilter::defaultTags() const
{
  return {className(), "ITKImageProcessing", "ITKWhiteTopHatImage", "ITKMathematicalMorphology", "MathematicalMorphology"};
}

//------------------------------------------------------------------------------
Parameters ITKWhiteTopHatImageFilter::parameters() const
{
  Parameters params;
...
//------------------------------------------------------------------------------
IFilter::VersionType ITKWhiteTopHatImageFilter::parametersVersion() const
{
  return 1;
}

//------------------------------------------------------------------------------
IFilter::UniquePointer ITKWhiteTopHatImageFilter::clone() const
{
  return std::make_unique<ITKWhiteTopHatImageFilter>();
}

//------------------------------------------------------------------------------
IFilter::PreflightResult ITKWhiteTopHatImageFilter::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler,
                                                                  const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions = ITK::DataCheck<cxITKWhiteTopHatImageFilter::ArrayOptionsType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);

  return {std::move(resultOutputActions)};
}

//------------------------------------------------------------------------------
Result<> ITKWhiteTopHatImageFilter::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler,
                                                const std::atomic_bool& shouldCancel) const
{
  auto imageGeomPath = filterArgs.value<DataPath>(k_InputImageGeomPath_Key);
  auto selectedInputArray = filterArgs.value<DataPath>(k_InputImageDataPath_Key);
  ...
  const cxITKWhiteTopHatImageFilter::ITKWhiteTopHatImageFunctor itkFunctor = {kernelRadius, kernelType, safeBorder};

  auto& imageGeom = dataStructure.getDataRefAs<ImageGeom>(imageGeomPath);

  return ITK::Execute<cxITKWhiteTopHatImageFilter::ArrayOptionsType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor, shouldCancel);
}
...
Result<Arguments> ITKWhiteTopHatImageFilter::FromSIMPLJson(const nlohmann::json& json)
{
  Arguments args = ITKWhiteTopHatImageFilter().getDefaultArguments();
