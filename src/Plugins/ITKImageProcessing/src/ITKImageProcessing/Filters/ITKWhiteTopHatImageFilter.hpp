...
{
/**
 * @class ITKWhiteTopHatImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKWhiteTopHatImageFilter : public AbstractFilter
{
public:
  ITKWhiteTopHatImageFilter() = default;
  ~ITKWhiteTopHatImageFilter() noexcept override = default;

  ITKWhiteTopHatImageFilter(const ITKWhiteTopHatImageFilter&) = delete;
  ITKWhiteTopHatImageFilter(ITKWhiteTopHatImageFilter&&) noexcept = delete;

  ITKWhiteTopHatImageFilter& operator=(const ITKWhiteTopHatImageFilter&) = delete;
  ITKWhiteTopHatImageFilter& operator=(ITKWhiteTopHatImageFilter&&) noexcept = delete;
