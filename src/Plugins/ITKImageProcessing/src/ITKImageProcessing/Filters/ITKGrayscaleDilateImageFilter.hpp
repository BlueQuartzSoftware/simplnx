...
{
/**
 * @class ITKGrayscaleDilateImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKGrayscaleDilateImageFilter : public AbstractFilter
{
public:
  ITKGrayscaleDilateImageFilter() = default;
  ~ITKGrayscaleDilateImageFilter() noexcept override = default;

  ITKGrayscaleDilateImageFilter(const ITKGrayscaleDilateImageFilter&) = delete;
  ITKGrayscaleDilateImageFilter(ITKGrayscaleDilateImageFilter&&) noexcept = delete;

  ITKGrayscaleDilateImageFilter& operator=(const ITKGrayscaleDilateImageFilter&) = delete;
  ITKGrayscaleDilateImageFilter& operator=(ITKGrayscaleDilateImageFilter&&) noexcept = delete;
