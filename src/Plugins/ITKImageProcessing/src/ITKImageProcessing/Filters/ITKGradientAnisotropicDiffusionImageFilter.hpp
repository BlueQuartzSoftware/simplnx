...
{
/**
 * @class ITKGradientAnisotropicDiffusionImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKGradientAnisotropicDiffusionImageFilter : public AbstractFilter
{
public:
  ITKGradientAnisotropicDiffusionImageFilter() = default;
  ~ITKGradientAnisotropicDiffusionImageFilter() noexcept override = default;

  ITKGradientAnisotropicDiffusionImageFilter(const ITKGradientAnisotropicDiffusionImageFilter&) = delete;
  ITKGradientAnisotropicDiffusionImageFilter(ITKGradientAnisotropicDiffusionImageFilter&&) noexcept = delete;

  ITKGradientAnisotropicDiffusionImageFilter& operator=(const ITKGradientAnisotropicDiffusionImageFilter&) = delete;
  ITKGradientAnisotropicDiffusionImageFilter& operator=(ITKGradientAnisotropicDiffusionImageFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKGradientAnisotropicDiffusionImageFilter, "9dcef77b-e7d2-4a2a-b310-bfa80e8ea7c5");
