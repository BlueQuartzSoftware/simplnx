                                                      ...
                                                      const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKGradientMagnitudeImageFilter::ArrayOptionsType, cxITKGradientMagnitudeImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor,
                                                                                                                    shouldCancel);
}
} // namespace nx::core
