                                                                              ...
                                                                              const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions =
      ITK::DataCheck<cxITKSignedMaurerDistanceMapImageFilter::ArrayOptionsType, cxITKSignedMaurerDistanceMapImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);
                                                            ...
                                                            const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKSignedMaurerDistanceMapImageFilter::ArrayOptionsType, cxITKSignedMaurerDistanceMapImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath,
