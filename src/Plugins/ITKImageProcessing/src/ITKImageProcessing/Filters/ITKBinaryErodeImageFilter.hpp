...
{
/**
 * @class ITKBinaryErodeImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKBinaryErodeImageFilter : public AbstractFilter
{
public:
  ITKBinaryErodeImageFilter() = default;
  ~ITKBinaryErodeImageFilter() noexcept override = default;

  ITKBinaryErodeImageFilter(const ITKBinaryErodeImageFilter&) = delete;
  ITKBinaryErodeImageFilter(ITKBinaryErodeImageFilter&&) noexcept = delete;

  ITKBinaryErodeImageFilter& operator=(const ITKBinaryErodeImageFilter&) = delete;
  ITKBinaryErodeImageFilter& operator=(ITKBinaryErodeImageFilter&&) noexcept = delete;
