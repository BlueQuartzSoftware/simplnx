...
{
/**
 * @class ITKLabelContourImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKLabelContourImageFilter : public AbstractFilter
{
public:
  ITKLabelContourImageFilter() = default;
  ~ITKLabelContourImageFilter() noexcept override = default;

  ITKLabelContourImageFilter(const ITKLabelContourImageFilter&) = delete;
  ITKLabelContourImageFilter(ITKLabelContourImageFilter&&) noexcept = delete;

  ITKLabelContourImageFilter& operator=(const ITKLabelContourImageFilter&) = delete;
  ITKLabelContourImageFilter& operator=(ITKLabelContourImageFilter&&) noexcept = delete;
