#include "ITKMhaFileReaderFilter.hpp"
...
{
//------------------------------------------------------------------------------
std::string ITKMhaFileReaderFilter::name() const
{
  return FilterTraits<ITKMhaFileReaderFilter>::name;
}

//------------------------------------------------------------------------------
std::string ITKMhaFileReaderFilter::className() const
{
  return FilterTraits<ITKMhaFileReaderFilter>::className;
}

//------------------------------------------------------------------------------
Uuid ITKMhaFileReaderFilter::uuid() const
{
  return FilterTraits<ITKMhaFileReaderFilter>::uuid;
}

//------------------------------------------------------------------------------
std::string ITKMhaFileReaderFilter::humanName() const
{
  return "ITK MHA File Reader";
}

//------------------------------------------------------------------------------
std::vector<std::string> ITKMhaFileReaderFilter::defaultTags() const
{
  return {className(), "io", "input", "read", "import", "image", "ITK", "MHA"};
}

//------------------------------------------------------------------------------
Parameters ITKMhaFileReaderFilter::parameters() const
{
  Parameters params;
                                                               ...
                                                               const std::atomic_bool& shouldCancel) const
{
  ...
  auto cellDataName = filterArgs.value<DataObjectNameParameter::ValueType>(ITKImageReaderFilter::k_CellDataName_Key);
  auto imageDataArrayName = filterArgs.value<DataObjectNameParameter::ValueType>(ITKImageReaderFilter::k_ImageDataArrayPath_Key);
...

  {
    ...
    imageReaderArgs.insertOrAssign(ITKImageReaderFilter::k_FileName_Key, fileNamePath);
    imageReaderArgs.insertOrAssign(ITKImageReaderFilter::k_ImageGeometryPath_Key, imageGeomPath);
    imageReaderArgs.insertOrAssign(ITKImageReaderFilter::k_CellDataName_Key, cellDataName);
    imageReaderArgs.insertOrAssign(ITKImageReaderFilter::k_ImageDataArrayPath_Key, imageDataArrayName);
                                             ...
                                             const std::atomic_bool& shouldCancel) const
{
  ...
  messageHandler(fmt::format("Reading image file '{}'...", fileNamePath.string()));
  {
    ...
    const ITKImageReaderFilter imageReaderFilter;
    Arguments args;
    args.insertOrAssign(ITKImageReaderFilter::k_FileName_Key, fileNamePath);
    args.insertOrAssign(ITKImageReaderFilter::k_ImageGeometryPath_Key, imageGeomPath);
    args.insertOrAssign(ITKImageReaderFilter::k_CellDataName_Key, cellDataName);
    args.insertOrAssign(ITKImageReaderFilter::k_ImageDataArrayPath_Key, imageDataArrayName);
