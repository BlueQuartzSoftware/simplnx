 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKAsinImageFilter : public AbstractFilter
{
public:
  ITKAsinImageFilter() = default;
  ~ITKAsinImageFilter() noexcept override = default;

  ITKAsinImageFilter(const ITKAsinImageFilter&) = delete;
  ITKAsinImageFilter(ITKAsinImageFilter&&) noexcept = delete;

  ITKAsinImageFilter& operator=(const ITKAsinImageFilter&) = delete;
  ITKAsinImageFilter& operator=(ITKAsinImageFilter&&) noexcept = delete;
