 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKGrayscaleFillholeImageFilter : public AbstractFilter
{
public:
  ITKGrayscaleFillholeImageFilter() = default;
  ~ITKGrayscaleFillholeImageFilter() noexcept override = default;

  ITKGrayscaleFillholeImageFilter(const ITKGrayscaleFillholeImageFilter&) = delete;
  ITKGrayscaleFillholeImageFilter(ITKGrayscaleFillholeImageFilter&&) noexcept = delete;

  ITKGrayscaleFillholeImageFilter& operator=(const ITKGrayscaleFillholeImageFilter&) = delete;
  ITKGrayscaleFillholeImageFilter& operator=(ITKGrayscaleFillholeImageFilter&&) noexcept = delete;
