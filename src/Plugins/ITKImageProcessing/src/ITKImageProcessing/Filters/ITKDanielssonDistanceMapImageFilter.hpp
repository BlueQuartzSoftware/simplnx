...
{
/**
 * @class ITKDanielssonDistanceMapImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKDanielssonDistanceMapImageFilter : public AbstractFilter
{
public:
  ITKDanielssonDistanceMapImageFilter() = default;
  ~ITKDanielssonDistanceMapImageFilter() noexcept override = default;

  ITKDanielssonDistanceMapImageFilter(const ITKDanielssonDistanceMapImageFilter&) = delete;
  ITKDanielssonDistanceMapImageFilter(ITKDanielssonDistanceMapImageFilter&&) noexcept = delete;

  ITKDanielssonDistanceMapImageFilter& operator=(const ITKDanielssonDistanceMapImageFilter&) = delete;
  ITKDanielssonDistanceMapImageFilter& operator=(ITKDanielssonDistanceMapImageFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKDanielssonDistanceMapImageFilter, "f0cd4faf-a676-41ed-9ea5-859035f94836");
