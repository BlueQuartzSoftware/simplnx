                                                    ...
                                                    const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKBinaryThresholdImageFilter::ArrayOptionsType, cxITKBinaryThresholdImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor,
                                                                                                                shouldCancel);
}
} // namespace nx::core
