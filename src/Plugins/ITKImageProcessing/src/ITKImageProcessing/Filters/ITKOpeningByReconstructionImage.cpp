...
Result<Arguments> ITKOpeningByReconstructionImage::FromSIMPLJson(const nlohmann::json& json)
{
  Arguments args = ITKOpeningByReconstructionImage().getDefaultArguments();
