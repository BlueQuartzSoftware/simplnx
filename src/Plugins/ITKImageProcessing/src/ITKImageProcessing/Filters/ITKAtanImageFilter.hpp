...
public:
  ...
  ITKAtanImageFilter(const ITKAtanImageFilter&) = delete;
  ITKAtanImageFilter(ITKAtanImageFilter&&) noexcept = delete;

  ITKAtanImageFilter& operator=(const ITKAtanImageFilter&) = delete;
