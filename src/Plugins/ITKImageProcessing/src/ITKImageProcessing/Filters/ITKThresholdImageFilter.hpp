 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKThresholdImageFilter : public AbstractFilter
{
public:
  ITKThresholdImageFilter() = default;
  ~ITKThresholdImageFilter() noexcept override = default;

  ITKThresholdImageFilter(const ITKThresholdImageFilter&) = delete;
  ITKThresholdImageFilter(ITKThresholdImageFilter&&) noexcept = delete;

  ITKThresholdImageFilter& operator=(const ITKThresholdImageFilter&) = delete;
  ITKThresholdImageFilter& operator=(ITKThresholdImageFilter&&) noexcept = delete;
