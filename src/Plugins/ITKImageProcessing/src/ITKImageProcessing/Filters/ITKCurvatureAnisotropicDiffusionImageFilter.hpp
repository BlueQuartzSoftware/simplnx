...
{
/**
 * @class ITKCurvatureAnisotropicDiffusionImageFilter
...
public:
  ...
  ~ITKCurvatureAnisotropicDiffusionImageFilter() noexcept override = default;

  ITKCurvatureAnisotropicDiffusionImageFilter(const ITKCurvatureAnisotropicDiffusionImageFilter&) = delete;
  ITKCurvatureAnisotropicDiffusionImageFilter(ITKCurvatureAnisotropicDiffusionImageFilter&&) noexcept = delete;

  ITKCurvatureAnisotropicDiffusionImageFilter& operator=(const ITKCurvatureAnisotropicDiffusionImageFilter&) = delete;
  ITKCurvatureAnisotropicDiffusionImageFilter& operator=(ITKCurvatureAnisotropicDiffusionImageFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKCurvatureAnisotropicDiffusionImageFilter, "ada68f29-b1f2-44a2-86dc-f0cd28f54633");
