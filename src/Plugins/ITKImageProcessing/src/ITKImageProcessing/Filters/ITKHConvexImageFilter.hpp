 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKHConvexImageFilter : public AbstractFilter
{
public:
  ITKHConvexImageFilter() = default;
  ~ITKHConvexImageFilter() noexcept override = default;

  ITKHConvexImageFilter(const ITKHConvexImageFilter&) = delete;
  ITKHConvexImageFilter(ITKHConvexImageFilter&&) noexcept = delete;

  ITKHConvexImageFilter& operator=(const ITKHConvexImageFilter&) = delete;
  ITKHConvexImageFilter& operator=(ITKHConvexImageFilter&&) noexcept = delete;
