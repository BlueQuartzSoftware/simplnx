...
{
/**
 * @class ITKConnectedComponentImageFilter
...
public:
  ...
  ~ITKConnectedComponentImageFilter() noexcept override = default;

  ITKConnectedComponentImageFilter(const ITKConnectedComponentImageFilter&) = delete;
  ITKConnectedComponentImageFilter(ITKConnectedComponentImageFilter&&) noexcept = delete;

  ITKConnectedComponentImageFilter& operator=(const ITKConnectedComponentImageFilter&) = delete;
  ITKConnectedComponentImageFilter& operator=(ITKConnectedComponentImageFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_MaskImage_Key = "mask_image";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKConnectedComponentImageFilter, "905354c1-d55b-4436-b9f7-f4a6e80e5c0f");
