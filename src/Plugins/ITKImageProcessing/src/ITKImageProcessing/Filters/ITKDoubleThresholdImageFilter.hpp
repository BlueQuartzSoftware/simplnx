...
{
/**
 * @class ITKDoubleThresholdImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKDoubleThresholdImageFilter : public AbstractFilter
{
public:
  ITKDoubleThresholdImageFilter() = default;
  ~ITKDoubleThresholdImageFilter() noexcept override = default;

  ITKDoubleThresholdImageFilter(const ITKDoubleThresholdImageFilter&) = delete;
  ITKDoubleThresholdImageFilter(ITKDoubleThresholdImageFilter&&) noexcept = delete;

  ITKDoubleThresholdImageFilter& operator=(const ITKDoubleThresholdImageFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKDoubleThresholdImageFilter, "e268a65f-33f1-493f-a6c7-4635e57df3c4");
