...
{
/**
 * @class ITKIntensityWindowingImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKIntensityWindowingImageFilter : public AbstractFilter
{
public:
  ITKIntensityWindowingImageFilter() = default;
  ~ITKIntensityWindowingImageFilter() noexcept override = default;

  ITKIntensityWindowingImageFilter(const ITKIntensityWindowingImageFilter&) = delete;
  ITKIntensityWindowingImageFilter(ITKIntensityWindowingImageFilter&&) noexcept = delete;

  ITKIntensityWindowingImageFilter& operator=(const ITKIntensityWindowingImageFilter&) = delete;
  ITKIntensityWindowingImageFilter& operator=(ITKIntensityWindowingImageFilter&&) noexcept = delete;
