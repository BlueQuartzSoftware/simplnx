 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKMaskImageFilter : public AbstractFilter
{
public:
  ITKMaskImageFilter() = default;
  ~ITKMaskImageFilter() noexcept override = default;

  ITKMaskImageFilter(const ITKMaskImageFilter&) = delete;
  ITKMaskImageFilter(ITKMaskImageFilter&&) noexcept = delete;

  ITKMaskImageFilter& operator=(const ITKMaskImageFilter&) = delete;
  ITKMaskImageFilter& operator=(ITKMaskImageFilter&&) noexcept = delete;
