 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKNotImageFilter : public AbstractFilter
{
public:
  ITKNotImageFilter() = default;
  ~ITKNotImageFilter() noexcept override = default;

  ITKNotImageFilter(const ITKNotImageFilter&) = delete;
  ITKNotImageFilter(ITKNotImageFilter&&) noexcept = delete;

  ITKNotImageFilter& operator=(const ITKNotImageFilter&) = delete;
  ITKNotImageFilter& operator=(ITKNotImageFilter&&) noexcept = delete;
