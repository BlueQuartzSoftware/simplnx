                                                                           ...
                                                                           const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions =
      ITK::DataCheck<cxITKLaplacianRecursiveGaussianImageFilter::ArrayOptionsType, cxITKLaplacianRecursiveGaussianImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);
                                                         ...
                                                         const std::atomic_bool& shouldCancel) const
{
  ...
  return ITK::Execute<cxITKLaplacianRecursiveGaussianImageFilter::ArrayOptionsType, cxITKLaplacianRecursiveGaussianImageFilter::FilterOutputType>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath,
