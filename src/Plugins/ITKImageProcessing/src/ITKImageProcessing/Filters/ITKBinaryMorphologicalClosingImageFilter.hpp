...
{
/**
 * @class ITKBinaryMorphologicalClosingImageFilter
...
public:
  ...
  ~ITKBinaryMorphologicalClosingImageFilter() noexcept override = default;

  ITKBinaryMorphologicalClosingImageFilter(const ITKBinaryMorphologicalClosingImageFilter&) = delete;
  ITKBinaryMorphologicalClosingImageFilter(ITKBinaryMorphologicalClosingImageFilter&&) noexcept = delete;

  ITKBinaryMorphologicalClosingImageFilter& operator=(const ITKBinaryMorphologicalClosingImageFilter&) = delete;
  ITKBinaryMorphologicalClosingImageFilter& operator=(ITKBinaryMorphologicalClosingImageFilter&&) noexcept = delete;
