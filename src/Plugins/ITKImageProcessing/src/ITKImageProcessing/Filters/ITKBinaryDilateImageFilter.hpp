...
{
/**
 * @class ITKBinaryDilateImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKBinaryDilateImageFilter : public AbstractFilter
{
public:
  ITKBinaryDilateImageFilter() = default;
  ~ITKBinaryDilateImageFilter() noexcept override = default;

  ITKBinaryDilateImageFilter(const ITKBinaryDilateImageFilter&) = delete;
  ITKBinaryDilateImageFilter(ITKBinaryDilateImageFilter&&) noexcept = delete;

  ITKBinaryDilateImageFilter& operator=(const ITKBinaryDilateImageFilter&) = delete;
  ITKBinaryDilateImageFilter& operator=(ITKBinaryDilateImageFilter&&) noexcept = delete;
