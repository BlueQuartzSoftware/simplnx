...
{
/**
 * @class ITKValuedRegionalMaximaImageFilter
...
public:
  ...
  ~ITKValuedRegionalMaximaImageFilter() noexcept override = default;

  ITKValuedRegionalMaximaImageFilter(const ITKValuedRegionalMaximaImageFilter&) = delete;
  ITKValuedRegionalMaximaImageFilter(ITKValuedRegionalMaximaImageFilter&&) noexcept = delete;

  ITKValuedRegionalMaximaImageFilter& operator=(const ITKValuedRegionalMaximaImageFilter&) = delete;
  ITKValuedRegionalMaximaImageFilter& operator=(ITKValuedRegionalMaximaImageFilter&&) noexcept = delete;
