 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKCosImageFilter : public AbstractFilter
{
public:
  ITKCosImageFilter() = default;
  ~ITKCosImageFilter() noexcept override = default;

  ITKCosImageFilter(const ITKCosImageFilter&) = delete;
  ITKCosImageFilter(ITKCosImageFilter&&) noexcept = delete;

  ITKCosImageFilter& operator=(const ITKCosImageFilter&) = delete;
  ITKCosImageFilter& operator=(ITKCosImageFilter&&) noexcept = delete;
