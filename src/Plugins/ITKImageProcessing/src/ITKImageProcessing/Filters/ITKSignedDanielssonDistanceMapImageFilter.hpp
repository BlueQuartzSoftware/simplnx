...
{
/**
 * @class ITKSignedDanielssonDistanceMapImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKSignedDanielssonDistanceMapImageFilter : public AbstractFilter
{
public:
  ITKSignedDanielssonDistanceMapImageFilter() = default;
  ~ITKSignedDanielssonDistanceMapImageFilter() noexcept override = default;

  ITKSignedDanielssonDistanceMapImageFilter(const ITKSignedDanielssonDistanceMapImageFilter&) = delete;
  ITKSignedDanielssonDistanceMapImageFilter(ITKSignedDanielssonDistanceMapImageFilter&&) noexcept = delete;

  ITKSignedDanielssonDistanceMapImageFilter& operator=(const ITKSignedDanielssonDistanceMapImageFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKSignedDanielssonDistanceMapImageFilter, "2f42e771-1d84-4468-8991-9a1fad7eb740");
