...
{
/**
 * @class ITKRelabelComponentImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKRelabelComponentImageFilter : public AbstractFilter
{
public:
  ITKRelabelComponentImageFilter() = default;
  ~ITKRelabelComponentImageFilter() noexcept override = default;

  ITKRelabelComponentImageFilter(const ITKRelabelComponentImageFilter&) = delete;
  ITKRelabelComponentImageFilter(ITKRelabelComponentImageFilter&&) noexcept = delete;

  ITKRelabelComponentImageFilter& operator=(const ITKRelabelComponentImageFilter&) = delete;
  ITKRelabelComponentImageFilter& operator=(ITKRelabelComponentImageFilter&&) noexcept = delete;
