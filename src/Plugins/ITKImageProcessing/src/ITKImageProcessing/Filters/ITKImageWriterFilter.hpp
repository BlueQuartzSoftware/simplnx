...
public:
  ...
  ~ITKImageWriterFilter() noexcept override = default;

  ITKImageWriterFilter(const ITKImageWriterFilter&) = delete;
  ITKImageWriterFilter(ITKImageWriterFilter&&) noexcept = delete;

  ITKImageWriterFilter& operator=(const ITKImageWriterFilter&) = delete;
  ITKImageWriterFilter& operator=(ITKImageWriterFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKImageWriterFilter, "a181ee3e-1678-4133-b9c5-a9dd7bfec62f");
