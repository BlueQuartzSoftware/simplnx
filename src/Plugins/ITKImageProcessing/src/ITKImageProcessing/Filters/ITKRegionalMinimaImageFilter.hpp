...
{
/**
 * @class ITKRegionalMinimaImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKRegionalMinimaImageFilter : public AbstractFilter
{
public:
  ITKRegionalMinimaImageFilter() = default;
  ~ITKRegionalMinimaImageFilter() noexcept override = default;

  ITKRegionalMinimaImageFilter(const ITKRegionalMinimaImageFilter&) = delete;
  ITKRegionalMinimaImageFilter(ITKRegionalMinimaImageFilter&&) noexcept = delete;

  ITKRegionalMinimaImageFilter& operator=(const ITKRegionalMinimaImageFilter&) = delete;
  ITKRegionalMinimaImageFilter& operator=(ITKRegionalMinimaImageFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKRegionalMinimaImageFilter, "7ec0883e-ac48-40e9-8b97-11bdfde721e2");
