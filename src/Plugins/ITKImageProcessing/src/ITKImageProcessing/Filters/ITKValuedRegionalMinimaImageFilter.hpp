...
{
/**
 * @class ITKValuedRegionalMinimaImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKValuedRegionalMinimaImageFilter : public AbstractFilter
{
public:
  ITKValuedRegionalMinimaImageFilter() = default;
  ~ITKValuedRegionalMinimaImageFilter() noexcept override = default;

  ITKValuedRegionalMinimaImageFilter(const ITKValuedRegionalMinimaImageFilter&) = delete;
  ITKValuedRegionalMinimaImageFilter(ITKValuedRegionalMinimaImageFilter&&) noexcept = delete;

  ITKValuedRegionalMinimaImageFilter& operator=(const ITKValuedRegionalMinimaImageFilter&) = delete;
  ITKValuedRegionalMinimaImageFilter& operator=(ITKValuedRegionalMinimaImageFilter&&) noexcept = delete;
