...
{
/**
 * @class ITKThresholdMaximumConnectedComponentsImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKThresholdMaximumConnectedComponentsImageFilter : public AbstractFilter
{
public:
  ITKThresholdMaximumConnectedComponentsImageFilter() = default;
  ~ITKThresholdMaximumConnectedComponentsImageFilter() noexcept override = default;

  ITKThresholdMaximumConnectedComponentsImageFilter(const ITKThresholdMaximumConnectedComponentsImageFilter&) = delete;
  ITKThresholdMaximumConnectedComponentsImageFilter(ITKThresholdMaximumConnectedComponentsImageFilter&&) noexcept = delete;

  ITKThresholdMaximumConnectedComponentsImageFilter& operator=(const ITKThresholdMaximumConnectedComponentsImageFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ITKThresholdMaximumConnectedComponentsImageFilter, "dc0f6771-87bf-457f-8430-2d943e039a24");
