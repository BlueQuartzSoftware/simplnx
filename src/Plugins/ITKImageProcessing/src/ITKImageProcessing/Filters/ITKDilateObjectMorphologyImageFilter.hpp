...
{
/**
 * @class ITKDilateObjectMorphologyImageFilter
 ...
 */
class ITKIMAGEPROCESSING_EXPORT ITKDilateObjectMorphologyImageFilter : public AbstractFilter
{
public:
  ITKDilateObjectMorphologyImageFilter() = default;
  ~ITKDilateObjectMorphologyImageFilter() noexcept override = default;

  ITKDilateObjectMorphologyImageFilter(const ITKDilateObjectMorphologyImageFilter&) = delete;
  ITKDilateObjectMorphologyImageFilter(ITKDilateObjectMorphologyImageFilter&&) noexcept = delete;

  ITKDilateObjectMorphologyImageFilter& operator=(const ITKDilateObjectMorphologyImageFilter&) = delete;
  ITKDilateObjectMorphologyImageFilter& operator=(ITKDilateObjectMorphologyImageFilter&&) noexcept = delete;
