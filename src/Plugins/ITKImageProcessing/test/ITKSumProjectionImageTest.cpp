...
TEST_CASE("ITKImageProcessing::ITKSumProjectionImageFilter(z_projection)", "[ITKImageProcessing][ITKSumProjectionImage][z_projection]")
{
  ...
  const ITKSumProjectionImage filter;
  ...
  Arguments args;
  args.insertOrAssign(ITKSumProjectionImage::k_InputImageGeomPath_Key, std::make_any<DataPath>(inputGeometryPath));
  args.insertOrAssign(ITKSumProjectionImage::k_InputImageDataPath_Key, std::make_any<DataPath>(inputDataPath));
  args.insertOrAssign(ITKSumProjectionImage::k_OutputImageArrayName_Key, std::make_any<DataObjectNameParameter::ValueType>(outputArrayName));
