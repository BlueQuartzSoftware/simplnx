...
TEST_CASE("ITKImageProcessing::ITKMaximumProjectionImageFilter(z_projection)", "[ITKImageProcessing][ITKMaximumProjectionImage][z_projection]")
{
  ...
  const fs::path baselineFilePath = fs::path(nx::core::unit_test::k_DataDir.view()) / "JSONFilters/Baseline/BasicFilters_MaximumProjectionImageFilter_z_projection.nrrd";
