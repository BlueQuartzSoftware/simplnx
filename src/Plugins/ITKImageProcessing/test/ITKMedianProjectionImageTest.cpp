...
TEST_CASE("ITKImageProcessing::ITKMedianProjectionImageFilter(z_projection)", "[ITKImageProcessing][ITKMedianProjectionImage][z_projection]")
{
  ...
  const fs::path baselineFilePath = fs::path(nx::core::unit_test::k_DataDir.view()) / "JSONFilters/Baseline/BasicFilters_MedianProjectionImageFilter_z_projection.nrrd";
