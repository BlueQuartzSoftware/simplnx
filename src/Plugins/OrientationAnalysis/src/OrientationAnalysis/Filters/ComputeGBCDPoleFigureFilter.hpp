...
{
/**
 * @class ComputeGBCDPoleFigureFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT ComputeGBCDPoleFigureFilter : public AbstractFilter
{
public:
  ComputeGBCDPoleFigureFilter() = default;
  ~ComputeGBCDPoleFigureFilter() noexcept override = default;

  ComputeGBCDPoleFigureFilter(const ComputeGBCDPoleFigureFilter&) = delete;
  ComputeGBCDPoleFigureFilter(ComputeGBCDPoleFigureFilter&&) noexcept = delete;

  ComputeGBCDPoleFigureFilter& operator=(const ComputeGBCDPoleFigureFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeGBCDPoleFigureFilter, "eed5183e-5a9c-485b-9e64-579a81f0d301");
