 ...
 */
class ORIENTATIONANALYSIS_EXPORT EnsembleInfoReaderFilter : public IFilter
{
public:
  EnsembleInfoReaderFilter() = default;
  ~EnsembleInfoReaderFilter() noexcept override = default;

  EnsembleInfoReaderFilter(const EnsembleInfoReaderFilter&) = delete;
  EnsembleInfoReaderFilter(EnsembleInfoReaderFilter&&) noexcept = delete;

  EnsembleInfoReaderFilter& operator=(const EnsembleInfoReaderFilter&) = delete;
  EnsembleInfoReaderFilter& operator=(EnsembleInfoReaderFilter&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, EnsembleInfoReaderFilter, "ecf1ec45-bc27-4ddb-b2c0-3d465b8c182a");
