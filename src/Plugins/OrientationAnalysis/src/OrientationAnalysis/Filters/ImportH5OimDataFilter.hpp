 ...
 */
class ORIENTATIONANALYSIS_EXPORT ImportH5OimDataFilter : public IFilter
{
public:
  ImportH5OimDataFilter() = default;
  ~ImportH5OimDataFilter() noexcept override = default;

  ImportH5OimDataFilter(const ImportH5OimDataFilter&) = delete;
  ImportH5OimDataFilter(ImportH5OimDataFilter&&) noexcept = delete;

  ImportH5OimDataFilter& operator=(const ImportH5OimDataFilter&) = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportH5OimDataFilter, "4ad3d47c-b1e1-4429-bc65-5e021be62ba0");
