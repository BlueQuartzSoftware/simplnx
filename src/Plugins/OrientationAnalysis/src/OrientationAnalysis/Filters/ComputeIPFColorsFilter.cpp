#include "ComputeIPFColorsFilter.hpp"

#include "OrientationAnalysis/Filters/Algorithms/ComputeIPFColors.hpp"
...
{
//------------------------------------------------------------------------------
std::string ComputeIPFColorsFilter::name() const
{
  return FilterTraits<ComputeIPFColorsFilter>::name.str();
}

//------------------------------------------------------------------------------
std::string ComputeIPFColorsFilter::className() const
{
  return FilterTraits<ComputeIPFColorsFilter>::className;
}

//------------------------------------------------------------------------------
Uuid ComputeIPFColorsFilter::uuid() const
{
  return FilterTraits<ComputeIPFColorsFilter>::uuid;
}

//------------------------------------------------------------------------------
std::string ComputeIPFColorsFilter::humanName() const
{
  return "Compute IPF Colors";
}

//------------------------------------------------------------------------------
std::vector<std::string> ComputeIPFColorsFilter::defaultTags() const
{
  return {className(), "Processing", "Crystallography", "Inverse Pole Figure", "Colors", "Generate"};
}

//------------------------------------------------------------------------------
Parameters ComputeIPFColorsFilter::parameters() const
{
  Parameters params;
...
Result<Arguments> ComputeIPFColorsFilter::FromSIMPLJson(const nlohmann::json& json)
{
  Arguments args = ComputeIPFColorsFilter().getDefaultArguments();
