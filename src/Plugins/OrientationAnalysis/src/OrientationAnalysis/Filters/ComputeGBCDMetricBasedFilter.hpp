...
public:
  ...
  ~ComputeGBCDMetricBasedFilter() noexcept override = default;

  ComputeGBCDMetricBasedFilter(const ComputeGBCDMetricBasedFilter&) = delete;
  ComputeGBCDMetricBasedFilter(ComputeGBCDMetricBasedFilter&&) noexcept = delete;

  ComputeGBCDMetricBasedFilter& operator=(const ComputeGBCDMetricBasedFilter&) = delete;
  ComputeGBCDMetricBasedFilter& operator=(ComputeGBCDMetricBasedFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_ChosenLimitDists_Key = "chosen_limit_dists_index";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeGBCDMetricBasedFilter, "fc0d695a-e381-4f11-a8fd-26d5b5cda30a");
