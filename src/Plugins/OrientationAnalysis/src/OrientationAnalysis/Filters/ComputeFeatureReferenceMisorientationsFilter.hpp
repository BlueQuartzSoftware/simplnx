...
public:
  ...
  ~ComputeFeatureReferenceMisorientationsFilter() noexcept override = default;

  ComputeFeatureReferenceMisorientationsFilter(const ComputeFeatureReferenceMisorientationsFilter&) = delete;
  ComputeFeatureReferenceMisorientationsFilter(ComputeFeatureReferenceMisorientationsFilter&&) noexcept = delete;

  ComputeFeatureReferenceMisorientationsFilter& operator=(const ComputeFeatureReferenceMisorientationsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFeatureReferenceMisorientationsFilter, "24b54daf-3bf5-4331-93f6-03a49f719bf1");
