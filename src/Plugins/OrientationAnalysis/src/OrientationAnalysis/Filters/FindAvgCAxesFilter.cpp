                                                           ...
                                                           const std::atomic_bool& shouldCancel) const
{
  ...
  {
    return MakePreflightErrorResult(-6400, fmt::format("The quaternions cell data array and feature ids cell data array have mismatching number of tuples. Make sure these arrays are located in the "
