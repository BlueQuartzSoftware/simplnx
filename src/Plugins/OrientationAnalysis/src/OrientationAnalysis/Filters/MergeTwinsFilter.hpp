 ...
 */
class ORIENTATIONANALYSIS_EXPORT MergeTwinsFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, MergeTwinsFilter, "f173786a-50cd-4c3c-9518-48ef6fc2bac9");
