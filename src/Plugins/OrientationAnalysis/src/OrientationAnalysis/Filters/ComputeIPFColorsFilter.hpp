...
{
/**
 * @class ComputeIPFColorsFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT ComputeIPFColorsFilter : public AbstractFilter
{
public:
  ComputeIPFColorsFilter() = default;
  ~ComputeIPFColorsFilter() noexcept override = default;

  ComputeIPFColorsFilter(const ComputeIPFColorsFilter&) = delete;
  ComputeIPFColorsFilter(ComputeIPFColorsFilter&&) noexcept = delete;

  ComputeIPFColorsFilter& operator=(const ComputeIPFColorsFilter&) = delete;
  ComputeIPFColorsFilter& operator=(ComputeIPFColorsFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_CellIPFColorsArrayName_Key = "cell_ipf_colors_array_name";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeIPFColorsFilter, "64cb4f27-6e5e-4dd2-8a03-0c448cb8f5e6");
