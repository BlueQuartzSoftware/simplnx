...
{
/**
 * @class ImportH5EspritDataFilter
 ...
 */
class ORIENTATIONANALYSIS_EXPORT ImportH5EspritDataFilter : public IFilter
{
public:
  ImportH5EspritDataFilter() = default;
  ~ImportH5EspritDataFilter() noexcept override = default;

  ImportH5EspritDataFilter(const ImportH5EspritDataFilter&) = delete;
  ImportH5EspritDataFilter(ImportH5EspritDataFilter&&) noexcept = delete;

  ImportH5EspritDataFilter& operator=(const ImportH5EspritDataFilter&) = delete;
  ImportH5EspritDataFilter& operator=(ImportH5EspritDataFilter&&) noexcept = delete;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportH5EspritDataFilter, "694a0d54-b492-41bc-993b-ce0f5006e927");
