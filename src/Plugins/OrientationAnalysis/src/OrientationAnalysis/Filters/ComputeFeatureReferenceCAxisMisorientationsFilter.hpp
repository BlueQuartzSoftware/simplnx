...
public:
  ...
  ~ComputeFeatureReferenceCAxisMisorientationsFilter() noexcept override = default;

  ComputeFeatureReferenceCAxisMisorientationsFilter(const ComputeFeatureReferenceCAxisMisorientationsFilter&) = delete;
  ComputeFeatureReferenceCAxisMisorientationsFilter(ComputeFeatureReferenceCAxisMisorientationsFilter&&) noexcept = delete;

  ComputeFeatureReferenceCAxisMisorientationsFilter& operator=(const ComputeFeatureReferenceCAxisMisorientationsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFeatureReferenceCAxisMisorientationsFilter, "16c487d2-8f99-4fb5-a4df-d3f70a8e6b25");
