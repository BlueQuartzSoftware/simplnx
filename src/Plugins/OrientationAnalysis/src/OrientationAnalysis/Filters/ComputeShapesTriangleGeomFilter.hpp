 ...
 */
class ORIENTATIONANALYSIS_EXPORT ComputeShapesTriangleGeomFilter : public AbstractFilter
{
public:
  ...
  static constexpr StringLiteral k_EulerCharacteristicArrayName_Key = "euler_characteristic_array_name";
  /**
