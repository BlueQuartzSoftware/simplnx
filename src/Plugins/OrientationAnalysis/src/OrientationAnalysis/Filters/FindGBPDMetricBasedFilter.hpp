...
{
/**
 * @class FindGBPDMetricBasedFilter
 * @brief This filter computes the grain boundary plane distribution (GBPD)
 */
class ORIENTATIONANALYSIS_EXPORT FindGBPDMetricBasedFilter : public IFilter
{
public:
  FindGBPDMetricBasedFilter() = default;
  ~FindGBPDMetricBasedFilter() noexcept override = default;

  FindGBPDMetricBasedFilter(const FindGBPDMetricBasedFilter&) = delete;
  FindGBPDMetricBasedFilter(FindGBPDMetricBasedFilter&&) noexcept = delete;

  FindGBPDMetricBasedFilter& operator=(const FindGBPDMetricBasedFilter&) = delete;
  FindGBPDMetricBasedFilter& operator=(FindGBPDMetricBasedFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindGBPDMetricBasedFilter, "8267878b-d23a-4666-83a0-f1a7711861ce");
