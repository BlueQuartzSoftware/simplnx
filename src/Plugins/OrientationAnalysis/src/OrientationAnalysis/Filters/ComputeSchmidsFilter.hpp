...
{
/**
 * @class ComputeSchmidsFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT ComputeSchmidsFilter : public AbstractFilter
{
public:
  ComputeSchmidsFilter() = default;
  ~ComputeSchmidsFilter() noexcept override = default;

  ComputeSchmidsFilter(const ComputeSchmidsFilter&) = delete;
  ComputeSchmidsFilter(ComputeSchmidsFilter&&) noexcept = delete;

  ComputeSchmidsFilter& operator=(const ComputeSchmidsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeSchmidsFilter, "b4681855-0a3d-4237-97f2-5aec509115c4");
