...
{
/**
 * @class WriteGBCDGMTFileFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT WriteGBCDGMTFileFilter : public AbstractFilter
{
public:
  WriteGBCDGMTFileFilter() = default;
  ~WriteGBCDGMTFileFilter() noexcept override = default;

  WriteGBCDGMTFileFilter(const WriteGBCDGMTFileFilter&) = delete;
  WriteGBCDGMTFileFilter(WriteGBCDGMTFileFilter&&) noexcept = delete;

  WriteGBCDGMTFileFilter& operator=(const WriteGBCDGMTFileFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, WriteGBCDGMTFileFilter, "31710abf-b8a6-423f-a03f-4b8885bd3633");
