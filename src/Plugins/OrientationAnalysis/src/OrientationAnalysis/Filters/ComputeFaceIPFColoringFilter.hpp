...
public:
  ...
  ~ComputeFaceIPFColoringFilter() noexcept override = default;

  ComputeFaceIPFColoringFilter(const ComputeFaceIPFColoringFilter&) = delete;
  ComputeFaceIPFColoringFilter(ComputeFaceIPFColoringFilter&&) noexcept = delete;

  ComputeFaceIPFColoringFilter& operator=(const ComputeFaceIPFColoringFilter&) = delete;
  ComputeFaceIPFColoringFilter& operator=(ComputeFaceIPFColoringFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFaceIPFColoringFilter, "30759600-7c02-4650-b5ca-e7036d6b568e");
