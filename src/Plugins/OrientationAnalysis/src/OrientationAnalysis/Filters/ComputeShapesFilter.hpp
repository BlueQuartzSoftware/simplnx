...
{
/**
 * @class ComputeShapesFilter
 *
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT ComputeShapesFilter : public AbstractFilter
{
public:
  ComputeShapesFilter() = default;
  ~ComputeShapesFilter() noexcept override = default;

  ComputeShapesFilter(const ComputeShapesFilter&) = delete;
  ComputeShapesFilter(ComputeShapesFilter&&) noexcept = delete;

  ComputeShapesFilter& operator=(const ComputeShapesFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeShapesFilter, "036b17d5-23bb-4a24-9187-c4a8dd918792");
