...
{
/**
 * @class ComputeAvgCAxesFilter
 * @brief This filter determines the average C-axis location of each Feature
 */
class ORIENTATIONANALYSIS_EXPORT ComputeAvgCAxesFilter : public AbstractFilter
{
public:
  ComputeAvgCAxesFilter() = default;
  ~ComputeAvgCAxesFilter() noexcept override = default;

  ComputeAvgCAxesFilter(const ComputeAvgCAxesFilter&) = delete;
  ComputeAvgCAxesFilter(ComputeAvgCAxesFilter&&) noexcept = delete;

  ComputeAvgCAxesFilter& operator=(const ComputeAvgCAxesFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeAvgCAxesFilter, "453cdb58-7bbb-4576-ad5e-f75a1c54d348");
