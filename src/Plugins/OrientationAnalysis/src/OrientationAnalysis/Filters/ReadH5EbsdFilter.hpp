 ...
 */
class ORIENTATIONANALYSIS_EXPORT ReadH5EbsdFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ReadH5EbsdFilter, "db291b6c-9aaf-432d-9547-430c865a539c");
