 ...
 */
class ORIENTATIONANALYSIS_EXPORT BadDataNeighborOrientationCheckFilter : public AbstractFilter
{
public:
  ...
  static constexpr StringLiteral k_NumberOfNeighbors_Key = "number_of_neighbors";
