...
public:
  ...
  static constexpr StringLiteral k_RandomizeFeatureIds_Key = "randomize_feature_ids";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, CAxisSegmentFeaturesFilter, "9fe07e17-aef1-4bf1-834c-d3a73dafc27d");
