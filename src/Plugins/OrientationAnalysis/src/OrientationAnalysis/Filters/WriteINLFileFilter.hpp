 ...
 */
class ORIENTATIONANALYSIS_EXPORT WriteINLFileFilter : public AbstractFilter
{
public:
  WriteINLFileFilter() = default;
  ~WriteINLFileFilter() noexcept override = default;

  WriteINLFileFilter(const WriteINLFileFilter&) = delete;
  WriteINLFileFilter(WriteINLFileFilter&&) noexcept = delete;

  WriteINLFileFilter& operator=(const WriteINLFileFilter&) = delete;
  WriteINLFileFilter& operator=(WriteINLFileFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_NumFeaturesArrayPath_Key = "num_features_array_path";
