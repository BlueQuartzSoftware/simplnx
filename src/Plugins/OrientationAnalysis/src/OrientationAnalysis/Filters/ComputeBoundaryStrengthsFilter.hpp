...
{
/**
 * @class ComputeBoundaryStrengthsFilter
 * @brief This filter will ....
 */
class ORIENTATIONANALYSIS_EXPORT ComputeBoundaryStrengthsFilter : public AbstractFilter
{
public:
  ComputeBoundaryStrengthsFilter() = default;
  ~ComputeBoundaryStrengthsFilter() noexcept override = default;

  ComputeBoundaryStrengthsFilter(const ComputeBoundaryStrengthsFilter&) = delete;
  ComputeBoundaryStrengthsFilter(ComputeBoundaryStrengthsFilter&&) noexcept = delete;

  ComputeBoundaryStrengthsFilter& operator=(const ComputeBoundaryStrengthsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeBoundaryStrengthsFilter, "f39707f9-0411-4736-a591-1bfbd099bb71");
