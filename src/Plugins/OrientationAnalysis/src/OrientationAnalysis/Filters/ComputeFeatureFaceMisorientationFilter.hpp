...
{
/**
 * @class ComputeFeatureFaceMisorientationFilter
...
public:
  ...
  ~ComputeFeatureFaceMisorientationFilter() noexcept override = default;

  ComputeFeatureFaceMisorientationFilter(const ComputeFeatureFaceMisorientationFilter&) = delete;
  ComputeFeatureFaceMisorientationFilter(ComputeFeatureFaceMisorientationFilter&&) noexcept = delete;

  ComputeFeatureFaceMisorientationFilter& operator=(const ComputeFeatureFaceMisorientationFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFeatureFaceMisorientationFilter, "f3473af9-db77-43db-bd25-60df7230ea73");
