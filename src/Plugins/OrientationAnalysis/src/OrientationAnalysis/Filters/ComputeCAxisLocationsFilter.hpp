...
{
/**
 * @class ComputeCAxisLocationsFilter
...
public:
  ...
  ~ComputeCAxisLocationsFilter() noexcept override = default;

  ComputeCAxisLocationsFilter(const ComputeCAxisLocationsFilter&) = delete;
  ComputeCAxisLocationsFilter(ComputeCAxisLocationsFilter&&) noexcept = delete;

  ComputeCAxisLocationsFilter& operator=(const ComputeCAxisLocationsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeCAxisLocationsFilter, "a51c257a-ddc1-499a-9b21-f2d25a19d098");
