...
public:
  ...
  ~ConvertOrientationsToVertexGeometryFilter() noexcept override = default;

  ConvertOrientationsToVertexGeometryFilter(const ConvertOrientationsToVertexGeometryFilter&) = delete;
  ConvertOrientationsToVertexGeometryFilter(ConvertOrientationsToVertexGeometryFilter&&) noexcept = delete;

  ConvertOrientationsToVertexGeometryFilter& operator=(const ConvertOrientationsToVertexGeometryFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ConvertOrientationsToVertexGeometryFilter, "fd32e338-a4c3-477c-9027-e105285078fd");
