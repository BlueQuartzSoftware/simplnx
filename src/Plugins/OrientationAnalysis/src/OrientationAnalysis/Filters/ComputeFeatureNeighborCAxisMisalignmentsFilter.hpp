...
public:
  ...
  // Parameter Keys
  static constexpr StringLiteral k_FindAvgMisals_Key = "find_avg_misals";
  ...
  static constexpr StringLiteral k_CAxisMisalignmentListArrayName_Key = "c_axis_misalignment_list_array_name";
  static constexpr StringLiteral k_AvgCAxisMisalignmentsArrayName_Key = "avg_c_axis_misalignments_array_name";
