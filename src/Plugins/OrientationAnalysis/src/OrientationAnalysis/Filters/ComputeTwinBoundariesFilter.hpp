...
{
/**
 * @class ComputeTwinBoundariesFilter
 *
...
public:
  ...
  ~ComputeTwinBoundariesFilter() noexcept override = default;

  ComputeTwinBoundariesFilter(const ComputeTwinBoundariesFilter&) = delete;
  ComputeTwinBoundariesFilter(ComputeTwinBoundariesFilter&&) noexcept = delete;

  ComputeTwinBoundariesFilter& operator=(const ComputeTwinBoundariesFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeTwinBoundariesFilter, "66156e04-0e62-4478-baf8-88d34ac694c1");
