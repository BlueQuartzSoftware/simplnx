...
// #include "OrientationAnalysis/Filters/ComputeAvgCAxes.hpp"
...
namespace nx::core
{
  static const AbstractPlugin::SIMPLMapType k_SIMPL_to_OrientationAnalysis
  {
    ...
    {nx::core::Uuid::FromString("7cd30864-7bcf-5c10-aea7-d107373e2d40").value(), {nx::core::FilterTraits<ComputeFeatureFaceMisorientationFilter>::uuid, &ComputeFeatureFaceMisorientationFilter::FromSIMPLJson}}, // GenerateFaceMisorientationColoring
    {nx::core::Uuid::FromString("85900eba-3da9-5985-ac71-1d9d290a5d31").value(), {nx::core::FilterTraits<ComputeGBCDPoleFigureFilter>::uuid, &ComputeGBCDPoleFigureFilter::FromSIMPLJson}}, // VisualizeGBCDPoleFigureFilter
    ...
    {nx::core::Uuid::FromString("9a6677a6-b9e5-5fee-afa2-27e868cab8ca").value(), {nx::core::FilterTraits<ComputeFZQuaternionsFilter>::uuid, &ComputeFZQuaternionsFilter::FromSIMPLJson}}, // ComputeFZQuaternions
    ...
    {nx::core::Uuid::FromString("a50e6532-8075-5de5-ab63-945feb0de7f7").value(), {nx::core::FilterTraits<ComputeIPFColorsFilter>::uuid, &ComputeIPFColorsFilter::FromSIMPLJson}}, // ComputeIPFColors
    ...
    {nx::core::Uuid::FromString("bf7036d8-25bd-540e-b6de-3a5ab0e42c5f").value(), {nx::core::FilterTraits<ComputeAvgOrientationsFilter>::uuid, &ComputeAvgOrientationsFilter::FromSIMPLJson}}, // ComputeAvgOrientations
    ...
    {nx::core::Uuid::FromString("c5a9a96c-7570-5279-b383-cc25ebae0046").value(), {nx::core::FilterTraits<ComputeAvgCAxesFilter>::uuid, &ComputeAvgCAxesFilter::FromSIMPLJson}}, // ComputeAvgCAxes
    ...
    // {nx::core::Uuid::FromString("c5a9a96c-7570-5279-b383-cc25ebae0046").value(), {nx::core::FilterTraits<ComputeAvgCAxes>::uuid, {}}}, // ComputeAvgCAxes
