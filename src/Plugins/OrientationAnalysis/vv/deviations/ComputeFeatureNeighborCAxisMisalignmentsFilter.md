...
| **Status**       | active (SIMPLNX fixed 2026-06-04; legacy 6.5.171 still has the bug — root cause proven 2026-06-04 by applying the same fix to a local build of the legacy source) |
