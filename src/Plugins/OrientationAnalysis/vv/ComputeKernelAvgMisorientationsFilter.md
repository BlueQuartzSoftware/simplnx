...
9 active TEST_CASEs (11 ctest entries counting the SIMPL-compat dynamic sections); 100% pass on both in-core and out-of-core builds (Task 5 regression sweep, 2026-07-15).
