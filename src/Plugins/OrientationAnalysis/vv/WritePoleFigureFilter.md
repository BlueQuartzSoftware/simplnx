...
- **Class 5 (Expert-visual):** the hex + cubic renders in `vv_work/write_pole_figure/` (legacy PDFs + SIMPLNX PNGs), signed off this cycle — see the provenance sidecar.
...
Established by expert (Class 5) visual comparison on hex and cubic; 6.5.171 == 6.5.172. Full renders in `vv_work/write_pole_figure/`. All four are cosmetic / labeling / intentional-rendering; none is a defect.
