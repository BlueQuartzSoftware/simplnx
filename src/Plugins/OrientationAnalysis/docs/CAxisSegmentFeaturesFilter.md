...
+ Class Name: CAxisSegmentFeaturesFilter
+ Displayed Name: Segment Features (C-Axis Misalignment)

| argument key | Human Name | Description | Parameter Type |
|--------------|------------|-------------|----------------|
| active_array_name | Active | Specifies if the Feature is still in the sample (true if the Feature is in the sample and false if it is not). At the end of the Filter, all Features will be Active | complex.DataObjectNameParameter |
| cell_feature_attribute_matrix_name | Cell Feature Attribute Matrix | The name of the created feature attribute matrix | complex.DataObjectNameParameter |
...
| feature_ids_array_name | Feature Ids | Specifies to which Feature each Cell belongs | complex.DataObjectNameParameter |
...
| misorientation_tolerance | C-Axis Misorientation Tolerance (Degrees) | Tolerance (in degrees) used to determine if neighboring Cells belong to the same Feature | complex.Float32Parameter |
...
| randomize_feature_ids | Randomize Feature Ids | Specifies whether to randomize the feature ids | complex.BoolParameter |
