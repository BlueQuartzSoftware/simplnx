...
const FilterHandle k_ImportTextFilterHandle(k_ImportTextFilterId, k_ComplexCorePluginId, "ImportTextFilter", "ImportTextFilter");
...
const FilterHandle k_ImportDream3dFilterHandle(k_ImportDream3dFilterId, k_ComplexCorePluginId, "ImportDream3dFilter", "ImportDream3dFilter");
...
const FilterHandle k_RenameDataObjectFilterHandle(k_RenameDataObjectFilterId, k_ComplexCorePluginId, "RenameDataObjectFilter", "RenameDataObjectFilter");
...
const FilterHandle k_CropImageGeometryFilterHandle(k_CropImageGeometryFilterId, k_ComplexCorePluginId, "CropImageGeometryFilter", "CropImageGeometryFilter");
...
const FilterHandle k_CopyDataGroupFilterHandle(k_CopyDataGroupFilterId, k_ComplexCorePluginId, "CopyDataGroupFilter", "CopyDataGroupFilter");
...
const FilterHandle k_RemoveMinimumSizeFeaturesFilterHandle(k_RemoveMinimumSizeFeaturesFilterId, k_ComplexCorePluginId, "RemoveMinimumSizeFeaturesFilter", "RemoveMinimumSizeFeaturesFilter");
...
const FilterHandle k_CalculateFeatureSizesFilterHandle(k_CalculateFeatureSizesFilterId, k_ComplexCorePluginId, "CalculateFeatureSizesFilter", "CalculateFeatureSizesFilter");
const Uuid k_ImportCSVDataFilterId = *Uuid::FromString("373be1f8-31cf-49f6-aa5d-e356f4f3f261");
const FilterHandle k_ImportCSVDataFilterHandle(k_ImportCSVDataFilterId, k_ComplexCorePluginId, "ImportCSVDataFilter", "ImportCSVDataFilter");
...
const FilterHandle k_ConvertOrientationsFilterHandle(k_ConvertOrientationsFilterId, k_OrientationAnalysisPluginId, "ConvertOrientationsFilter", "ConvertOrientationsFilter");
...
const FilterHandle k_EbsdSegmentFeaturesFilterHandle(k_EbsdSegmentFeaturesFilterId, k_OrientationAnalysisPluginId, "EbsdSegmentFeaturesFilter", "EbsdSegmentFeaturesFilter");
...
const FilterHandle k_AlignSectionMisorientationFilterHandle(k_AlignSectionMisorientationFilterId, k_OrientationAnalysisPluginId, "AlignSectionMisorientationFilter",
                                                            "AlignSectionMisorientationFilter");
...
const FilterHandle k_NeighborOrientationCorrelationFilterHandle(k_NeighborOrientationCorrelationFilterId, k_OrientationAnalysisPluginId, "NeighborOrientationCorrelationFilter",
...
const FilterHandle k_BadDataNeighborOrientationCheckFilterHandle(k_BadDataNeighborOrientationCheckFilterId, k_OrientationAnalysisPluginId, "BadDataNeighborOrientationCheckFilter",
...
const FilterHandle k_AlignSectionsFeatureCentroidFilterHandle(k_AlignSectionsFeatureCentroidFilterId, k_ComplexCorePluginId, "AlignSectionsFeatureCentroidFilter",
...
const FilterHandle k_FindNFeaturePhasesFilterHandle(k_FindFeaturePhasesObjectsId, k_ComplexCorePluginId, "FindFeaturePhasesObjects", "FindFeaturePhasesObjects");
const Uuid k_FindNeighborsObjectsId = *Uuid::FromString("7177e88c-c3ab-4169-abe9-1fdaff20e598");
const FilterHandle k_FindNeighborsFilterHandle(k_FindNeighborsObjectsId, k_ComplexCorePluginId, "FindNeighborsFilter", "FindNeighborsFilter");
} // namespace complex
