...
TEST_CASE("OrientationAnalysis::GenerateFaceMisorientationColoring: Valid Execution", "[OrientationAnalysis][GenerateFaceMisorientationColoring][.][UNIMPLEMENTED][!mayfail]")
{
