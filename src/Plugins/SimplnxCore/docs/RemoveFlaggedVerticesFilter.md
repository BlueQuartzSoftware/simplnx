...
- **Mask** -- a single-component boolean (or `uint8`) array, one value per vertex, where **TRUE** marks the vertices to remove. Typically produced by [Multi-Threshold Objects](MultiThresholdObjectsFilter.md).
