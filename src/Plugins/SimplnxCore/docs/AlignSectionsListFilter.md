...
This **Filter** will apply the precalculated cell shifts to each section of an Image Geometry. It accepts an alignment .txt file or an alignment DataArray that has full **Cells** shifts that have already been calculated in it.

The user created alignment file should have the format as follows:
