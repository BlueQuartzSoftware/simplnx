...
If the alignment file was generated by another DREAM3D-NX alignment filter then the DREAM3D-NX Alignment File format option should be turned on and the format of the first 6 columns of each row in the file should be as follows:
