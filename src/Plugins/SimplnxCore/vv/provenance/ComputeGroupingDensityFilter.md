...
1. **Input file** (`data/compute_grouping_density_inputs.dream3d`) — the 20×5×1 `ImageGeometry` designed in Step 1 of the authorship chain. Legacy v7.0 format (FileVersion 7.0) so the *same* file is consumed by both DREAM3D 6.5.172 and SIMPLNX. Contents:
