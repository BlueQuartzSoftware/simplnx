...
TEST_CASE("SimplnxCore::CreateDataArray(Instantiate)", "[SimplnxCore][CreateDataArray]")
{
...
TEST_CASE("SimplnxCore::CreateDataArray(Invalid Parameters)", "[SimplnxCore][CreateDataArray]")
{
  static constexpr uint64 k_NComp = 3;
  static constexpr uint64 k_NumTuples = 25;
  const static DynamicTableInfo::TableDataType k_TupleDims = {{static_cast<double>(k_NumTuples)}};
  ...
  SECTION("Section1")
  {
    ...
    args.insert(CreateDataArray::k_TupleDims_Key, std::make_any<DynamicTableParameter::ValueType>(k_TupleDims));
    args.insert(CreateDataArray::k_DataPath_Key, std::make_any<DataPath>(k_DataPath));
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>("-1"));
  ...
  SECTION("Section2")
  {
    ...
    args.insert(CreateDataArray::k_TupleDims_Key, std::make_any<DynamicTableParameter::ValueType>(k_TupleDims));
    args.insert(CreateDataArray::k_DataPath_Key, std::make_any<DataPath>(k_DataPath));
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>("1024"));
  ...
  SECTION("Section5")
  {
    ...
    args.insert(CreateDataArray::k_TupleDims_Key, std::make_any<DynamicTableParameter::ValueType>(tupleDims));
    args.insert(CreateDataArray::k_DataPath_Key, std::make_any<DataPath>(k_DataPath));
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>(""));
  ...
  SECTION("Section6")
  {
    ...
    args.insert(CreateDataArray::k_TupleDims_Key, std::make_any<DynamicTableParameter::ValueType>(tupleDims));
    args.insert(CreateDataArray::k_DataPath_Key, std::make_any<DataPath>(k_DataPath));
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>("1000"));
    ...
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>("70000"));
    result = filter.execute(dataStructure, args);
    SIMPLNX_RESULT_REQUIRE_INVALID(result.result);
    ...
    args.insert(CreateDataArray::k_NumericType_Key, std::make_any<NumericType>(NumericType::int32));
    args.insert(CreateDataArray::k_InitializationValue_Key, std::make_any<std::string>("4294967297"));
    result = filter.execute(dataStructure, args);
    SIMPLNX_RESULT_REQUIRE_INVALID(result.result);
