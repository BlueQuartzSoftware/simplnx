...
TEST_CASE("SimplnxCore::IdentifyDuplicateVerticesFilter: Valid Filter Execution", "[SimplnxCore][IdentifyDuplicateVerticesFilter]")
{
  ...
  DataStructure dataStructure = UnitTest::LoadDataStructure(fs::path(fmt::format("{}/reverse_triangle_winding/6_6_reverse_triangle_winding.dream3d", unit_test::k_TestFilesDir)));
  {
    ...
    //args.insertOrAssign(IdentifyDuplicateVerticesFilter::k_TriGeomPath_Key, std::make_any<DataPath>(k_TriangleGeomPath));
