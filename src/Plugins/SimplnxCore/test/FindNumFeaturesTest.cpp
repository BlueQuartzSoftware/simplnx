...
TEST_CASE("SimplnxCore::FindNumFeaturesFilter: Valid filter execution", "[SimplnxCore][FindNumFeaturesFilter]")
{
  ...
  args.insertOrAssign(FindNumFeaturesFilter::k_NumFeaturesArrayName_Key, std::make_any<std::string>(k_FeatureCountsNX));
...
TEST_CASE("SimplnxCore::FindNumFeaturesFilter: InValid filter execution", "[SimplnxCore][FindNumFeaturesFilter]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  FindNumFeaturesFilter filter;
  Arguments args;
