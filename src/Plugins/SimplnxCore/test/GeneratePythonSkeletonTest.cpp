...
TEST_CASE("SimplnxCore::GeneratePythonSkeleton")
{
  ...
  DataStructure dataStructure;
  {
    ...
    // Generate filters into a new plugin
    {
      ...
      args.insertOrAssign(GeneratePythonSkeletonFilter::k_UseExistingPlugin_Key, false);
      ...
      args.insertOrAssign(GeneratePythonSkeletonFilter::k_PluginOutputDirectory_Key, std::make_any<FileSystemPathParameter::ValueType>(k_OutputDirectory.string()));
    ...
    // Generate filters into an existing plugin
    {
      ...
      // Create default Parameters for the filter.
      args.insertOrAssign(GeneratePythonSkeletonFilter::k_UseExistingPlugin_Key, true);
      args.insertOrAssign(GeneratePythonSkeletonFilter::k_PluginInputDirectory_Key, std::make_any<FileSystemPathParameter::ValueType>(k_InputDirectory.string()));
      args.insertOrAssign(GeneratePythonSkeletonFilter::k_PluginFilterNames, std::make_any<std::string>(k_FilterNames));
