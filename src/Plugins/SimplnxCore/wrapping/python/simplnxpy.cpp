...
PYBIND11_MODULE(simplnx, mod)
{
  ...
  pathImportPolicy.value("Include", Dream3dImportParameter::PathImportPolicy::Include);
  pathImportPolicy.value("Exclude", Dream3dImportParameter::PathImportPolicy::Exclude);
