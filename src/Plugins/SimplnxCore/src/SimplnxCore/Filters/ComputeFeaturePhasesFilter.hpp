...
{
/**
 * @class ComputeFeaturePhasesFilter
...
public:
  ...
  ~ComputeFeaturePhasesFilter() noexcept override = default;

  ComputeFeaturePhasesFilter(const ComputeFeaturePhasesFilter&) = delete;
  ComputeFeaturePhasesFilter(ComputeFeaturePhasesFilter&&) noexcept = delete;

  ComputeFeaturePhasesFilter& operator=(const ComputeFeaturePhasesFilter&) = delete;
  ComputeFeaturePhasesFilter& operator=(ComputeFeaturePhasesFilter&&) noexcept = delete;
  ...
  static constexpr StringLiteral k_FeaturePhasesArrayName_Key = "feature_phases_array_name";
  static constexpr StringLiteral k_CellFeaturesAttributeMatrixPath_Key = "cell_features_attribute_matrix_path";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFeaturePhasesFilter, "da5bb20e-4a8e-49d9-9434-fbab7bc434fc");
