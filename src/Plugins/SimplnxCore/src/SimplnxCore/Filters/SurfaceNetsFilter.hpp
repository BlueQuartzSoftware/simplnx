 ...
 */
class SIMPLNXCORE_EXPORT SurfaceNetsFilter : public IFilter
{
public:
  ...
  static constexpr StringLiteral k_OmitBoundingBoxSkin_Key = "omit_bounding_box_skin";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, SurfaceNetsFilter, "13ddf0bd-af49-4e0f-95fb-3267952fd6e5");
