...
public:
  ...
  ~ComputeNumFeaturesFilter() noexcept override = default;

  ComputeNumFeaturesFilter(const ComputeNumFeaturesFilter&) = delete;
  ComputeNumFeaturesFilter(ComputeNumFeaturesFilter&&) noexcept = delete;

  ComputeNumFeaturesFilter& operator=(const ComputeNumFeaturesFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeNumFeaturesFilter, "ec3388de-d7a7-4cf6-94f4-81061b0863c8");
