 ...
 */
class SIMPLNXCORE_EXPORT FindTriangleGeomCentroidsFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindTriangleGeomCentroidsFilter, "074c0523-ab7a-4097-b0c3-c4dcbfb9a05e");
