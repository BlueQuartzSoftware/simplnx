 ...
 */
class SIMPLNXCORE_EXPORT ReadVtkStructuredPointsFilter : public AbstractFilter
{
public:
  ...
  static constexpr StringLiteral k_ReadPointData_Key = "read_point_data";
  static constexpr StringLiteral k_ReadCellData_Key = "read_cell_data";
