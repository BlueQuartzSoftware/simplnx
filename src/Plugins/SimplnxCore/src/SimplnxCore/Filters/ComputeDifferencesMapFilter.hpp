...
{
/**
 * @class ComputeDifferencesMapFilter
 * @brief
 */
class SIMPLNXCORE_EXPORT ComputeDifferencesMapFilter : public AbstractFilter
{
public:
  ComputeDifferencesMapFilter() = default;
  ~ComputeDifferencesMapFilter() noexcept override = default;

  ComputeDifferencesMapFilter(const ComputeDifferencesMapFilter&) = delete;
  ComputeDifferencesMapFilter(ComputeDifferencesMapFilter&&) noexcept = delete;

  ComputeDifferencesMapFilter& operator=(const ComputeDifferencesMapFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeDifferencesMapFilter, "5a0ee5b5-c135-4535-85d0-9c2058943099");
