 ...
 */
class SIMPLNXCORE_EXPORT FindNumFeaturesFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindNumFeaturesFilter, "ec3388de-d7a7-4cf6-94f4-81061b0863c8");
