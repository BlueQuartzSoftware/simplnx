 ...
 */
class SIMPLNXCORE_EXPORT FindNeighborhoodsFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindNeighborhoodsFilter, "924c10e3-2f39-4c08-9d7a-7fe029f74f6d");
