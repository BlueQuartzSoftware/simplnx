 ...
 */
class SIMPLNXCORE_EXPORT WriteStlFileFilter : public AbstractFilter
{
public:
  ...
  // Parameter Keys
  static constexpr StringLiteral k_GroupingType_Key = "grouping_type_index";
  static constexpr StringLiteral k_OutputStlFile_Key = "output_stl_file";
  static constexpr StringLiteral k_OutputStlDirectory_Key = "output_stl_directory";
  static constexpr StringLiteral k_OutputStlPrefix_Key = "output_stl_prefix";
  ...
  static constexpr StringLiteral k_PartNumberPath_Key = "part_number_path";
