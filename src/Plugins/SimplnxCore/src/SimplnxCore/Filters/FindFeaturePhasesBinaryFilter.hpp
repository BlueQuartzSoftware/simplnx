 ...
 */
class SIMPLNXCORE_EXPORT FindFeaturePhasesBinaryFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindFeaturePhasesBinaryFilter, "16010080-a913-443a-b5b3-bd43391fe3c0");
