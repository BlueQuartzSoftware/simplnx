...
public:
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_InputGeometry_Key = "input_geometry_path";
  static inline constexpr StringLiteral k_DestinationGeometry_Key = "destination_geometry_path";
  ...
  static inline constexpr StringLiteral k_NewGeometry_Key = "new_geometry_path";
