 ...
 */
class SIMPLNXCORE_EXPORT ConvertDataFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ConvertDataFilter, "6dc586cc-59fb-4ee8-90ff-2d3587da12f5");
