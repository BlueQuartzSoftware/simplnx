...
{
/**
 * @class ComputeSurfaceAreaToVolumeFilter
 * @brief This filter will ....
 */
class SIMPLNXCORE_EXPORT ComputeSurfaceAreaToVolumeFilter : public AbstractFilter
{
public:
  ComputeSurfaceAreaToVolumeFilter() = default;
  ~ComputeSurfaceAreaToVolumeFilter() noexcept override = default;

  ComputeSurfaceAreaToVolumeFilter(const ComputeSurfaceAreaToVolumeFilter&) = delete;
  ComputeSurfaceAreaToVolumeFilter(ComputeSurfaceAreaToVolumeFilter&&) noexcept = delete;

  ComputeSurfaceAreaToVolumeFilter& operator=(const ComputeSurfaceAreaToVolumeFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeSurfaceAreaToVolumeFilter, "94e83e4f-797d-4594-b130-3819b7676f01");
