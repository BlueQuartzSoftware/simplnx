 ...
 */
class SIMPLNXCORE_EXPORT WriteVtkRectilinearGridFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, WriteVtkRectilinearGridFilter, "58a4d758-c5ff-43d3-a394-1508ad00a0d2");
