...
{
/**
 * @class ComputeFeatureBoundsFilter
 * @brief This filter will ....
 */
class SIMPLNXCORE_EXPORT ComputeFeatureBoundsFilter : public AbstractFilter
{
public:
  ComputeFeatureBoundsFilter() = default;
  ~ComputeFeatureBoundsFilter() noexcept override = default;

  ComputeFeatureBoundsFilter(const ComputeFeatureBoundsFilter&) = delete;
  ComputeFeatureBoundsFilter(ComputeFeatureBoundsFilter&&) noexcept = delete;

  ComputeFeatureBoundsFilter& operator=(const ComputeFeatureBoundsFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeFeatureBoundsFilter, "b0616957-d051-4e51-bf27-efb742848fc9");
