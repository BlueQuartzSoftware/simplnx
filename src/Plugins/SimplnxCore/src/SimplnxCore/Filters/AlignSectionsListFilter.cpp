...
Parameters AlignSectionsListFilter::parameters() const
{
  ...
  params.insert(
      std::make_unique<BoolParameter>(k_DREAM3DAlignmentFile_Key, "DREAM3D Alignment File Format", "Turn this ON if the alignment file was generated by another DREAM3D-NX Alignment filter", false));
