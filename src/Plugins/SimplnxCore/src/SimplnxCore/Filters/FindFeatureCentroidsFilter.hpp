 ...
 */
class SIMPLNXCORE_EXPORT FindFeatureCentroidsFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindFeatureCentroidsFilter, "c6875ac7-8bdd-4f69-b6ce-82ac09bd3421");
