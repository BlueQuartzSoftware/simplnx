 ...
 */
class SIMPLNXCORE_EXPORT RegularGridSampleSurfaceMeshFilter : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_UseExistingGeometry_Key = "use_existing_geometry";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, RegularGridSampleSurfaceMeshFilter, "7d061fe1-7c88-45ef-a7ee-f8ab027c8e85");
