...
public:
  ...
  // Parameter Keys
  static constexpr StringLiteral k_RectilinearGridPath_Key = "rectilinear_grid_path";
  ...
  static constexpr StringLiteral k_ImageGeomCellAttributeMatrixName_Key = "image_geom_cell_attribute_matrix_name";
