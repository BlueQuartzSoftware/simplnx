 ...
 */
class SIMPLNXCORE_EXPORT FindEuclideanDistMapFilter : public IFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, FindEuclideanDistMapFilter, "ba9ae8f6-443e-41d3-bb45-a08a139325c1");
