...
public:
  ...
  ~ComputeLargestCrossSectionsFilter() noexcept override = default;

  ComputeLargestCrossSectionsFilter(const ComputeLargestCrossSectionsFilter&) = delete;
  ComputeLargestCrossSectionsFilter(ComputeLargestCrossSectionsFilter&&) noexcept = delete;

  ComputeLargestCrossSectionsFilter& operator=(const ComputeLargestCrossSectionsFilter&) = delete;
  ComputeLargestCrossSectionsFilter& operator=(ComputeLargestCrossSectionsFilter&&) noexcept = delete;
  ...
  static inline constexpr StringLiteral k_LargestCrossSectionsArrayName_Key = "largest_cross_sections_array_name";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ComputeLargestCrossSectionsFilter, "18ba2f7a-4e3a-4547-bd8c-b0955d542a9f");
