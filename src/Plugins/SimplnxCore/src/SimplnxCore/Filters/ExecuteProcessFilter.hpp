 ...
 */
class SIMPLNXCORE_EXPORT ExecuteProcessFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ExecuteProcessFilter, "fb511a70-2175-4595-8c11-d1b5b6794221");
