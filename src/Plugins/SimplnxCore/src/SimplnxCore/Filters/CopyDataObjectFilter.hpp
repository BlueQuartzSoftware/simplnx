...
namespace nx::core
{
class SIMPLNXCORE_EXPORT CopyDataObjectFilter : public AbstractFilter
{
public:
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, CopyDataObjectFilter, "ac8d51d8-9167-5628-a060-95a8863a76b1");
