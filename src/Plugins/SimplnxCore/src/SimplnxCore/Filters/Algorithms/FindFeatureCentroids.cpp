...
{
public:
  FindFeatureCentroidsImpl1(FindFeatureCentroids* filter, double* sum, double* center, size_t* count, std::array<size_t, 3> dims, const nx::core::ImageGeom& imageGeom, const Int32Array& featureIds)
  : m_Filter(filter)
  , m_Sum(sum)
  , m_Center(center)
  , m_Count(count)
