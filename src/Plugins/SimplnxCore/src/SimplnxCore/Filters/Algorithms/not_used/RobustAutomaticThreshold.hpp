...
* This is example code to put in the Execute Method of the filter.
  ...
  inputValues.CreatedMaskName = filterArgs.value<DataObjectNameParameter::ValueType>(created_mask_name);
  inputValues.GradientArrayPath = filterArgs.value<ArraySelectionParameter::ValueType>(gradient_array_path);
  inputValues.InputArrayPath = filterArgs.value<ArraySelectionParameter::ValueType>(input_array_path);
