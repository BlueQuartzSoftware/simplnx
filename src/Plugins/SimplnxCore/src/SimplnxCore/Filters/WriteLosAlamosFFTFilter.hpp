...
{
/**
 * @class WriteLosAlamosFFTFilter
 * @brief This filter will ....
 */
class SIMPLNXCORE_EXPORT WriteLosAlamosFFTFilter : public AbstractFilter
{
public:
  WriteLosAlamosFFTFilter() = default;
  ~WriteLosAlamosFFTFilter() noexcept override = default;

  WriteLosAlamosFFTFilter(const WriteLosAlamosFFTFilter&) = delete;
  WriteLosAlamosFFTFilter(WriteLosAlamosFFTFilter&&) noexcept = delete;

  WriteLosAlamosFFTFilter& operator=(const WriteLosAlamosFFTFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, WriteLosAlamosFFTFilter, "9d5ffeba-4339-49d2-a519-5743fbd5e7a9");
