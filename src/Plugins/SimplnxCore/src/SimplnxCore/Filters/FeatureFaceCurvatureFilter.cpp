...
Parameters FeatureFaceCurvatureFilter::parameters() const
{
  ...
  params.insert(std::make_unique<ArrayCreationParameter>(k_PrincipalCurvature1Path_Key, "Principal Curvature 1", "Output DataPath to hold the 'Principal Curvature 1' values", DataPath({"Principal Curvature 1"})));
  params.insert(std::make_unique<ArrayCreationParameter>(k_PrincipalCurvature2Path_Key, "Principal Curvature 2", "Output DataPath to hold the 'Principal Curvature 2' values", DataPath({"Principal Curvature 2"})));
  params.insert(std::make_unique<ArrayCreationParameter>(k_PrincipalDirection1Path_Key, "Principal Direction 1", "Output DataPath to hold the 'Principal Direction 1' values", DataPath({"Principal Direction 1"})));
  params.insert(std::make_unique<ArrayCreationParameter>(k_PrincipalDirection2Path_Key, "Principal Direction 2", "Output DataPath to hold the 'Principal Direction 2' values", DataPath({"Principal Direction 2"})));
  params.insert(std::make_unique<ArrayCreationParameter>(k_GaussianCurvaturePath_Key, "Gaussian Curvature", "Output DataPath to hold the 'Gaussian Curvature' values", DataPath({"Gaussian Curvature"})));
