                                                 ...
                                                 const std::atomic_bool& shouldCancel) const
{
  ...
  inputValues.triangleGeomPath = filterArgs.value<DataPath>(k_TriangleGeom_Key);
  inputValues.surfaceMeshPrincipalCurvature1Path = filterArgs.value<DataPath>(k_PrincipalCurvature1_Key);
  inputValues.surfaceMeshFeatureFaceIdsPath = filterArgs.value<DataPath>(k_FeatureFaceIds_Key);
  inputValues.surfaceMeshFaceLabelsPath = filterArgs.value<DataPath>(k_FaceLabels_Key);
  inputValues.surfaceMeshFaceNormalsPath = filterArgs.value<DataPath>(k_FaceNormals_Key);
  inputValues.surfaceMeshTriangleCentroidsPath = filterArgs.value<DataPath>(k_FaceCentroids_Key);

  inputValues.useNormalsForCurveFitting = filterArgs.value<bool>(k_UseFaceNormals_Key);
  inputValues.surfaceMeshPrincipalCurvature1sPath = filterArgs.value<DataPath>(k_PrincipalCurvature1_Key);
  inputValues.surfaceMeshPrincipalCurvature2sPath = filterArgs.value<DataPath>(k_PrincipalCurvature2_Key);
  inputValues.surfaceMeshPrincipalDirection1sPath = filterArgs.value<DataPath>(k_PrincipalDirection1_Key);
  inputValues.surfaceMeshPrincipalDirection2sPath = filterArgs.value<DataPath>(k_PrincipalDirection2_Key);
  inputValues.surfaceMeshMeanCurvaturesPath = filterArgs.value<DataPath>(k_MeanCurvature_Key);
  inputValues.surfaceMeshGaussianCurvaturesPath = filterArgs.value<DataPath>(k_GaussianCurvature_Key);
  inputValues.surfaceMeshWeingartenMatrixPath = filterArgs.value<DataPath>(k_WeingartenMatrix_Key);
