...
namespace nx::core
{
class SIMPLNXCORE_EXPORT ReshapeDataArrayFilter : public AbstractFilter
{
public:
  ReshapeDataArrayFilter() = default;
  ~ReshapeDataArrayFilter() noexcept override = default;

  ReshapeDataArrayFilter(const ReshapeDataArrayFilter&) = delete;
  ReshapeDataArrayFilter(ReshapeDataArrayFilter&&) noexcept = delete;

  ReshapeDataArrayFilter& operator=(const ReshapeDataArrayFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ReshapeDataArrayFilter, "9831f05e-8b35-4c3d-b733-8c0a24bbd5ca");
