...
public:
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_CalculateLength_Key = "calculate_length";
  static inline constexpr StringLiteral k_CalculateMin_Key = "calculate_min";
  ...
  static inline constexpr StringLiteral k_MinName_Key = "min_name";
