 ...
 */
class SIMPLNXCORE_EXPORT ReverseTriangleWindingFilter : public AbstractFilter
{
public:
  ...
  static constexpr StringLiteral k_TriGeomPath_Key = "input_triangle_geometry_path";
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ReverseTriangleWindingFilter, "f11a45e9-c169-4227-85b0-0fb0108e47de");
