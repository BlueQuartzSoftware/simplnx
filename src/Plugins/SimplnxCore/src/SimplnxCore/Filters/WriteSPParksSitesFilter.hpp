...
{
/**
 * @class WriteSPParksSitesFilter
 * @brief This filter will ....
 */
class SIMPLNXCORE_EXPORT WriteSPParksSitesFilter : public AbstractFilter
{
public:
  WriteSPParksSitesFilter() = default;
  ~WriteSPParksSitesFilter() noexcept override = default;

  WriteSPParksSitesFilter(const WriteSPParksSitesFilter&) = delete;
  WriteSPParksSitesFilter(WriteSPParksSitesFilter&&) noexcept = delete;

  WriteSPParksSitesFilter& operator=(const WriteSPParksSitesFilter&) = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, WriteSPParksSitesFilter, "FF5ffeDD-4339-49d2-a519-AA43fbd3e710");
