...
public:
  ...
  static inline constexpr StringLiteral k_CADSliceDataContainerName_Key = "cad_slice_data_container_name";
  ...
  static inline constexpr StringLiteral k_HatchDataContainerName_Key = "hatch_data_container_name";
