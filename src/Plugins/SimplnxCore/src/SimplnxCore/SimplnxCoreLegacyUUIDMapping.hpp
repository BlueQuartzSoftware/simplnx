...
namespace nx::core
{
  static const AbstractPlugin::SIMPLMapType k_SIMPL_to_SimplnxCore
  {
    ...
    {nx::core::Uuid::FromString("ce1ee404-0336-536c-8aad-f9641c9458be").value(), {nx::core::FilterTraits<AlignGeometries>::uuid, &AlignGeometries::FromSIMPLJson}}, // AlignGeometries
    ...
    {nx::core::Uuid::FromString("f7bc0e1e-0f50-5fe0-a9e7-510b6ed83792").value(), {nx::core::FilterTraits<ChangeAngleRepresentation>::uuid, &ChangeAngleRepresentation::FromSIMPLJson}}, // ChangeAngleRepresentation
    ...
    //{nx::core::Uuid::FromString("47cafe63-83cc-5826-9521-4fb5bea684ef").value(), {nx::core::FilterTraits<ConditionalSetValue>::uuid, &ConditionalSetValue::FromSIMPLJson}}, // ConditionalSetValue
    ...
    {nx::core::Uuid::FromString("a37f2e24-7400-5005-b9a7-b2224570cbe9").value(), {nx::core::FilterTraits<ConditionalSetValue>::uuid, &ConditionalSetValue::FromSIMPLJson}}, // ReplaceValueInArray
    ...
    {nx::core::Uuid::FromString("816fbe6b-7c38-581b-b149-3f839fb65b93").value(), {nx::core::FilterTraits<CreateDataGroup>::uuid, &CreateDataGroup::FromSIMPLJson}}, // CreateDataContainer
    ...
    {nx::core::Uuid::FromString("f2132744-3abb-5d66-9cd9-c9a233b5c4aa").value(), {nx::core::FilterTraits<CreateImageGeometry>::uuid, &CreateImageGeometry::FromSIMPLJson}}, // CreateImageGeometry
    {nx::core::Uuid::FromString("baa4b7fe-31e5-5e63-a2cb-0bb9d844cfaf").value(), {nx::core::FilterTraits<CropImageGeometry>::uuid, &CropImageGeometry::FromSIMPLJson}}, // CropImageGeometry
    {nx::core::Uuid::FromString("f28cbf07-f15a-53ca-8c7f-b41a11dae6cc").value(), {nx::core::FilterTraits<CropVertexGeometry>::uuid, &CropVertexGeometry::FromSIMPLJson}}, // CropVertexGeometry
    {nx::core::Uuid::FromString("7b1c8f46-90dd-584a-b3ba-34e16958a7d0").value(), {nx::core::FilterTraits<DeleteData>::uuid, &DeleteData::FromSIMPLJson}}, // RemoveArrays   
    ...
    {nx::core::Uuid::FromString("52a069b4-6a46-5810-b0ec-e0693c636034").value(), {nx::core::FilterTraits<ExtractInternalSurfacesFromTriangleGeometry>::uuid, &ExtractInternalSurfacesFromTriangleGeometry::FromSIMPLJson}}, // ExtractInternalSurfacesFromTriangleGeometry
    ...
    {nx::core::Uuid::FromString("29086169-20ce-52dc-b13e-824694d759aa").value(), {nx::core::FilterTraits<FindDifferencesMap>::uuid, &FindDifferencesMap::FromSIMPLJson}}, // FindDifferenceMap
    ...
    {nx::core::Uuid::FromString("d2b0ae3d-686a-5dc0-a844-66bc0dc8f3cb").value(), {nx::core::FilterTraits<FindSurfaceFeatures>::uuid, &FindSurfaceFeatures::FromSIMPLJson}}, // FindSurfaceFeatures
    ...
    {nx::core::Uuid::FromString("0e8c0818-a3fb-57d4-a5c8-7cb8ae54a40a").value(), {nx::core::FilterTraits<IdentifySample>::uuid, &IdentifySample::FromSIMPLJson}}, // IdentifySample
    ...
    {nx::core::Uuid::FromString("dfab9921-fea3-521c-99ba-48db98e43ff8").value(), {nx::core::FilterTraits<InitializeImageGeomCellData>::uuid, &InitializeImageGeomCellData::FromSIMPLJson}}, // InitializeData
