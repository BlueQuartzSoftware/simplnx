...
void BuildMaskInputs(DataStructure& ds, usize dim, usize numComponents)
{
  ...
  auto inStore = DataStoreUtilities::CreateDataStore<float32>(ds, DataPath({"Image Geometry", "CellData", "Input"}), cellShape, {numComponents});
  ...
  auto maskStore = DataStoreUtilities::CreateDataStore<uint8>(ds, DataPath({"Image Geometry", "CellData", "Mask"}), cellShape, {1});
