...
// -----------------------------------------------------------------------------
// (1) Computed-expected: an independent skip-OOB min oracle over MakeStructuringElement(...):
...
//     erosion of a strictly-increasing ramp directly: the min over the (clamped) box neighborhood is attained
...
// (uint8), Ball radius {1,1,1}. The test compares our output md5 with the committed hash.
// -----------------------------------------------------------------------------
