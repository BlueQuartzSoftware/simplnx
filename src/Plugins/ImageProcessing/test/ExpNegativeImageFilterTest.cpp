...
// Ramp-Zero-One-Float.nrrd (float32) through OUR reader, run OUR filter (defaults), then compare with the
// committed baseline @0.01. See AcosImageFilterTest.cpp for the full rationale.
// -----------------------------------------------------------------------------
