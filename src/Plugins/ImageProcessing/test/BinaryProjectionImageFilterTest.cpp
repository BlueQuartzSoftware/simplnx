...
// OUR ITK-free filter: the output md5 must equal ITK's committed hash. Binary projection emits foreground/background
// cast to the input type (type-preserving), so the hash is bit-exact.
