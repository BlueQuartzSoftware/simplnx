...
//------------------------------------------------------------------------------
// Reads @p file into a fresh ImageGeom @p geomPath / cell AM @p cellAmName / scalar array @p arrayName. The function
// routes by extension to the reader that owns that format. It returns the reader's execute Result. These readers
// support an in-core store and an out-of-core store.
