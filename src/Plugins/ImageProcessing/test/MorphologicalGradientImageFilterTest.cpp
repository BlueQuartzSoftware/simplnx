...
// -----------------------------------------------------------------------------
// (1b) Degenerate empty structuring element (Annulus r{0,0,0}) must produce an ALL-ZERO gradient. An Annulus of
...
//     in-memory stores (selected by SIMPLNX_TEST_ALGORITHM_PATH). The test asserts the closed form of a Box
//     morphological gradient of a strictly-increasing ramp directly: gradient == dilate - erode, and for a
//     monotone ramp the box max is at
...
// STAPLE1.png (uint8), Ball radius {1,1,1}. The test compares our output md5 with the committed hash. MorphologicalGradient
