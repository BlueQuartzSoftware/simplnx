#include "LaplacianRecursiveGaussianImageFilter.hpp"
...
namespace nx::core
{
std::string LaplacianRecursiveGaussianImageFilter::name() const
{
  return FilterTraits<LaplacianRecursiveGaussianImageFilter>::name;
}
std::string LaplacianRecursiveGaussianImageFilter::className() const
{
  return FilterTraits<LaplacianRecursiveGaussianImageFilter>::className;
}
Uuid LaplacianRecursiveGaussianImageFilter::uuid() const
{
  return FilterTraits<LaplacianRecursiveGaussianImageFilter>::uuid;
}
std::string LaplacianRecursiveGaussianImageFilter::humanName() const
{
  return "Laplacian Recursive Gaussian Image Filter";
}
std::vector<std::string> LaplacianRecursiveGaussianImageFilter::defaultTags() const
{
  return {className(), "ImageProcessing", "Laplacian", "Gaussian", "EdgeDetection"};
}

Parameters LaplacianRecursiveGaussianImageFilter::parameters() const
{
  Parameters params;
...
IFilter::VersionType LaplacianRecursiveGaussianImageFilter::parametersVersion() const
{
  return 1;
}
IFilter::UniquePointer LaplacianRecursiveGaussianImageFilter::clone() const
{
  return std::make_unique<LaplacianRecursiveGaussianImageFilter>();
}

IFilter::PreflightResult LaplacianRecursiveGaussianImageFilter::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler,
                                                                              const std::atomic_bool& shouldCancel, const ExecutionContext& executionContext) const
{
  ...
  // requireScalar=true: the recursive Gaussian is defined on scalar images. The Laplacian output is a FIXED float32
...
Result<> LaplacianRecursiveGaussianImageFilter::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler,
                                                            const std::atomic_bool& shouldCancel, const ExecutionContext& executionContext) const
{
  auto imageGeomPath = filterArgs.value<DataPath>(k_InputImageGeomPath_Key);
  auto selectedInputArray = filterArgs.value<DataPath>(k_InputImageDataPath_Key);
  ...
  return ImageProcessing::ExecuteLaplacianRecursiveGaussianImageFilter(dataStructure, imageGeomPath, selectedInputArray, outputArrayPath, sigma, normalizeAcrossScale, shouldCancel, messageHandler);
}
...
Result<Arguments> LaplacianRecursiveGaussianImageFilter::FromSIMPLJson(const nlohmann::json& json)
{
  Arguments args = LaplacianRecursiveGaussianImageFilter().getDefaultArguments();
