...
{
/**
 * @class ReadImageStackFilter
 * @brief Reads an ordered image sequence into a three-dimensional Image Geometry.
 */
class IMAGEPROCESSING_EXPORT ReadImageStackFilter : public IFilter
{
public:
  ReadImageStackFilter() = default;
  ~ReadImageStackFilter() noexcept override = default;

  ReadImageStackFilter(const ReadImageStackFilter&) = delete;
  ReadImageStackFilter(ReadImageStackFilter&&) noexcept = delete;

  ReadImageStackFilter& operator=(const ReadImageStackFilter&) = delete;
  ReadImageStackFilter& operator=(ReadImageStackFilter&&) noexcept = delete;
...
SIMPLNX_DEF_FILTER_TRAITS(nx::core, ReadImageStackFilter, "15e7784e-6a9b-457c-9f5c-f5983246c8e8");
