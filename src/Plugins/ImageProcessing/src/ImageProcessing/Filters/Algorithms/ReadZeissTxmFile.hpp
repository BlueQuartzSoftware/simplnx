...
struct IMAGEPROCESSING_EXPORT ReadZeissTxmFileInputValues
{
 ...
 * @brief
 */
struct IMAGEPROCESSING_EXPORT ReadZeissTxmFilterFileCache
{
  fs::path inputFile;
 ...
 */
class IMAGEPROCESSING_EXPORT ReadZeissTxmFile
{
