#include "MinimumProjectionImageFilter.hpp"
...
{
//------------------------------------------------------------------------------
std::string MinimumProjectionImageFilter::name() const
{
  return FilterTraits<MinimumProjectionImageFilter>::name;
}

//------------------------------------------------------------------------------
std::string MinimumProjectionImageFilter::className() const
{
  return FilterTraits<MinimumProjectionImageFilter>::className;
}

//------------------------------------------------------------------------------
Uuid MinimumProjectionImageFilter::uuid() const
{
  return FilterTraits<MinimumProjectionImageFilter>::uuid;
}

//------------------------------------------------------------------------------
std::string MinimumProjectionImageFilter::humanName() const
{
  return "Minimum Projection Image Filter";
}

//------------------------------------------------------------------------------
std::vector<std::string> MinimumProjectionImageFilter::defaultTags() const
{
  return {className(), "ImageProcessing", "Minimum", "Projection", "ImageStatistics"};
}

//------------------------------------------------------------------------------
Parameters MinimumProjectionImageFilter::parameters() const
{
  Parameters params;
...
//------------------------------------------------------------------------------
IFilter::VersionType MinimumProjectionImageFilter::parametersVersion() const
{
  return 1;
}

//------------------------------------------------------------------------------
IFilter::UniquePointer MinimumProjectionImageFilter::clone() const
{
  return std::make_unique<MinimumProjectionImageFilter>();
}

//------------------------------------------------------------------------------
IFilter::PreflightResult MinimumProjectionImageFilter::preflightImpl(const DataStructure& dataStructure, const Arguments& filterArgs, const MessageHandler& messageHandler,
                                                                     const std::atomic_bool& shouldCancel, const ExecutionContext& executionContext) const
{
  ...
  // Minimum projection preserves the element type, so both preflight and execute use the default
...
//------------------------------------------------------------------------------
Result<> MinimumProjectionImageFilter::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler,
                                                   const std::atomic_bool& shouldCancel, const ExecutionContext& executionContext) const
{
  auto imageGeomPath = filterArgs.value<DataPath>(k_InputImageGeomPath_Key);
  auto selectedInputArray = filterArgs.value<DataPath>(k_InputImageDataPath_Key);
  ...
  return ImageProcessing::ExecuteAxisProjectionImageFilter(dataStructure, imageGeomPath, selectedInputArray, outputArrayPath, static_cast<usize>(projectionDimension), ImageProcessing::MinReduce{},
