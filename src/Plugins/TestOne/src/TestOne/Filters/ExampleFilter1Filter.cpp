...
{
  Parameters params;
  params.insertSeparator(Parameters::Separator{"FileSystem Selections"});
  ...
  params.insertSeparator(Parameters::Separator{"Linked Parameter"});
  ...
  params.insertSeparator(Parameters::Separator{"Vector Parameters"});
  ...
  params.insertSeparator(Parameters::Separator{"Other Parameters"});
  ...
  params.insertSeparator(Parameters::Separator{"Big Parameters"});
  ...
  params.insertSeparator(Parameters::Separator{"Multiple Linked Parameters"});
...
//------------------------------------------------------------------------------
IFilter::VersionType ExampleFilter1Filter::parametersVersion() const
{
  return 1;
}
