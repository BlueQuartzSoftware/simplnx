...
{
/**
 * @class LinkFeatureMapToElementArray
 * @brief This filter will ....
 */
class COMPLEX_EXPORT LinkFeatureMapToElementArray : public IFilter
{
public:
  LinkFeatureMapToElementArray() = default;
  ~LinkFeatureMapToElementArray() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex::LinkFeatureMapToElementArray, "50f91ecb-69a9-517c-b104-9c1a77af0ef2");
