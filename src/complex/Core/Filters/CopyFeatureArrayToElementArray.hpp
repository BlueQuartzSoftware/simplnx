 ...
 */
class COMPLEX_EXPORT CopyFeatureArrayToElementArray : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::CopyFeatureArrayToElementArray, "2217650b-be8b-5944-8dda-f057a327e953");
