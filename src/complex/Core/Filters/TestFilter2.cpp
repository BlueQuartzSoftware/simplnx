...
#include "complex/Core/Parameters/MultiArraySelectionParameter.hpp"
...
Parameters TestFilter2::parameters() const
{
  ...
  params.insert(std::make_unique<MultiArraySelectionParameter>(k_Param4, "Parameter 4", "The 4th parameter", MultiArraySelectionParameter::ValueType{DataPath(), DataPath(), DataPath()}));
  return params;
}
