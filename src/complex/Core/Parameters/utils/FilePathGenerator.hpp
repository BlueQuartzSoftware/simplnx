...
std::vector<std::string> GenerateFileList2(const StackFileListInfo& info, bool validatePaths)
{
   ...
   * @return
   */
std::vector<std::string> GenerateFileList(int32_t start, int32_t end, int32_t increment,
                                                                   ...
                                                                   const std::string& filePrefix, const std::string& separator, const std::string& fileSuffix, const std::string& fileExtension, int32_t paddingDigits)
{
   ...
   * @return
   */
//    static TileRCIndexLayout2D GenerateRCIndexMontageFileList(int32_t rowStart, int32_t rowEnd, int32_t colStart, int32_t colEnd, bool& hasMissingFiles, bool rcOrdering, const std::string& inputPath,
