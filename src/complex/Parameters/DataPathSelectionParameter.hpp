...
namespace complex
{
class COMPLEX_EXPORT DataPathSelectionParameter : public MutableDataParameter
{
public:
...
COMPLEX_DEF_PARAMETER_TRAITS(complex::DataPathSelectionParameter, "cd12d081-fbf0-46c4-8f4a-15e2e06e98b8");
