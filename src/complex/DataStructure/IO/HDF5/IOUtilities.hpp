...
Result<> COMPLEX_EXPORT ReadDataMap(DataStructureReader& reader, const H5::GroupReader& parentGroup, DataObject::IdType parentId, bool useEmptyDataStore = false);
Result<> COMPLEX_EXPORT ReadingBaseGroup(DataStructureReader& reader, const H5::GroupReader& groupReader, BaseGroup* baseGroup, bool useEmptyDataStore = false);
