...
public:
   ...
   * @return GridMontage*
   */
  static GridMontage* Create(DataStructure& dataGraph, std::string name, const std::optional<IdType>& parentId = {});
   ...
   * @return GridMontage*
   */
  static GridMontage* Import(DataStructure& dataGraph, std::string name, IdType importId, const std::optional<IdType>& parentId = {});
...
protected:
   ...
   * @param name
   */
  GridMontage(DataStructure& dataGraph, std::string name);
   ...
   * @param importId
   */
  GridMontage(DataStructure& dataGraph, std::string name, IdType importId);
