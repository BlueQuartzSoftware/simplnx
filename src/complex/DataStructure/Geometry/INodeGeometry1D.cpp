...
namespace complex
{
INodeGeometry1D::INodeGeometry1D(DataStructure& dataGraph, std::string name)
: INodeGeometry0D(dataGraph, std::move(name))
{
}

INodeGeometry1D::INodeGeometry1D(DataStructure& dataGraph, std::string name, IdType importId)
