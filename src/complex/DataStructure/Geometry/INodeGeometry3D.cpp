...
namespace complex
{
INodeGeometry3D::INodeGeometry3D(DataStructure& dataGraph, std::string name)
: INodeGeometry2D(dataGraph, std::move(name))
{
}

INodeGeometry3D::INodeGeometry3D(DataStructure& dataGraph, std::string name, IdType importId)
