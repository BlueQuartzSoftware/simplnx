...
H5::ErrorType TriangleGeom::readHdf5(const H5::GroupReader& groupReader)
{
  return getDataMap().readH5Group(*getDataStructure(), groupReader, getId());
}

H5::ErrorType TriangleGeom::writeHdf5(H5::DataStructureWriter& dataStructureWriter, const std::shared_ptr<H5::GroupWriter>& parentGroupWriter) const
{
