...
{
class COMPLEX_EXPORT AttributeIO
{
public:
...
extern template COMPLEX_EXPORT int8_t AttributeIO::readAsValue<int8_t>() const;
extern template COMPLEX_EXPORT int16_t AttributeIO::readAsValue<int16_t>() const;
extern template COMPLEX_EXPORT int32_t AttributeIO::readAsValue<int32_t>() const;
extern template COMPLEX_EXPORT int64_t AttributeIO::readAsValue<int64_t>() const;
extern template COMPLEX_EXPORT uint8_t AttributeIO::readAsValue<uint8_t>() const;
extern template COMPLEX_EXPORT uint16_t AttributeIO::readAsValue<uint16_t>() const;
extern template COMPLEX_EXPORT uint32_t AttributeIO::readAsValue<uint32_t>() const;
extern template COMPLEX_EXPORT uint64_t AttributeIO::readAsValue<uint64_t>() const;
extern template COMPLEX_EXPORT float AttributeIO::readAsValue<float>() const;
...
extern template COMPLEX_EXPORT std::vector<int32_t> AttributeIO::readAsVector<int32_t>() const;
extern template COMPLEX_EXPORT std::vector<int64_t> AttributeIO::readAsVector<int64_t>() const;
extern template COMPLEX_EXPORT std::vector<uint8_t> AttributeIO::readAsVector<uint8_t>() const;
extern template COMPLEX_EXPORT std::vector<uint16_t> AttributeIO::readAsVector<uint16_t>() const;
extern template COMPLEX_EXPORT std::vector<uint32_t> AttributeIO::readAsVector<uint32_t>() const;
extern template COMPLEX_EXPORT std::vector<uint64_t> AttributeIO::readAsVector<uint64_t>() const;
extern template COMPLEX_EXPORT std::vector<float> AttributeIO::readAsVector<float>() const;
