...
template COMPLEX_EXPORT std::vector<int8_t> DatasetIO::readAsVector<int8_t>() const;
template COMPLEX_EXPORT std::vector<int16_t> DatasetIO::readAsVector<int16_t>() const;
template COMPLEX_EXPORT std::vector<int32_t> DatasetIO::readAsVector<int32_t>() const;
template COMPLEX_EXPORT std::vector<int64_t> DatasetIO::readAsVector<int64_t>() const;
template COMPLEX_EXPORT std::vector<uint8_t> DatasetIO::readAsVector<uint8_t>() const;
template COMPLEX_EXPORT std::vector<uint16_t> DatasetIO::readAsVector<uint16_t>() const;
template COMPLEX_EXPORT std::vector<uint32_t> DatasetIO::readAsVector<uint32_t>() const;
template COMPLEX_EXPORT std::vector<uint64_t> DatasetIO::readAsVector<uint64_t>() const;
#ifdef __APPLE__
template COMPLEX_EXPORT std::vector<size_t> DatasetIO::readAsVector<size_t>() const;
#endif
template COMPLEX_EXPORT std::vector<float> DatasetIO::readAsVector<float>() const;
template COMPLEX_EXPORT std::vector<double> DatasetIO::readAsVector<double>() const;

template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<int8_t>(nonstd::span<int8_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<int16_t>(nonstd::span<int16_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<int32_t>(nonstd::span<int32_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<int64_t>(nonstd::span<int64_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<uint8_t>(nonstd::span<uint8_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<uint16_t>(nonstd::span<uint16_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<uint32_t>(nonstd::span<uint32_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<uint64_t>(nonstd::span<uint64_t>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<bool>(nonstd::span<bool>&) const;
#ifdef __APPLE__
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<size_t>(nonstd::span<size_t>&) const;
#endif
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<float>(nonstd::span<float>&) const;
template COMPLEX_EXPORT bool DatasetIO::readIntoSpan<double>(nonstd::span<double>&) const;

template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<int8_t>(nonstd::span<int8_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<int16_t>(nonstd::span<int16_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<int32_t>(nonstd::span<int32_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<int64_t>(nonstd::span<int64_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<uint8_t>(nonstd::span<uint8_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<uint16_t>(nonstd::span<uint16_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<uint32_t>(nonstd::span<uint32_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<uint64_t>(nonstd::span<uint64_t>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<bool>(nonstd::span<bool>, nonstd::span<const hsize_t>) const;
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<char>(nonstd::span<char>, nonstd::span<const hsize_t>) const;
#ifdef __APPLE__
template COMPLEX_EXPORT bool DatasetIO::readChunkIntoSpan<size_t>(nonstd::span<size_t>, nonstd::span<const hsize_t>) const;
#endif
