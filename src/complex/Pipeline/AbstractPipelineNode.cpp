...
void AbstractPipelineNode::setDataStructure(const DataStructure& dataGraph)
{
...
void AbstractPipelineNode::setPreflightStructure(const DataStructure& dataGraph, bool success)
{
  m_PreflightStructure = dataGraph;
