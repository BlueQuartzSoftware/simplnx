...
{
/**
 * @class ItkMultiOtsuThreshold
 * @brief This filter will ....
 */
class IMAGEPROCESSING_EXPORT ItkMultiOtsuThreshold : public IFilter
{
public:
  ItkMultiOtsuThreshold() = default;
  ~ItkMultiOtsuThreshold() noexcept override = default;
  ...
  static inline constexpr StringLiteral k_Levels_Key = "Levels";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkMultiOtsuThreshold, "0a6088e8-19f2-43cb-9178-2aff90c6009f");
