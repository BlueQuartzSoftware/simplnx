 ...
 */
class IMAGEPROCESSING_EXPORT ItkFindMaxima : public IFilter
{
public:
  ItkFindMaxima() = default;
  ~ItkFindMaxima() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkFindMaxima, "000be116-d9c8-4a5a-9ec9-60ed12e7ea22");
