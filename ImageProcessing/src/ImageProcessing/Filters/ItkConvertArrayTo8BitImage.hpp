 ...
 */
class COMPLEX_EXPORT ItkConvertArrayTo8BitImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkConvertArrayTo8BitImage, "4f44b137-b94c-5119-a6d8-d21a3c0fdb54");
