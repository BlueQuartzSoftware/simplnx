 ...
 */
class IMAGEPROCESSING_EXPORT ItkGrayToRGB : public IFilter
{
public:
  ItkGrayToRGB() = default;
  ~ItkGrayToRGB() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkGrayToRGB, "733f5db7-a851-47b5-a634-d0a25f2e08b9");
