...
{
/**
 * @class ItkManualThreshold
 * @brief This filter will ....
 */
class IMAGEPROCESSING_EXPORT ItkManualThreshold : public IFilter
{
public:
  ItkManualThreshold() = default;
  ~ItkManualThreshold() noexcept override = default;
  ...
  // Parameter Keys
  static inline constexpr StringLiteral k_ManualParameter_Key = "manual_parameter";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkManualThreshold, "d1180c91-c4e9-4264-9297-1cb797c005a5");
