 ...
 */
class IMAGEPROCESSING_EXPORT ItkKMeans : public IFilter
{
public:
  ItkKMeans() = default;
  ~ItkKMeans() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkKMeans, "b8000dd0-351b-42c8-829a-560065f477ca");
