 ...
 */
class IMAGEPROCESSING_EXPORT ItkMeanKernel : public IFilter
{
public:
  ItkMeanKernel() = default;
  ~ItkMeanKernel() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkMeanKernel, "3d452981-3be3-4116-b5d3-8b80aca63614");
