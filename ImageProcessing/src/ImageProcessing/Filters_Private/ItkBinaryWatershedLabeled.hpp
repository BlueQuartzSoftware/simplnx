...
public:
  ...
  static inline constexpr StringLiteral k_PeakTolerance_Key = "peak_tolerance";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkBinaryWatershedLabeled, "e5072b2f-e108-4a26-8a70-f2866b5b55c9");
