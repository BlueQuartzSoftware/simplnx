...
{
/**
 * @class ItkGaussianBlur
 * @brief This filter will ....
 */
class IMAGEPROCESSING_EXPORT ItkGaussianBlur : public IFilter
{
public:
  ItkGaussianBlur() = default;
  ~ItkGaussianBlur() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ItkGaussianBlur, "704f6145-aa17-40fb-9596-747e2f230671");
