...
TEST_CASE("ITKLaplacianRecursiveGaussianImageFilter(default)", "[ITKImageProcessing][ITKLaplacianRecursiveGaussianImage][default]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_LaplacianRecursiveGaussianImageFilter_default.nrrd";
