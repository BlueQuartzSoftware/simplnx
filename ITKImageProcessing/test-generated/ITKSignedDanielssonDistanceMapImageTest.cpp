...
TEST_CASE("ITKSignedDanielssonDistanceMapImageFilter(default)", "[ITKImageProcessing][ITKSignedDanielssonDistanceMapImage][default]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_SignedDanielssonDistanceMapImageFilter_default.nrrd";
