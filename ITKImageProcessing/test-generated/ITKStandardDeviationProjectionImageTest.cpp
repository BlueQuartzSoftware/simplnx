...
TEST_CASE("ITKStandardDeviationProjectionImageFilter(z_projection)", "[ITKImageProcessing][ITKStandardDeviationProjectionImage][z_projection]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_StandardDeviationProjectionImageFilter_z_projection.nrrd";
