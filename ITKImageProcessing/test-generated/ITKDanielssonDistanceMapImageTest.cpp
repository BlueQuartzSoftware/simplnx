...
TEST_CASE("ITKDanielssonDistanceMapImageFilter(default)", "[ITKImageProcessing][ITKDanielssonDistanceMapImage][default]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_DanielssonDistanceMapImageFilter_default.nrrd";
