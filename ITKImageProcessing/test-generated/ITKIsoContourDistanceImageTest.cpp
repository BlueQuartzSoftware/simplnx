...
TEST_CASE("ITKIsoContourDistanceImageFilter(default)", "[ITKImageProcessing][ITKIsoContourDistanceImage][default]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_IsoContourDistanceImageFilter_default.nrrd";
