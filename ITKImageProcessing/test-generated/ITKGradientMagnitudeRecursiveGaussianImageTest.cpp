...
TEST_CASE("ITKGradientMagnitudeRecursiveGaussianImageFilter(default)", "[ITKImageProcessing][ITKGradientMagnitudeRecursiveGaussianImage][default]")
{
  ...
  fs::path baselineFilePath = fs::path(unit_test::k_SourceDir.view()) / complex::unit_test::k_DataDir.view() / "JSONFilters/Baseline/BasicFilters_GradientMagnitudeRecursiveGaussianImageFilter_default.nrrd";
