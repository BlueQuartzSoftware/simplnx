...
TEST_CASE("ITKImageProcessing::ITKMeanProjectionImage: z_projection", "[ITKImageProcessing][ITKMeanProjectionImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKMeanProjectionImage::k_ProjectionDimension_Key, std::make_any<float64>(pProjectionDimension));
    args.insertOrAssign(ITKMeanProjectionImage::k_SelectedImageGeomPath_Key, std::make_any<DataPath>(inputGeometryPath));
    args.insertOrAssign(ITKMeanProjectionImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKMeanProjectionImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
