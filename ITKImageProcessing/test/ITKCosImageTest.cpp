...
// Cosine of an image
TEST_CASE("ITKImageProcessing::ITKCosImage: float", "[ITKImageProcessing][ITKCosImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKCosImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKCosImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
...
// Cosine of an image
TEST_CASE("ITKImageProcessing::ITKCosImage: short", "[ITKImageProcessing][ITKCosImage]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKCosImage filter;
  DataStructure ds;
