...
TEST_CASE("ITKImageProcessing::ITKTanImage: defaults", "[ITKImageProcessing][ITKTanImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKTanImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKTanImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
