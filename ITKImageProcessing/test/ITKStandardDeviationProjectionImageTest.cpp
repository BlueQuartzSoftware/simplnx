...
TEST_CASE("ITKImageProcessing::ITKStandardDeviationProjectionImage: z_projection", "[ITKImageProcessing][ITKStandardDeviationProjectionImage]")
{
  ...
  // Test the filter itself
  {
    ...
    auto pProjectionDimension = 2;
    args.insertOrAssign(ITKStandardDeviationProjectionImage::k_ProjectionDimension_Key, std::make_any<float64>(pProjectionDimension));
    ...
    args.insertOrAssign(ITKStandardDeviationProjectionImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKStandardDeviationProjectionImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
