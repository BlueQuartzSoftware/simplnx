...
TEST_CASE("ITKImageProcessing::ITKSqrtImage: defaults", "[ITKImageProcessing][ITKSqrtImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKSqrtImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKSqrtImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
