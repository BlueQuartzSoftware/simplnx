...
TEST_CASE("ITKImageProcessing::ITKSignedDanielssonDistanceMapImage: default", "[ITKImageProcessing][ITKSignedDanielssonDistanceMapImage]")
{
  ...
  // Test the filter itself
  {
    ...
    auto pSquaredDistance = false;
    auto pUseImageSpacing = false;
    args.insertOrAssign(ITKSignedDanielssonDistanceMapImage::k_InsideIsPositive_Key, std::make_any<bool>(pInsideIsPositive));
    args.insertOrAssign(ITKSignedDanielssonDistanceMapImage::k_SquaredDistance_Key, std::make_any<bool>(pSquaredDistance));
    args.insertOrAssign(ITKSignedDanielssonDistanceMapImage::k_UseImageSpacing_Key, std::make_any<bool>(pUseImageSpacing));
    ...
    args.insertOrAssign(ITKSignedDanielssonDistanceMapImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKSignedDanielssonDistanceMapImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
