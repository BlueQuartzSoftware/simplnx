...
TEST_CASE("ITKImageProcessing::ITKBoundedReciprocalImage: defaults", "[ITKImageProcessing][ITKBoundedReciprocalImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKBoundedReciprocalImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKBoundedReciprocalImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
...
TEST_CASE("ITKImageProcessing::ITKBoundedReciprocalImage: vector", "[ITKImageProcessing][ITKBoundedReciprocalImage]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKBoundedReciprocalImage filter;
  DataStructure ds;
