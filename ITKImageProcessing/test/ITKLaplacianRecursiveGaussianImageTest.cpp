...
TEST_CASE("ITKImageProcessing::ITKLaplacianRecursiveGaussianImage: default", "[ITKImageProcessing][ITKLaplacianRecursiveGaussianImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKLaplacianRecursiveGaussianImage::k_Sigma_Key, std::make_any<float64>(pSigma));
    args.insertOrAssign(ITKLaplacianRecursiveGaussianImage::k_NormalizeAcrossScale_Key, std::make_any<bool>(pNormalizeAcrossScale));
    ...
    args.insertOrAssign(ITKLaplacianRecursiveGaussianImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKLaplacianRecursiveGaussianImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
