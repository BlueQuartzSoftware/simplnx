...
TEST_CASE("ITKImageProcessing::ITKGradientMagnitudeImage: default", "[ITKImageProcessing][ITKGradientMagnitudeImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKGradientMagnitudeImage::k_UseImageSpacing_Key, std::make_any<bool>(pUseImageSpacing));
    args.insertOrAssign(ITKGradientMagnitudeImage::k_SelectedImageGeomPath_Key, std::make_any<DataPath>(inputGeometryPath));
    args.insertOrAssign(ITKGradientMagnitudeImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKGradientMagnitudeImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
