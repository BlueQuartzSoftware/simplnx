...
TEST_CASE("ITKImageProcessing::ITKSinImage: defaults", "[ITKImageProcessing][ITKSinImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKSinImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKSinImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
