...
TEST_CASE("ITKImageProcessing::ITKNormalizeImage: defaults", "[ITKImageProcessing][ITKNormalizeImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKNormalizeImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKNormalizeImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
...
TEST_CASE("ITKImageProcessing::ITKNormalizeImage: vector", "[ITKImageProcessing][ITKNormalizeImage]")
{
  // Instantiate the filter, a DataStructure object and an Arguments Object
  ITKNormalizeImage filter;
  DataStructure ds;
