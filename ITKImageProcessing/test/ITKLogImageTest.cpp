...
TEST_CASE("ITKImageProcessing::ITKLogImage: defaults", "[ITKImageProcessing][ITKLogImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKLogImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKLogImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
