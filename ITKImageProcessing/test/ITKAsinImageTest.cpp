...
TEST_CASE("ITKImageProcessing::ITKAsinImage: defaults", "[ITKImageProcessing][ITKAsinImage]")
{
  ...
  // Test the filter itself
  {
    ...
    args.insertOrAssign(ITKAsinImage::k_SelectedCellArrayPath_Key, std::make_any<DataPath>(inputDataPath));
    args.insertOrAssign(ITKAsinImage::k_NewCellArrayName_Key, std::make_any<DataPath>(outputDataPath));
