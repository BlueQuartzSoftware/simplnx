 ...
 */
class COMPLEX_EXPORT IlluminationCorrection : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, IlluminationCorrection, "340ff86c-a203-5ad9-8c87-aa6227ff2009");
