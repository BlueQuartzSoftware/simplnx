 ...
 */
class COMPLEX_EXPORT ITKRefineTileCoordinates : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKRefineTileCoordinates, "13f22db0-d406-5ebd-ab59-0ccc0cfa62ba");
