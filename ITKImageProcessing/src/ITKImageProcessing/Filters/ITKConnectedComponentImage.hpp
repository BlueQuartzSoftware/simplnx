 ...
 */
class COMPLEX_EXPORT ITKConnectedComponentImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKConnectedComponentImage, "96325950-27cf-5491-a164-1bcd6f5a64b5");
