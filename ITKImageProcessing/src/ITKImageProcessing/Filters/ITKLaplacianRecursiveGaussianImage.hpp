 ...
 */
class COMPLEX_EXPORT ITKLaplacianRecursiveGaussianImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKLaplacianRecursiveGaussianImage, "04f741b2-b44c-5175-8a6e-2887afc76a5e");
