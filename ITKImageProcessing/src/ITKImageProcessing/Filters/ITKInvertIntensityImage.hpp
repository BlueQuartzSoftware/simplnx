 ...
 */
class COMPLEX_EXPORT ITKInvertIntensityImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKInvertIntensityImage, "a85ddca8-3870-5f56-bc3c-62e8c9f7fa2e");
