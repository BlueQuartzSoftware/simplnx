 ...
 */
class COMPLEX_EXPORT ITKGrayscaleFillholeImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGrayscaleFillholeImage, "ad63c408-23e7-5fdb-bd68-e1d66f987893");
