 ...
 */
class COMPLEX_EXPORT ITKNormalizeToConstantImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKNormalizeToConstantImage, "a84fe404-7c6f-5666-89ee-ab197391227c");
