 ...
 */
class COMPLEX_EXPORT ITKHistogramMatchingImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKHistogramMatchingImage, "b13a3b4d-3a9f-557a-908e-ce989ea7af9d");
