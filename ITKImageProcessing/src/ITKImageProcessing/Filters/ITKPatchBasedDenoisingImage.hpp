 ...
 */
class COMPLEX_EXPORT ITKPatchBasedDenoisingImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKPatchBasedDenoisingImage, "25681bf3-31aa-552a-9319-99f4a75c7240");
