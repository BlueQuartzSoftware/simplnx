 ...
 */
class COMPLEX_EXPORT ITKFFTNormalizedCorrelationImage : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_RequiredFractionOfOverlappingPixels_Key = "RequiredFractionOfOverlappingPixels";
  static inline constexpr StringLiteral k_SelectedCellArrayPath_Key = "SelectedCellArrayPath";
  static inline constexpr StringLiteral k_MovingCellArrayPath_Key = "MovingCellArrayPath";
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKFFTNormalizedCorrelationImage, "2731ffd1-49fb-51a7-b899-e6c9910df516");
