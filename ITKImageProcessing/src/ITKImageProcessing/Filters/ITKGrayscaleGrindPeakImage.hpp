 ...
 */
class COMPLEX_EXPORT ITKGrayscaleGrindPeakImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGrayscaleGrindPeakImage, "d87ade03-07d5-505d-8a44-ccec822ccebf");
