 ...
 */
class COMPLEX_EXPORT ITKRegionalMinimaImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKRegionalMinimaImage, "766f8e03-2d87-51f2-80d0-6a4b45e1febc");
