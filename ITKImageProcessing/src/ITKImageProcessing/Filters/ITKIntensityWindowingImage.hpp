 ...
 */
class COMPLEX_EXPORT ITKIntensityWindowingImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKIntensityWindowingImage, "0dabd1ef-3d2d-5388-a0ed-982bbf775296");
