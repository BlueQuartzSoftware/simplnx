 ...
 */
class COMPLEX_EXPORT ITKBinaryThinningImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKBinaryThinningImage, "bd2ec326-253e-5c71-9e9e-78e005bb12ee");
