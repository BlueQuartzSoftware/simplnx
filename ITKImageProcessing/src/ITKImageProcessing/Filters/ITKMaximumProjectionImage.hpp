 ...
 */
class COMPLEX_EXPORT ITKMaximumProjectionImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKMaximumProjectionImage, "0d3cbb5e-cc05-5b02-bc9d-08f72a8f3973");
