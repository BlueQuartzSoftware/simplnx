 ...
 */
class COMPLEX_EXPORT ITKSaltAndPepperNoiseImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKSaltAndPepperNoiseImage, "3ce99bca-d424-5955-871a-7c5762215adc");
