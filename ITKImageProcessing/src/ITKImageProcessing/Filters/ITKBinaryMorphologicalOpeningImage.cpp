...
namespace
{
struct ITKBinaryMorphologicalOpeningImageFilterCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryMorphologicalOpeningImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKBinaryMorphologicalOpeningImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryMorphologicalOpeningImageFilterCreationFunctor itkFunctor;
