...
namespace
{
struct ITKGrayscaleMorphologicalOpeningImageFilterCreationFunctor
{
  bool m_SafeBorder;
  ...
  auto operator()() const
  {
    using FilterType = itk::GrayscaleMorphologicalOpeningImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKGrayscaleMorphologicalOpeningImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKGrayscaleMorphologicalOpeningImageFilterCreationFunctor itkFunctor;
