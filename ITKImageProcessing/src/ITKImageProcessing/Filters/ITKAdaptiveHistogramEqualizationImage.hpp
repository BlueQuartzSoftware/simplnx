 ...
 */
class COMPLEX_EXPORT ITKAdaptiveHistogramEqualizationImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKAdaptiveHistogramEqualizationImage, "86813ed4-3250-5614-bc46-62924ae36447");
