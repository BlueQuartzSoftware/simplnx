...
namespace
{
struct ITKBinaryMorphologicalClosingImageFilterCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryMorphologicalClosingImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKBinaryMorphologicalClosingImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryMorphologicalClosingImageFilterCreationFunctor itkFunctor;
