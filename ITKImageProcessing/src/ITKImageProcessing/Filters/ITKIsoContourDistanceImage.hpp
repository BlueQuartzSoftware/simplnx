 ...
 */
class COMPLEX_EXPORT ITKIsoContourDistanceImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKIsoContourDistanceImage, "b017d59f-1117-5259-973f-76592321b9c6");
