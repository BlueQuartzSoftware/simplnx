 ...
 */
class COMPLEX_EXPORT ITKGrayscaleErodeImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKGrayscaleErodeImage, "77d708ee-acec-5fb8-95b4-0e60f5246f85");
