...
namespace
{
struct ITKBinaryDilateImageFilterCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::BinaryDilateImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKBinaryDilateImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBinaryDilateImageFilterCreationFunctor itkFunctor;
