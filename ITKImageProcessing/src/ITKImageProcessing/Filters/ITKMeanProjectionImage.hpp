 ...
 */
class COMPLEX_EXPORT ITKMeanProjectionImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKMeanProjectionImage, "d3d21fb5-b153-5415-bb95-0b5f42a101de");
