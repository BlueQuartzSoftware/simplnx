 ...
 */
class COMPLEX_EXPORT ITKSmoothingRecursiveGaussianImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKSmoothingRecursiveGaussianImage, "5589a536-86a2-5552-9edb-aab8b12cd624");
