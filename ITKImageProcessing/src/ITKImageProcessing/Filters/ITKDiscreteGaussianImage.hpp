 ...
 */
class COMPLEX_EXPORT ITKDiscreteGaussianImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKDiscreteGaussianImage, "65a00e45-15fe-548a-a761-6e85b6e049f7");
