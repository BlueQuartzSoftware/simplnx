 ...
 */
class COMPLEX_EXPORT ITKBinaryMorphologicalClosingImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKBinaryMorphologicalClosingImage, "cd137ed9-e172-5870-8455-ce0c79b40ad6");
