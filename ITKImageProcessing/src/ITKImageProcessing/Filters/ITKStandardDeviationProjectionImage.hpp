 ...
 */
class COMPLEX_EXPORT ITKStandardDeviationProjectionImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKStandardDeviationProjectionImage, "f6695137-f547-5e0c-b458-3bf36577a1c4");
