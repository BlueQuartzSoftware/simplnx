 ...
 */
class COMPLEX_EXPORT ITKSignedMaurerDistanceMapImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKSignedMaurerDistanceMapImage, "4a70c6bd-ca68-5234-9a7b-e2b5202ca0f6");
