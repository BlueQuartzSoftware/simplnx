 ...
 */
class COMPLEX_EXPORT ITKRegionalMaximaImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKRegionalMaximaImage, "884d1eda-bfb1-5c43-8162-3fc6c771135e");
