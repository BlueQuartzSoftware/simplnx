 ...
 */
class COMPLEX_EXPORT ITKDilateObjectMorphologyImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKDilateObjectMorphologyImage, "966d7652-a93d-5b38-9046-499a7d8655cd");
