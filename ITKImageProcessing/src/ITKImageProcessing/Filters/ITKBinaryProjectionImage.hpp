 ...
 */
class COMPLEX_EXPORT ITKBinaryProjectionImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKBinaryProjectionImage, "01757a68-fb95-5e14-a341-0ad3888e9c8d");
