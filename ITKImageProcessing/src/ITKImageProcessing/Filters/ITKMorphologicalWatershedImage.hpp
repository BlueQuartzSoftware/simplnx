 ...
 */
class COMPLEX_EXPORT ITKMorphologicalWatershedImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKMorphologicalWatershedImage, "9838447d-a492-5165-a0b9-a1672b63aa49");
