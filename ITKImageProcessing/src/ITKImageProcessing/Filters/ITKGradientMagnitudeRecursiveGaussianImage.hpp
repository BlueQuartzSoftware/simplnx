 ...
 */
class COMPLEX_EXPORT ITKGradientMagnitudeRecursiveGaussianImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKGradientMagnitudeRecursiveGaussianImage, "1a852e31-bfd0-58e1-8ccc-026b81a97d42");
