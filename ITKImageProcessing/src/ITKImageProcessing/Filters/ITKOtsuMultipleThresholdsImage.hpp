 ...
 */
class COMPLEX_EXPORT ITKOtsuMultipleThresholdsImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKOtsuMultipleThresholdsImage, "3b784c44-549a-547b-aabc-ffe9fde3b3bd");
