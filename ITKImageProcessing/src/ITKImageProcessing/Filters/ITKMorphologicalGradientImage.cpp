...
namespace
{
struct ITKMorphologicalGradientImageFilterCreationFunctor
{
  ...
  auto operator()() const
  {
    using FilterType = itk::MorphologicalGradientImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKMorphologicalGradientImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKMorphologicalGradientImageFilterCreationFunctor itkFunctor;
