...
namespace
{
struct ITKBlackTopHatImageFilterCreationFunctor
{
  bool m_SafeBorder;
  ...
  auto operator()() const
  {
    using FilterType = itk::BlackTopHatImageFilter<InputImageType, OutputImageType>;
...
Result<> ITKBlackTopHatImage::executeImpl(DataStructure& dataStructure, const Arguments& filterArgs, const PipelineFilter* pipelineNode, const MessageHandler& messageHandler) const
{
   ...
   ***************************************************************************/
  ::ITKBlackTopHatImageFilterCreationFunctor itkFunctor;
