 ...
 */
class COMPLEX_EXPORT ITKOpeningByReconstructionImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKOpeningByReconstructionImage, "038fd2d1-4ce4-5d92-9706-b8559e0889c6");
