 ...
 */
class COMPLEX_EXPORT ITKMorphologicalWatershedFromMarkersImage : public IFilter
{
public:
  ...
  static inline constexpr StringLiteral k_MarkerCellArrayPath_Key = "MarkerCellArrayPath";
...
COMPLEX_DEF_FILTER_TRAITS(complex::ITKMorphologicalWatershedFromMarkersImage, "0af42200-3cf9-5871-bbcc-d0245587bc08");
