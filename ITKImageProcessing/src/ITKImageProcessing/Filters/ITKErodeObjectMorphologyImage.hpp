 ...
 */
class COMPLEX_EXPORT ITKErodeObjectMorphologyImage : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, ITKErodeObjectMorphologyImage, "b376041b-c8f6-5664-a5be-6d95daf6c8a2");
