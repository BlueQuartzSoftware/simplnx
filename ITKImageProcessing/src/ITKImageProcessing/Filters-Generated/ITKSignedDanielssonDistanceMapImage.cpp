                                                             ...
                                                             const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions = ITK::DataCheck<cxITKSignedDanielssonDistanceMapImage::ArrayOptionsT, cxITKSignedDanielssonDistanceMapImage::FilterOutputT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);
...
// LINK GEOMETRY OUTPUT STOP
  ...
  return ITK::Execute<cxITKSignedDanielssonDistanceMapImage::ArrayOptionsT, cxITKSignedDanielssonDistanceMapImage::FilterOutputT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor);
}
} // namespace complex
