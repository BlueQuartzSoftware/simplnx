...
Parameters ITKCurvatureAnisotropicDiffusionImage::parameters() const
{
  ...
  params.insert(std::make_unique<ArraySelectionParameter>(k_SelectedImageDataPath_Key, "Input Image Data Array", "The image data that will be processed by this filter.", DataPath{}, complex::ITK::GetFloatingScalarPixelAllowedTypes()));
...
// LINK GEOMETRY OUTPUT STOP
  ...
  return ITK::Execute<cxITKCurvatureAnisotropicDiffusionImage::ArrayOptionsT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor);
}
} // namespace complex
