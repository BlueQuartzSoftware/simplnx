                                                             ...
                                                             const std::atomic_bool& shouldCancel) const
{
  ...
  Result<OutputActions> resultOutputActions = ITK::DataCheck<cxITKLaplacianRecursiveGaussianImage::ArrayOptionsT, cxITKLaplacianRecursiveGaussianImage::FilterOutputT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath);
...
// LINK GEOMETRY OUTPUT STOP
  ...
  return ITK::Execute<cxITKLaplacianRecursiveGaussianImage::ArrayOptionsT, cxITKLaplacianRecursiveGaussianImage::FilterOutputT>(dataStructure, selectedInputArray, imageGeomPath, outputArrayPath, itkFunctor);
}
} // namespace complex
