...
Parameters CreateAbaqusFile::parameters() const
{
  ...
  params.insert(
      std::make_unique<ArraySelectionParameter>(k_AbqFeatureIdsArrayPath_Key, "Feature Ids", "Specifies to which Feature each Element belongs", DataPath{}, ArraySelectionParameter::AllowedTypes{}));
