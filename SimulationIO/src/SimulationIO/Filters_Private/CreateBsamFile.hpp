...
{
/**
 * @class CreateBsamFile
 * @brief This filter will ....
 */
class SIMULATIONIO_EXPORT CreateBsamFile : public IFilter
{
public:
  CreateBsamFile() = default;
  ~CreateBsamFile() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CreateBsamFile, "407b4976-ac06-4827-9627-7af7124b447f");
