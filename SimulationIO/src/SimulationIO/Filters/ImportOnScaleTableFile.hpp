...
{
/**
 * @class ImportOnScaleTableFile
 * @brief This filter will ....
 */
class SIMULATIONIO_EXPORT ImportOnScaleTableFile : public IFilter
{
public:
  ImportOnScaleTableFile() = default;
  ~ImportOnScaleTableFile() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ImportOnScaleTableFile, "fc1de1a0-1fb4-462f-a2c7-8ae1eda5098e");
