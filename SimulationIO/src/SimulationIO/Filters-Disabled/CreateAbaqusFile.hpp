...
{
/**
 * @class CreateAbaqusFile
 * @brief This filter will ....
 */
class SIMULATIONIO_EXPORT CreateAbaqusFile : public IFilter
{
public:
  CreateAbaqusFile() = default;
  ~CreateAbaqusFile() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, CreateAbaqusFile, "957ffcc4-e240-4e2c-afd8-5a3b69235d66");
