...
std::map<complex::Uuid, complex::Uuid> k_SimplToComplexFilterMapping = {
    ...
    {Uuid::FromString("{fcff3b03-bff6-5511-bc65-5e558d12f0a6}").value(), Uuid::FromString("e7f02408-6c01-5b56-b970-7813e64c12e2").value()}, /* Export3dSolidMesh */
    ...
    {Uuid::FromString("{d5873836-f150-5fc9-9bc8-0bc837bd8dd4}").value(), Uuid::FromString("4bdb2202-d8e5-59cd-96fe-09f86adcf9b3").value()}, /* ExportMultiOnScaleTableFile */
    {Uuid::FromString("{8efc447d-1c92-5ec5-885c-60b4a597835c}").value(), Uuid::FromString("cbd17a65-be18-5fb7-b76d-7055507a36be").value()}, /* ExportOnScaleTableFile */
    ...
    {Uuid::FromString("{06dd6e66-84fb-5170-a923-d925dc39bb94}").value(), Uuid::FromString("59e42be5-27ca-589a-bfc8-aa6639c94986").value()}, /* ImportOnScaleTableFile */
};
// Plugin Uuid
