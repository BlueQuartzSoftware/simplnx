 ...
 */
class SURFACEMESHING_EXPORT TriangleCentroidFilter : public IFilter
{
public:
...
COMPLEX_DEF_FILTER_TRAITS(complex, TriangleCentroidFilter, "6eb7f1f4-c26a-5f93-88a6-ed0fbd689ede");
