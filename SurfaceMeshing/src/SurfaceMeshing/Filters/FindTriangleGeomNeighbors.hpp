...
{
/**
 * @class FindTriangleGeomNeighbors
 * @brief This filter will ....
 */
class SURFACEMESHING_EXPORT FindTriangleGeomNeighbors : public IFilter
{
public:
  FindTriangleGeomNeighbors() = default;
  ~FindTriangleGeomNeighbors() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, FindTriangleGeomNeighbors, "c1a2cc33-4db8-5d9b-ad80-153062a17976");
