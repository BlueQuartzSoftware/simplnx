...
{
/**
 * @class GenerateGeometryConnectivity
 * @brief This filter will ....
 */
class SURFACEMESHING_EXPORT GenerateGeometryConnectivity : public IFilter
{
public:
  GenerateGeometryConnectivity() = default;
  ~GenerateGeometryConnectivity() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, GenerateGeometryConnectivity, "36848349-68b6-4230-a8fb-a5b08ca9c82e");
