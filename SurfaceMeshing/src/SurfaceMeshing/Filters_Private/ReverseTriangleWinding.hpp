 ...
 */
class SURFACEMESHING_EXPORT ReverseTriangleWinding : public IFilter
{
public:
  ReverseTriangleWinding() = default;
  ~ReverseTriangleWinding() noexcept override = default;
...
COMPLEX_DEF_FILTER_TRAITS(complex, ReverseTriangleWinding, "f11a45e9-c169-4227-85b0-0fb0108e47de");
